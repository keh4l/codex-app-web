...
- **Vendored 前端**：`scratch/asar`，官方 ChatGPT app 版本 **26.803.41515**（见 `scripts/prepare`）。外层 archive/Bundle 是 `ChatGPT-darwin-arm64-*.zip` / `ChatGPT.app`；asar 内 productName、title、URL scheme 和 `codex_desktop:*` 协议仍是 Codex，禁止全局改名。
