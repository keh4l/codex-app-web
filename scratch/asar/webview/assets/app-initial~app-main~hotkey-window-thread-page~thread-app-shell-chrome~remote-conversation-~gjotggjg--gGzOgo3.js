...
function Ae({
  ...
  projectAssignment: b,
  baseInstructions: x,
  additionalDeveloperInstructions: S,
}) {
  ...
  return (
    w != null &&
      t != null &&
      ((w.activePermissionProfile = { id: t, extends: null }),
      (w.runtimeWorkspaceRoots = r)),
    {
      input: o,
      commentAttachments: s,
      workspaceRoots: r,
      ...
      ...(w == null
        ...
        : { permissions: w, approvalsReviewer: w.approvalsReviewer }),
      cwd: d,
      attachments: C,
      workspaceKind: v,
      projectAssignment: b,
...
function Pe({ defaultWidth: e, mainContentWidth: t, shellHeight: n }) {
  return e === 600
    ? Math.max(320, Math.min(n * Ke, t - We), Math.min(Ge, t - qe))
    : e;
}
function Fe(e, t, n = `regular`) {
...
function Le({ mainContentWidth: e, storageKey: t, width: n, widthMode: r }) {
  u(t, Re(n, e, r));
}
function Re(e, t, n = `regular`) {
  let r = Ve(t, n),
    i = r.maximum - r.minimum;
  return i === 0 ? 0 : He((Fe(e, t, n) - r.minimum) / i);
}
function ze(e, t, n = `regular`) {
  let r = Ve(t, n);
  return Fe(r.minimum + He(e) * (r.maximum - r.minimum), t, n);
}
function Be(e, t) {
  return t === `full` ? Math.max(320, e) : Math.max(320, e - qe);
}
function Ve(e, t) {
  let n = Be(e, t);
...
var Ue,
  ...
  Je = e(() => {
    (Ne(),
      Se(),
      (Ue = `app-shell:right-panel-width:v3`),
      (We = 500),
      (Ge = 640),
      (Ke = 16 / 10),
      (qe = 352));
...
function Xe({
  ...
  return e ? Math.max(0, t - ze(r, t, n)) : t;
}
function Ze() {
  let e = (0, Qe.useContext)(tt);
...
var Qe,
  ...
  nt = e(() => {
    ((Qe = t(f(), 1)),
      Je(),
      ($e = { type: `spring`, duration: 0.5, bounce: 0.1 }),
      (et = 0.5),
      (tt = (0, Qe.createContext)(null)));
  });
function rt(e, t) {
  e.get(Tt) !== t && e.set(Tt, t);
}
function it(e, t) {
  e.get(Dt) !== t && e.set(Dt, t);
}
function at(e, t) {
  e.get(Ot) !== t && e.set(Ot, t);
}
function ot() {
  let e = g(i, []),
    t = M(i, (e) => null);
...
var ct,
  ...
  Rt = e(() => {
    (U(),
      ...
      (ht = g(G, !1)),
      (gt = g(i, null)),
      (_t = g(H, { defaultWidth: 600, storageKey: Ue })),
      (vt = W(
        i,
...
function Vt(e) {
  return Number.isFinite(e) ? Math.min(Math.max(e, 240), Ht) : 275;
}
var Ht,
  Ut,
  Wt = e(() => {
    (Se(), (Ht = 520), (Ut = `sidebar-width`));
  });
function Gt(e, t, n = {}) {
  (!t && e.get(cn) && e.set(ln, !0),
    e.set(on, t),
    e.set(cn, !1),
    t && e.set(ln, !1));
  let r = e.get(dn);
...
function Jt() {
  ne(`app-shell-bottom-panel-launcher-visible`, void 0) ?? u(rn, !1);
}
function Yt(e, t) {
  (e.set(mn, t), nn(e.get(hn), t, e.get(z)));
}
function Xt(e, t, n = {}) {
  (e.set(bn, null), e.set(gn, t));
  let r = e.get(_n);
  if ((r.stop(), nn(r, t, e.get(z)), t)) {
    e.get(yn) && (e.set(ht, !0), e.set(yn, !1));
    return;
  }
  (e.set(vn, !1),
    e.set(yn, n.restoreFullWidthOnNextOpen === !0 && e.get(ht)),
    e.set(ht, !1));
}
function Zt(e) {
  if (!e.get(gn)) return;
...
function en(e, t, n = {}) {
  (e.set(Sn, t), tn(e.get(Cn), t, e.get(z), n));
}
function tn(e, t, n, r) {
...
var rn,
  ...
  Tn = e(() => {
    (j(),
      ...
      Rt(),
      Wt(),
      (rn = `app-shell-bottom-panel-launcher-visible`),
      (an = 100),
      (on = g(H, window.__ELECTRON_SHIM__.initialSidebarState)),
      (sn = g(H, !0)),
      (cn = g(H, !1)),
      (ln = g(H, !1, {
        onMount: (e, t) => {
      ...
      (dn = g(H, () => new R(window.__ELECTRON_SHIM__.initialSidebarState))),
      (fn = g(H, zt)),
      (pn = v(rn, !0)),
      (mn = g(G, !1)),
      (hn = g(G, () => new R(0))),
...
function On(e, t) {
  let n = Zn[t];
  return {
    accent: zn(e?.accent) ?? n.accent,
    contrast: kn(e?.contrast, n.contrast),
    fonts: Nn(e?.fonts),
    ink: zn(e?.ink) ?? n.ink,
    opaqueWindows: e?.opaqueWindows ?? n.opaqueWindows,
    semanticColors: Pn(e?.semanticColors, n.semanticColors),
    surface: zn(e?.surface) ?? n.surface,
  };
}
function kn(e, t) {
...
function Mn(e, t) {
  let n = Bn(e.contrast, t),
    r = Un(e.surface),
    i = Un(e.ink);
  return {
    accent: Un(e.accent),
    contrast: n,
    editorBackground: t === `light` ? J(r, Z, 0.12) : J(r, i, 0.07),
    ink: i,
    surface: r,
    surfaceUnder: Vn(e, r, i, t),
    theme: e,
    variant: t,
  };
}
function Nn(e) {
  return { code: Fn(e?.code), ui: Fn(e?.ui) };
}
function Pn(e, t) {
  return {
    diffAdded: zn(e?.diffAdded) ?? t.diffAdded,
    diffRemoved: zn(e?.diffRemoved) ?? t.diffRemoved,
    skill: zn(e?.skill) ?? t.skill,
  };
}
function Fn(e) {
  let t = e?.trim() ?? ``;
...
function In(e, t) {
  return {
    ...
    "--color-background-editor-opaque": Y(e.editorBackground),
    ...
    "--color-editor-added": K(
      Un(e.theme.semanticColors.diffAdded),
      e.variant === `light` ? 0.15 : 0.23,
    ),
    "--color-editor-deleted": K(
      Un(e.theme.semanticColors.diffRemoved),
      e.variant === `light` ? 0.15 : 0.23,
    ),
    ...
    "--color-text-on-accent": Y(Kn(e.accent)),
...
function Ln(e) {
  let t = J(e.surface, Z, 0.09 + e.contrast * 0.04),
    n = J(e.surface, Z, 0.08 + e.contrast * 0.08),
    r = J(e.surface, Z, 0.16 + e.contrast * 0.12);
  return {
    accentBackground: q(e.surface, e.accent, 0.11 + e.contrast * 0.04),
    accentBackgroundActive: q(e.surface, e.accent, 0.13 + e.contrast * 0.05),
    accentBackgroundHover: q(e.surface, e.accent, 0.12 + e.contrast * 0.045),
    ...
    controlBackgroundOpaque: Y(t),
    elevatedPrimary: K(r, 0.96),
    elevatedPrimaryOpaque: Y(r),
    elevatedSecondary: K(n, 0.96),
    elevatedSecondaryOpaque: Y(n),
    ...
    simpleScrim: K(X, 0.08 + e.contrast * 0.04),
...
function Rn(e) {
  let t = J(e.surface, e.ink, 0.06 + e.contrast * 0.05),
    n = J(e.accent, Z, 0.3 + e.contrast * 0.15),
    r = J(e.surface, X, 0.38 + e.contrast * 0.12),
    i = J(e.surface, e.ink, 0.08 + e.contrast * 0.08);
  return {
    accentBackground: q(X, e.accent, 0.2 + e.contrast * 0.08),
    accentBackgroundActive: q(X, e.accent, 0.22 + e.contrast * 0.12),
    accentBackgroundHover: q(X, e.accent, 0.21 + e.contrast * 0.1),
    border: K(e.ink, 0.06 + e.contrast * 0.04),
    borderFocus: K(n, 0.7 + e.contrast * 0.1),
    borderHeavy: K(e.ink, 0.12 + e.contrast * 0.06),
    borderLight: K(e.ink, 0.03 + e.contrast * 0.02),
    buttonPrimaryBackground: Y(r),
    ...
    elevatedPrimaryOpaque: Y(i),
    elevatedSecondary: K(e.ink, 0.02 + e.contrast * 0.02),
    elevatedSecondaryOpaque: q(e.surface, e.ink, 0.04 + e.contrast * 0.05),
    iconAccent: Y(n),
    ...
    textAccent: Y(n),
    textButtonPrimary: Y(r),
    textButtonSecondary: q(e.ink, e.surface, 0.7 + e.contrast * 0.1),
    textButtonTertiary: K(e.ink, 0.45 + e.contrast * 0.1),
    textForeground: e.theme.ink,
    textForegroundSecondary: K(e.ink, 0.65 + e.contrast * 0.1),
...
function Bn(e, t) {
  let n = $n[t],
    r = n / 100,
    i = e / 100 + ((e - n) / 60) * er;
  return e <= n ? i : r + (i - r) * tr;
}
function Vn(e, t, n, r) {
  let i = $n[r],
    a = nr[r] + (e.contrast - i) * rr[r];
  return r === `light` ? q(t, n, a) : q(t, X, a);
}
function Hn(e) {
  let t = e.variant === `light` ? Z : e.ink;
  return q(e.surface, t, ir[e.variant] + e.contrast * ar[e.variant]);
}
function Un(e) {
  let t = e.slice(1);
  return {
...
function K(e, t) {
  return `rgba(${e.red}, ${e.green}, ${e.blue}, ${Gn(t)})`;
}
function q(e, t, n) {
  return Yn(J(e, t, n));
}
function J(e, t, n) {
  ...
  return {
    blue: Wn(e.blue, t.blue, r),
    green: Wn(e.green, t.green, r),
    red: Wn(e.red, t.red, r),
  };
}
function Wn(e, t, n) {
...
function Kn(e) {
  return Yn(e) === Zn.light.accent ? Z : qn(e) > Qn ? X : Z;
}
function qn(e) {
  return Jn(e.red) * 0.2126 + Jn(e.green) * 0.7152 + Jn(e.blue) * 0.0722;
}
function Jn(e) {
  let t = e / 255;
...
function Yn(e) {
  return `#${Xn(e.red)}${Xn(e.green)}${Xn(e.blue)}`;
}
function Y(e) {
...
var Zn,
  ...
  or = e(() => {
    (Dn(),
      ...
      (X = { blue: 0, green: 0, red: 0 }),
      (Z = { blue: 255, green: 255, red: 255 }),
      (Qn = 0.179),
      ($n = { dark: Zn.dark.contrast, light: Zn.light.contrast }),
      (er = 0.7),
      (tr = 2),
      (nr = { dark: 0.16, light: 0.04 }),
      (rr = { dark: 0.0015, light: 0.0012 }),
      (ir = { dark: 0.03, light: 0.18 }),
      (ar = { dark: 0.03, light: 0.008 }));
  });
function sr(e) {
  if (e == null) return null;
  if (O(e)) return `browser`;
  let t = e.tabId;
  return t === I.DIFF
    ? `review`
    : t === I.MCP_APP || t.startsWith(`${I.MCP_APP}:`)
      ? `mcp_app`
...
function ur(e, t) {
  let n = sr(t);
  n != null && _(e, ie, { routeKind: cr(e.value.routeKind), tab: n });
}
var dr = e(() => {
  (ee(), E(), lr());
});
...
var pr = e(() => {});
function mr({ panelId: e, panelOpen$: t, setPanelOpen: n }) {
  let r = g(G, []),
    i = M(G, (e) => null),
    a = W(G, ({ get: e }) =>
      e(r)
    ...
    l = W(G, ({ get: e }) => {
      ...
      return n == null
        ? null
        : (e(i, n) ?? (e(t) && a[0] != null ? e(i, a[0]) : null));
    }),
    u = W(G, ({ get: e }) => {
      let t = e(l);
  ...
  function d(t, r, a) {
    let {
      ...
      N = wr(r, d),
      P = t.get(i, N);
    if (P == null && !t.get(vt)) return N;
    let F = t.get(o, N),
      I = F?.value ?? E?.(),
      L = D ?? {};
    F == null && E != null && t.set(o, N, { key: 0, value: I });
    let ee = {
      Component: r,
      contextMenuItems: c,
      dndId: P?.dndId ?? gr(),
  ...
  function p(e, t, n) {
    let a = e.get(i, t.tabId),
      o = t.isPreview && a != null ? { ...t, isPreview: a.isPreview } : t,
      s = o.isPreview && a == null ? m(e) : null,
      c = s == null ? o : { ...o, dndId: s.dndId };
    (e.set(i, t.tabId, c),
      a ??
        e.set(r, (e) => {
  ...
  function m(e) {
    let t = e.get(a).find((e) => e.isPreview) ?? null;
    return t == null
      ? null
      : (w(e, t),
        e.set(i, t.tabId, null),
        e.set(r, (e) => e.filter((e) => e !== t.tabId)),
        e.set(c, (e) => e.filter((e) => e !== t.tabId)),
        t);
  }
  function h(t, n) {
    let r = n == null ? null : t.get(i, n);
    if (n != null && r == null) return;
    let a = t.get(l)?.tabId ?? null,
      o = a == null ? null : t.get(i, a),
      s = a != null && a !== n && xr(e, o);
    (O(t, n, !0),
      r != null &&
        (rt(t, e === `bottom` ? `bottom-panel` : `right-panel`),
        s &&
          requestAnimationFrame(() => {
            br(e, r.tabId);
          })));
  ...
  function _(e, n) {
    let r = vr(
      e.get(a).map((e) => e.tabId),
      e.get(l)?.tabId ?? null,
      n,
    );
    return !e.get(t) || r == null ? !1 : (h(e, r), !0);
  }
  function v(e, t, n) {
    let i = e.get(r),
      a = i.indexOf(t),
  ...
  function y(e, t, n, r, i = {}) {
    if (n === A || e.get(n.tabById$, t) != null) return;
    let a = b(e, t);
  ...
  function x(
    ...
    a,
    s,
    { activate: c = !0, insertionPlacement: l = `before` } = {},
  ) {
    if (t.get(i, a.tab.tabId) != null) return;
    let { tab: u } = a;
    (u.isPreview && m(t), t.set(o, u.tabId, a.state));
    let d = u.onMove?.(t, A),
      f = d?.props ?? u.props,
      p = {
        ...u,
        ...
        renderPanel: j(
          ...
          u.tabId,
          f,
          a.state?.value ?? u.defaultState?.(),
        ),
      },
      g = t.get(r),
      _ = fr(g, s, l);
    (t.set(i, p.tabId, p),
      t.set(r, [...g.slice(0, _), p.tabId, ...g.slice(_)]),
      c &&
        (h(t, p.tabId),
        n(t, !0),
        requestAnimationFrame(() => {
  ...
  function S(t, a) {
    ...
    let f = xr(e, d);
    d != null && w(t, d);
    let p = o.filter((e) => e !== a);
    (t.set(i, a, null), t.set(r, p), p.length === 0 && n(t, !1));
    let m = _r(t, c, p);
    (t.set(c, m),
      t.get(s) === a &&
        (O(t, m[0] ?? hr(p, u), !1),
  ...
  function w(t, n) {
    (Cr(e, n.tabId), n.onClose?.(t, e), t.set(o, n.tabId, null));
  }
  function T(e) {
    let n = e.get(l);
    return !e.get(t) || n == null || !n.isClosable ? !1 : (S(e, n.tabId), !0);
  }
  function E(e, t) {
    let n = e
      .get(a)
      ...
      .map((e) => e.tabId)
      .reverse();
    for (let t of n) S(e, t);
    e.get(i, t) != null && h(e, t);
  }
  function D(e, t) {
    let n = e.get(r),
      a = n.indexOf(t);
    ...
    return (a, s) => {
      let c = a.get(o, t),
        ...
        d = (e) => {
          a.get(i, t) != null &&
            a.set(o, t, (t) => {
              if ((t?.key ?? 0) !== u) return t;
              let n = t == null ? r : t.value,
                i = typeof e == `function` ? e(n) : e;
              return Object.is(i, n) ? t : { key: u, value: i };
            });
        };
      return (0, Er.createElement)(e, {
        ...(a.get(i, t)?.props ?? n),
        onClose: s,
        tabId: t,
        isActive: a.get(l)?.tabId === t,
...
function xr(e, t) {
  ...
  return n == null
    ? !1
    : Sr(e, n)?.contains(document.activeElement) === !0 ||
...
var Er,
  ...
  jr = e(() => {
    (U(),
      ...
      (Dr = 0),
      (Or = new WeakMap()),
      (kr = mr({ panelId: `right`, panelOpen$: vn, setPanelOpen: $t })),
      (Ar = mr({ panelId: `bottom`, panelOpen$: mn, setPanelOpen: Yt })));
  }),
  Mr,
  Nr,
  Pr = e(() => {
                ...
                m = (t.DomRendererRowFactory = class {
                  ...
                  createRow(e, t, n, r, i, s, c, u, f, m, g) {
                    ...
                    for (let N = 0; N < x; N++) {
                      ...
                      let re = I.getChars() || o.WHITESPACE_CELL_CHAR;
                      if (
                        (re === ` ` &&
                          (I.isUnderline() || I.isOverline()) &&
                          (re = `\xA0`),
                        (A = x * u - f.get(re, I.isBold(), I.isItalic())),
                        b)
                      ) {
                        if (
                          S &&
                      ...
                      (I.isOverline() &&
                        ...
                        te && (b.style.textDecoration = `underline`));
                      let R = I.getFgColor(),
                        ie = I.getFgColorMode(),
                        z = I.getBgColor(),
                        ae = I.getBgColorMode(),
                      ...
                      switch (
                        (this._decorationService.forEachDecorationAtCell(
                          ...
                          void 0,
                          (e) => {
                            (e.options.layer !== `top` && se) ||
                              (e.backgroundColorRGB &&
                                ((ae = 50331648),
                                (z =
                                  (e.backgroundColorRGB.rgba >> 8) & 16777215),
                                (B = e.backgroundColorRGB)),
                              e.foregroundColorRGB &&
                                ((ie = 50331648),
                                (R =
                                  (e.foregroundColorRGB.rgba >> 8) & 16777215),
                                (V = e.foregroundColorRGB)),
                              (se = e.options.layer === `top`));
                          },
                        ),
                        !se &&
                          L &&
                          ((B = this._coreBrowserService.isFocused
                          ...
                          y.selectionForeground &&
                            ((ie = 50331648),
                            (R = (y.selectionForeground.rgba >> 8) & 16777215),
                            (V = y.selectionForeground))),
                        se && j.push(`xterm-decoration-top`),
                        ae)
                      ) {
                        case 16777216:
                        case 33554432:
                          ((H = y.ansi[z]), j.push(`xterm-bg-${z}`));
                          break;
                        case 50331648:
                          ((H = l.channels.toColor(
                            z >> 16,
                            (z >> 8) & 255,
                            255 & z,
                          )),
                            this._addStyle(
                              b,
                              `background-color:#${h((z >>> 0).toString(16), `0`, 6)}`,
                            ));
                          break;
                        default:
                          oe
                      ...
                      switch (
                        (B ||
                          (I.isDim() && (B = l.color.multiplyOpacity(H, 0.5))),
                        ie)
                      ) {
                        case 16777216:
                        case 33554432:
                        ...
                        case 50331648:
                          ...
                          this._applyMinimumContrast(b, H, e, I, B, V) ||
                            this._addStyle(
                              b,
                              `color:#${h(R.toString(16), `0`, 6)}`,
                            );
                          break;
                        default:
                          this._applyMinimumContrast(
...
`,
  ...
  zr,
  Br = e(() => {
    zr = `ui-monospace, "SFMono-Regular", Menlo, Consolas, monospace`;
  });
function Vr() {
  return Ce(y.theme) ?? `system`;
}
function Hr(e) {
  let t = (0, qr.c)(4),
    n;
  t[0] === e
    ? (n = t[1])
    : ((n = e === `system` ? Kr : () => e), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] === e
      ? (r = t[3])
      : ((r = e === `system` ? Kr : () => e), (t[2] = e), (t[3] = r)),
    (0, Jr.useSyncExternalStore)(e === `system` ? Gr : Wr, n, r)
  );
}
function Ur(e) {
...
function Xr(e, t) {
  t && xe({ event: e, href: t, initiator: `terminal_link_click` });
}
var Zr,
  Qr = e(() => {
    (oe(), (Zr = { activate: Xr }));
...
function $r(e) {
  let t = e.trim();
  return t.length === 0 ? `monospace` : ii(t) ? t : `${t}, monospace`;
}
function ei(e) {
  return e.replace(
    /\r?\n/gu,
...
function oi(e, t) {
  ...
  let i = r.getCoords,
    ...
    o = (e, n) => {
      let r = t();
      return r === 1 ? e : si(e, n.getBoundingClientRect(), r);
    },
...
function pi(e) {
  ...
  t[0] === e.dependencies
    ? (r = t[1])
    : ((r = e.dependencies ? e.dependencies.map(_i).join(`|`) : ``),
      (t[0] = e.dependencies),
      (t[1] = r));
  let i = r,
    a;
  t[2] !== e || t[3] !== n
    ? ((a = () => {
        n((t) => {
          ...
          return (n || r.push(e), (0, bi.default)(r.filter(gi), [hi, mi]));
        });
      }),
      (t[2] = e),
      (t[3] = n),
...
var yi,
  ...
  Si,
  Ci = e(() => {
    ((yi = S()), ae(), (bi = t(Te(), 1)), (xi = t(f(), 1)), (Si = ue([])));
  });
function wi(e, t) {
  return (0, Ti.useRef)(null);
}
var Ti,
  Ei = e(() => {
    Ti = t(f(), 1);
...
function Di(e) {
  let t = (0, Oi.c)(33),
    ...
    r = se(),
    i = Hr(Vr()),
    a = Ce(y.lightChromeTheme),
    o = Ce(y.darkChromeTheme),
    s = Ce(y.codeFontSize),
    c,
    l,
    u,
  ...
  if (t[0] !== s || t[1] !== o || t[2] !== a || t[3] !== i) {
    c = i === `light` ? On(a, `light`) : On(o, `dark`);
    let e =
      c.fonts.code?.trim() ||
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = () => {
        ...
        e == null ||
          t == null ||
          ((e.options.theme = ri(t)), e.rows > 0 && e.refresh(0, e.rows - 1));
      }),
      (t[15] = w))
    : (w = t[15]);
  let T;
  (t[16] !== c || t[17] !== i
    ? ((T = [c, i]), (t[16] = c), (t[17] = i), (t[18] = T))
    : (T = t[18]),
    (0, Q.useEffect)(w, T));
  let E, D;
  ...
  (t[24] !== l || t[25] !== u
    ? ((O = () => {
        ...
        ((h.current = i),
          (g.current = a),
          i.loadAddon(a),
          i.loadAddon(new Ai.WebLinksAddon(Xr)),
          i.open(e));
        let s = oi(i, () => v.current);
        (a.fit(), _.current.length > 0 && (i.write(ei(_.current)), o()));
  ...
  (t[28] === n
    ...
    : ((A = () => {
        ...
        if (n.startsWith(t)) {
          ...
          r.length > 0 && e.write(ei(r));
        } else (e.reset(), n.length > 0 && e.write(ei(n)));
  ...
  return (
    t[0] === e
      ...
      : ((n = (t) => L.subscribeToSessionSnapshot(e, t)),
        ...
        (t[1] = n),
        (t[2] = r)),
    (0, zi.useSyncExternalStore)(n, r, Ii)
  );
}
function Ii() {
  return null;
...
var Ri,
  ...
  Bi,
  Vi = e(() => {
    ((Ri = S()), U(), (zi = t(f(), 1)), h(), de(), A(), Ni(), (Bi = be()));
  });
function Hi({
  scope: e,
  ...
  kr.openTab(e, Pi, {
    icon: (0, Ui.jsx)(Nr, { className: `icon-xs shrink-0` }),
...
function Yi(e, t, n = Date.now(), { matchCommandStartTime: r = !1 } = {}) {
  if (t == null) return null;
  let i = r && e.commandExecutionStartedAtMs != null ? ca : null;
  if (e.osPid != null) {
    let n = $i(e.osPid, t);
    if (n != null && na(oa(e.command), n.command)) return n;
  }
  let a = Qi(e.processId);
  if (a != null) {
    if (e.source !== `restored-process` && i == null) {
      let e = $i(a, t);
      if (e != null) return e;
    }
    let r = ta(e, Xi(a, t), n, i);
    if (r != null) return $i(r.pid, t);
  }
  let o = ta(e, t, n, i);
  return o == null ? null : $i(o.pid, t);
}
function Xi(e, t) {
  let n = new Map(t.map((e) => [e.pid, e]));
  return t.filter((t) => ea(t.pid, e, n));
}
function Zi(e, t, n) {
...
function ra(e, t) {
  ...
  return n.length === r.length
    ? n.every((e, t) => {
        let n = r[t];
        return n == null ? !1 : e === n ? !0 : t === 0 ? !1 : sa(e) === sa(n);
      })
    : !1;
}
function ia(e, t, n) {
  if (n != null) {
    let r = aa(e.ageSeconds, n),
      i = aa(t.ageSeconds, n);
    if (r !== i) return r - i;
  }
...
function oa(e) {
  ...
  let n = /^"([^"]+)"(.*)$/u.exec(t);
  if (n != null) return `${sa(n[1])}${n[2]}`.trim().toLowerCase();
  let r = /^(\S+)(.*)$/u.exec(t);
  return r == null
    ? t.toLowerCase()
    : `${sa(r[1])}${r[2]}`.trim().toLowerCase();
}
function sa(e) {
  let t = e.replaceAll(`\\`, `/`),
    n = t.lastIndexOf(`/`);
...
function va(e, t, n) {
  ...
  for (let a of e) {
    let e = Yi(a, t, n);
    if (e == null) continue;
    let o = Ca({ metrics: e, process: a }, n);
    (o != null && o < Oa) ||
      i.has(e.pid) ||
...
function ya(e, t) {
  ...
  for (let i of t.values())
    Da(e, i.row) || r.push({ row: i.row, rowIndex: i.rowIndex ?? n.length });
...
function ba(e, t, n) {
  ...
  let r = new Map(e.map((e) => [e.process.id, e])),
    i = new Map();
  for (let [a, o] of t) wa(o, r.get(a) ?? Ea(e, o.row), n) || i.set(a, o);
  return i;
}
function xa(e, t) {
  return Sa(e, t)?.sortRow ?? e;
}
function Sa(e, t) {
  let n = t.get(e.process.id);
  if (n != null) return n;
  for (let n of t.values()) if (Ji(e.process, n.row.process)) return n;
}
function Ca(e, t) {
...
function Ta(e, t, n) {
  ...
  return r == null || i == null ? !0 : n - i * 1e3 >= r - ka;
}
function Ea(e, t) {
  return e.find((e) => Ji(e.process, t.process)) ?? null;
}
function Da(e, t) {
  return Ea(e, t) != null;
}
...
var Ma,
  ...
  Fa = e(() => {
    (U(),
      a(),
      V(),
      (Ma = v(`remote-hosted-pip-hidden-thread-ids`, [])),
      (Na = o(H, (e, { get: t }) => e == null || !(t(Ma) ?? []).includes(e))),
      (Pa = M(H, (e) => !1)));
  });
async function Ia({ entry: e, threadGoalObjective: t, workspaceRoot: n }) {
  let i = Va(e);
  if (e.launchMode === `fork-conversation`) {
    ...
    return (
      (t =
        e.targetTurnId == null
          ? await D(`fork-conversation-from-latest`, {
              hostId: e.hostId,
          ...
          : await D(`fork-conversation-from-turn`, {
              conversationId: e.sourceConversationId,
      ...
      i != null &&
        (await D(`add-worktree-init-synthetic-turn`, {
          conversationId: t,
          worktreeInit: i,
        })),
      t
  ...
  let a = za(e),
    o =
      t == null
        ...
        : {
            ...e.startConversationParamsInput,
            fileAttachments: La(e),
            input: Ba(e.startConversationParamsInput.input, r(t)),
          },
    s = o.projectAssignment;
  return D(`start-conversation`, {
    hostId: e.threadStartHostId ?? e.hostId,
    ...Ae({
      ...o,
      workspaceRoots: [n],
      cwd: n,
      projectAssignment: s == null ? s : { ...s, cwd: n },
    }),
    initialTitle: a || void 0,
    skipAutoTitleGeneration: a.length > 0,
    worktreeInit: i ?? void 0,
  });
}
function La(e) {
  let t = new Set(
...
async function Ra({
  ...
  if (e.isPinned)
    try {
      await ke(t, !0, e.pinnedBeforeThreadId);
    } catch (e) {
      m.warning(
  ...
  if (
    ...
    try {
      await c(`worktree-set-owner-thread`, {
        params: {
          hostId: n.id,
          worktree: re(e.worktreeGitRoot),
          conversationId: t,
        },
      });
    } catch (e) {
...
//# sourceMappingURL=app-initial~app-main~hotkey-window-thread-page~thread-app-shell-chrome~remote-conversation-~gjotggjg--gGzOgo3.js.map
