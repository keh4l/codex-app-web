import{n as e,s as t}from"./rolldown-runtime-BG2f4sTM.js";import{E as n,O as r,_t as i,b as a,dn as o,gt as s,un as c,vt as l,x as u,y as d,zt as f}from"./app-initial~avatarOverlayCompositionSurface~index-9fQ9wihu~index-BFCcxPM5~mapbox-gl-DVWlwqb~kppdhley-mFmI6cbL.js";import{C as p,Cn as m,Ga as h,In as g,Nl as ee,S as _,Ua as v,b as y,do as b,ho as te,lo as x,n as ne,o as S,po as C,qa as w,r as T,uo as E,w as D,wn as O,x as k,xl as A}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~ngwudnyz-CS1L_Amm.js";import{D as j,O as M,a as N,ft as re,i as P,lt as F,n as ie,t as I}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~l16cgjx9-Bw-xR9Fl.js";import{n as L}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~g8980z4e-Bj4tUPiN.js";import{a as R,s as ae}from"./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~nssizff1-C8BmUbuQ.js";import{I as z,bt as oe,lf as B,uf as V}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~business-checkout~oxnpxkxc-Caq74mjw.js";import{G as H,H as se,K as ce,N as U,W,k as le}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~business-checkout~mgfw3nls-C1ihWWPl.js";import{f as ue,h as de,n as G,t as fe}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~business-checkout~k87y25tw-31XubniU.js";import{c as K,d as pe,f as q,h as me,l as he,m as J,p as ge,u as Y}from"./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~settings-command-~cajo70vh-C4Uu6T2D.js";function _e(e){let t=(0,ye.c)(2),r;return t[0]===e?r=t[1]:(r=e==null?void 0:{hostId:e},t[0]=e,t[1]=r),n(le,r)}function ve(e){return _e(e).data?.codexHome}var ye,be=e((()=>{ye=c(),u(),U()}));async function xe(e,t){let n=!1,r=()=>{n||(n=!0,e[Symbol.dispose]?.())};t?.addEventListener(`abort`,r,{once:!0});try{t?.throwIfAborted();let n=await e;return t?.throwIfAborted(),n}finally{t?.removeEventListener(`abort`,r),r()}}var Se=e((()=>{}));function Ce(e){return[`open-in-targets`,JSON.stringify(e)]}async function we(e,t){return t?.throwIfAborted(),xe(P.openIn.getTargets(e),t)}var Te,Ee,De=e((()=>{A(),u(),W(),N(),Se(),a(),p(),Te=l(d,e=>ee({queryKey:Ce(e),queryFn:({signal:t})=>we(e,t),staleTime:_.ONE_MINUTE})),Ee=i(d,({scope:e})=>({mutationFn:async e=>xe(P.openIn.setGlobalPreferredTarget(e)),networkMode:`always`,onSuccess:async(t,{target:n})=>{let r=e.query.snapshot(Te,{cwd:null});r.setData(e=>e==null?e:{...e,preferredTarget:n}),await H(e.queryClient,r.queryKey)}}))}));function Oe(e){ke(e).catch(()=>void 0)}async function ke(e){return xe(P.openIn.open(e))}var Ae,je=e((()=>{u(),N(),Se(),a(),Ae=i(d,()=>({mutationFn:ke,networkMode:`always`}))})),Me,Ne=e((()=>{Me=`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`}));function qt(e){let t=0;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%Jt.length;return Jt[t]??``}var Jt,Yt=e((()=>{Qe(),et(),nt(),it(),ot(),ct(),ut(),ft(),mt(),gt(),vt(),bt(),St(),wt(),Et(),Ot(),At(),Mt(),Pt(),It(),Rt(),Bt(),Ht(),Wt(),Kt(),Jt=[Ze,$e,tt,rt,at,st,lt,dt,pt,ht,_t,yt,Ct,xt,Tt,Dt,kt,jt,Nt,Ft,Lt,zt,Vt,Ut,Gt].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`)}));async function Xt(e,t,n){let r=Zt(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>ne(`read-file-binary`,{params:e,signal:t}),queryKey:T(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:_.INFINITE});return i.contentsBase64?`data:${Qt(r)};base64,${i.contentsBase64}`:null}catch(e){return k.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function Zt(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=C(t);return x(r)?r:null}function Qt(e){return en[$t.default.extname(e).toLowerCase()]??`application/octet-stream`}var $t,en,tn=e((()=>{$t=t(te(),1),D(),y(),p(),S(),en={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`}}));function nn(e){return{...Wn(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...fn({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function rn({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function an(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function on(e){let t=e.plugin.remotePluginId??e.plugin.shareContext?.remotePluginId;return`${an(e)}:${e.plugin.id}:${t??``}`}function sn(e){return e.filter(e=>{let t=Nn(e).toLowerCase();return!rr.some(e=>t===e||t.startsWith(`${e}-`))})}function cn(e){return e.marketplacePath==null?un(e.plugin):e.plugin.name}function ln(e){return e.marketplacePath==null?un(e.plugin):e.plugin.id}function un(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function dn(e){return{...rn(e),pluginName:cn(e)}}function fn({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function pn(e,t,i){let a=(0,Gn.c)(65),o;a[0]===e?o=a[1]:(o={hostId:e},a[0]=e,a[1]=o);let s=he(o)&&(i?.enabled??!0),c=i?.additionalMarketplaceKinds??Xn,l=i?.installSuggestionPluginNames??null,u=ae(`4218407052`),d=de(e)?.authMethod??null,f;a[2]===d?f=a[3]:(f=Ye(d),a[2]=d,a[3]=f);let p=f,m=i?.includeRemoteCatalog??!0,h=!u,g;a[4]!==c||a[5]!==m||a[6]!==h?(g=yn({additionalMarketplaceKinds:c,includeRemoteCatalog:m,includeVerticalCatalog:h}),a[4]=c,a[5]=m,a[6]=h,a[7]=g):g=a[7];let ee=g,_=ce(),v=r(oe),y;a[8]!==e||a[9]!==v?(y=v.includes(e),a[8]=e,a[9]=v,a[10]=y):y=a[10];let b=y,te=t===void 0,x;a[11]===e?x=a[12]:(x={hostId:e},a[11]=e,a[12]=x);let ne=s&&b&&te,S;a[13]===ne?S=a[14]:(S={enabled:ne},a[13]=ne,a[14]=S);let C=n(se,x,S),w=ve(e),T=s&&b,E;a[15]!==e||a[16]!==T?(E={enabled:T,hostId:e},a[15]=e,a[16]=T,a[17]=E):E=a[17];let D=me(E),O;a[18]===e?O=a[19]:(O={hostId:e},a[18]=e,a[19]=O);let k=pe(O),A;a[20]===e?A=a[21]:(A={hostId:e},a[20]=e,a[21]=A);let j=ge(A),M=C.data?.roots,N;a[22]!==w||a[23]!==e||a[24]!==t||a[25]!==M?(N=Bn({codexHome:w,hostId:e,rootsOverrideCwd:t,workspaceRoots:M}),a[22]=w,a[23]=e,a[24]=t,a[25]=M,a[26]=N):N=a[26];let re=N,P=s&&b&&(t!==void 0||C.isFetched),F;a[27]===Symbol.for(`react.memo_cache_sentinel`)?(F=fe(),a[27]=F):F=a[27];let ie=F,I;a[28]!==e||a[29]!==l||a[30]!==u||a[31]!==ee||a[32]!==re||a[33]!==p?(I={buildFlavor:ie,hostId:e,installSuggestionPluginNames:l,isOpenAICuratedRemoteMarketplaceEnabled:u,marketplaceKinds:ee,roots:re,shouldHideOpenAICuratedMarketplaces:p},a[28]=e,a[29]=l,a[30]=u,a[31]=ee,a[32]=re,a[33]=p,a[34]=I):I=a[34];let L;a[35]===P?L=a[36]:(L={enabled:P},a[35]=P,a[36]=L);let R=n(ar,I,L);if(!s||!b){let e;return a[37]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:Q,featuredPluginIds:Jn,installedPlugins:Q,marketplaceLoadErrors:Yn,marketplaces:Qn,errorMessage:null,isLoading:!1,isFetching:!1,refetch:hn,forceReload:mn},a[37]=e):e=a[37],e}let z,B,V,H;a[38]!==D.available||a[39]!==j.available||a[40]!==k.available||a[41]!==R.data?.featuredPluginIds||a[42]!==R.data?.plugins?(z={isComputerUseAvailable:D.available,isExternalBrowserUseAvailable:j.available,isInAppBrowserUseAvailable:k.available},B=R.data?.plugins??Q,V=Tn({plugins:B,...z}),H=wn({featuredPluginIds:R.data?.featuredPluginIds??Jn,...z}),a[38]=D.available,a[39]=j.available,a[40]=k.available,a[41]=R.data?.featuredPluginIds,a[42]=R.data?.plugins,a[43]=z,a[44]=B,a[45]=V,a[46]=H):(z=a[43],B=a[44],V=a[45],H=a[46]);let U;a[47]===B?U=a[48]:(U=En(B),a[47]=B,a[48]=U);let W=R.data?.marketplaceLoadErrors??Yn,le=R.data?.marketplaces??Qn,ue=R.error?String(R.error.message):null,G=te&&C.isLoading||R.isLoading||k.isLoading||j.isLoading||D.isLoading,K=te&&C.isFetching||R.isFetching||D.isFetching,q;a[49]!==z||a[50]!==R?(q=async()=>{let e=(await R.refetch()).data?.plugins??Q;return{availablePlugins:Tn({plugins:e,...z}),installedPlugins:En(e)}},a[49]=z,a[50]=R,a[51]=q):q=a[51];let J;a[52]===_?J=a[53]:(J=()=>_(Z),a[52]=_,a[53]=J);let Y;return a[54]!==V||a[55]!==H||a[56]!==U||a[57]!==W||a[58]!==le||a[59]!==ue||a[60]!==G||a[61]!==K||a[62]!==q||a[63]!==J?(Y={availablePlugins:V,featuredPluginIds:H,installedPlugins:U,marketplaceLoadErrors:W,marketplaces:le,errorMessage:ue,isLoading:G,isFetching:K,refetch:q,forceReload:J},a[54]=V,a[55]=H,a[56]=U,a[57]=W,a[58]=le,a[59]=ue,a[60]=G,a[61]=K,a[62]=q,a[63]=J,a[64]=Y):Y=a[64],Y}async function mn(){}async function hn(){return{availablePlugins:Q,installedPlugins:Q}}function gn(e){let t=(0,Gn.c)(7),{enabled:r,hostId:i,marketplaceKind:a}=e,o=r===void 0?!0:r,s;t[0]===i?s=t[1]:(s={hostId:i},t[0]=i,t[1]=s);let c=he(s),l;t[2]!==i||t[3]!==a?(l={hostId:i,marketplaceKind:a},t[2]=i,t[3]=a,t[4]=l):l=t[4];let u=o&&c,d;return t[5]===u?d=t[6]:(d={enabled:u},t[5]=u,t[6]=d),n(or,l,d)}function _n(e,t,n=Xn,r=null,i=!1,a=!1){return r==null?bn(e,t,yn({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i,a):vn([...Z,e,t,`installed`,r,`curated-marketplace`,xn(i)],a)}function vn(e,t){return t?[...e,Kn]:e}function yn({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function bn(e,t,n,r,i){let a=xn(r);return vn(n==null?[...Z,e,t,`curated-marketplace`,a]:[...Z,e,t,`marketplace-kinds`,n,`curated-marketplace`,a],i)}function xn(e){return e?O:m}function Sn({isOpenAICuratedRemoteMarketplaceEnabled:e,shouldHideOpenAICuratedMarketplaces:t}){return t?er:e?$n:Zn}function Cn(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function wn({featuredPluginIds:e,...t}){return e.filter(e=>kn(e,t))}function Tn({plugins:e,...t}){return e.filter(e=>kn(e.plugin.id,t))}function En(e){return e.filter(e=>e.plugin.installed)}function Dn({enabled:e,hostId:t,installed:n,pluginId:r,queryClient:i}){i.setQueriesData({queryKey:[...Z,t]},t=>{if(t==null)return t;let i=On({enabled:e,installed:n,pluginId:r,plugins:t.plugins});return i===t.plugins?void 0:{...t,plugins:i}}),i.setQueriesData({queryKey:[...Z,`marketplace-kind`,t]},t=>{if(t==null)return;let i=On({enabled:e,installed:n,pluginId:r,plugins:t});return i===t?void 0:i}),i.setQueriesData({queryKey:[...Z,`detail`,t]},t=>{if(!(t==null||t.summary.id!==r||t.summary.installed===n&&t.summary.enabled===e))return{...t,summary:{...t.summary,enabled:e,installed:n}}})}function On({enabled:e,installed:t,pluginId:n,plugins:r}){return r.some(r=>r.plugin.id===n&&(r.plugin.installed!==t||r.plugin.enabled!==e))?r.map(r=>r.plugin.id===n?{...r,plugin:{...r.plugin,enabled:e,installed:t}}:r):r}function kn(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&An(e)||!n&&jn(e)||!t&&Mn(e))}function An(e){let t=Nn(e);return t===`browser`||t===`browser-use`}function jn(e){let t=Nn(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function Mn(e){return Nn(e)===tr}function Nn(e){return e.split(`@`)[0]}function Pn({buildFlavor:e,featuredPluginIds:t}){let n=h(e);return t.filter(e=>{let t=g(e);return t==null?!0:!w(t)||t===n})}function Fn({buildFlavor:e,plugins:t}){let n=h(e);return t.filter(e=>!w(e.marketplaceName)||e.marketplaceName===n)}function In(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function Ln(e){return ir.has(In(e))}function Rn(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=Ln(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function zn({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c,l]=await Promise.all([Xt(o.composerIconPath,e,n),Xt(o.logoPath,e,n),Xt(o.logoDarkPath,e,n)]);(s!=null||c!=null||l!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoDarkPath:l??o.logoDarkPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,composerIcon:s??o.plugin.interface.composerIcon,logo:c??o.plugin.interface.logo,...l==null?{}:{logoDark:l}}}:o.plugin}),await i(a+qn)}return await Promise.all(Array.from({length:Math.min(qn,t.length)},(e,t)=>i(t))),r}function Bn({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?re(e,nr):null;return Vn([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function Vn(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>x(e)&&Hn(e,t))))}function Hn(e,t){return t==null?!0:E(t)||b(t)?E(e)||b(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function Un(e,t=Q){let n=new Map,r=new Set;for(let t of e)for(let e of t.plugins){e.installed||r.add(e.id);let i={...Wn(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:t.interface?.displayName??null,marketplaceName:t.name,plugin:e,keywords:e.keywords,...fn({marketplaceName:t.name,marketplacePath:t.path})},a=n.get(e.id);if(a==null){n.set(e.id,i);continue}let o=a;(a.plugin.installed&&!e.installed||a.plugin.installed===e.installed&&a.plugin.interface==null&&e.interface!=null)&&(o=i),a.plugin.installed&&!e.installed&&n.delete(e.id);let s=null;if(a.plugin.installed?s=a.plugin:e.installed&&(s=e),s==null){n.set(e.id,o);continue}n.set(e.id,{...o,plugin:{...o.plugin,enabled:s.enabled,installed:!0,installPolicy:s.installPolicy,localVersion:s.localVersion,remotePluginId:o.plugin.remotePluginId??s.remotePluginId}})}let i=new Map(t.map(e=>[e.plugin.id,e])),a=!1,o=Array.from(n.values()).map(e=>{let t=i.get(e.plugin.id);return!e.plugin.installed||t==null||r.has(e.plugin.id)?e:(a||=e.marketplaceName!==t.marketplaceName||e.marketplacePath!==t.marketplacePath,{...t,plugin:{...e.plugin,id:t.plugin.id,interface:t.plugin.interface??e.plugin.interface,keywords:t.plugin.keywords??e.plugin.keywords,name:t.plugin.name,remotePluginId:t.plugin.remotePluginId??e.plugin.remotePluginId,shareContext:t.plugin.shareContext??e.plugin.shareContext,source:t.plugin.source}})});if(!a)return o;let s=new Map(o.map(e=>[e.plugin.id,e]));return[...t.flatMap(e=>{let t=s.get(e.plugin.id);return s.delete(e.plugin.id),t==null?[]:[t]}),...s.values()]}function Wn(e,t){let n=e.interface,r=n?.composerIcon??n?.composerIconUrl,i=n?.logo??n?.logoUrl,a=n?.logoDark??n?.logoUrlDark,o=We(e),s=i!=null||a!=null,c=r??(s?null:o),l=s?i??a??null:o??t?.logoUrl??t?.logoUrlDark??null,u=s?a??null:o??t?.logoUrlDark??t?.logoUrl??null;if(c!=null||l!=null)return{composerIconPath:c,logoDarkPath:u,logoPath:l};let d=qt(e.id);return{composerIconPath:d,logoDarkPath:d,logoPath:d}}var Gn,Z,Kn,qn,Jn,Yn,Xn,Zn,Qn,Q,$n,er,tr,nr,rr,ir,ar,or,sr=e((()=>{Gn=c(),u(),D(),z(),j(),ue(),be(),J(),q(),Y(),K(),W(),a(),U(),L(),R(),G(),F(),p(),Je(),Xe(),Yt(),tn(),Z=[`plugins`],Kn=`openai-curated-marketplaces-hidden`,qn=4,Jn=[],Yn=[],Xn=[],Zn=[],Qn=[],Q=[],$n=[m],er=[m,O],tr=`computer-use`,nr=`.tmp/marketplaces/openai-internal-testing`,rr=[`datadog`,`statsig`],ir=new Set([`codex-official`,v,m,O,`openai-primary-runtime`].map(In)),ar=l(d,({buildFlavor:e,hostId:t,installSuggestionPluginNames:n,isOpenAICuratedRemoteMarketplaceEnabled:r,marketplaceKinds:i,roots:a,shouldHideOpenAICuratedMarketplaces:o},{queryClient:s})=>{let c=Sn({isOpenAICuratedRemoteMarketplaceEnabled:r,shouldHideOpenAICuratedMarketplaces:o}),l=n==null?bn(t,a,i,r,o):_n(t,a,Xn,n,r,o);return{queryKey:l,queryFn:async()=>{if(n!=null){let e=await M(`send-cli-request-for-host`,{hostId:t,method:`plugin/installed`,params:{...a.length>0?{cwds:a}:{},installSuggestionPluginNames:n}}),r=Cn(e.marketplaces,c),i=Un(r,s.getQueryData(l)?.plugins);return{featuredPluginIds:Jn,marketplaceLoadErrors:e.marketplaceLoadErrors,marketplaces:Rn(r),plugins:await zn({hostId:t,plugins:i,queryClient:s})}}let r=await M(`list-plugins`,i==null?{hostId:t,...a.length>0?{cwds:a}:{}}:{hostId:t,...a.length>0?{cwds:a}:{},marketplaceKinds:i}),o=Cn(r.marketplaces,c),u=Un(o,s.getQueryData(l)?.plugins),d=e==null?u:Fn({buildFlavor:e,plugins:u}),f=sn(r.featuredPluginIds).filter(e=>!c.some(t=>e.endsWith(`@${t}`)));return{featuredPluginIds:e==null?f:Pn({buildFlavor:e,featuredPluginIds:f}),marketplaceLoadErrors:r.marketplaceLoadErrors,marketplaces:Rn(o),plugins:await zn({hostId:t,plugins:d,queryClient:s})}},staleTime:_.SIX_HOURS,gcTime:1/0}}),or=l(d,({hostId:e,marketplaceKind:t},{queryClient:n})=>{let r=[...Z,`marketplace-kind`,e,t];return{queryKey:r,queryFn:async()=>Un((await M(`list-plugins`,{hostId:e,marketplaceKinds:[t]})).marketplaces,n.getQueryData(r)),staleTime:_.SIX_HOURS}})}));async function cr(e,t,n={}){let{broadcast:r=!1,refetchType:i}=n;await e.invalidateQueries({predicate:({queryKey:e})=>e[0]===$[0]&&e[1]===t,refetchType:i}),r&&I($)}function lr(e,t){return e[0]===$[0]&&e[1]===t}function ur(e,t){if(e==null)return e;let n=new Map(t.map(e=>[e.key,e]));return V(e,e=>{for(let t of e.data)for(let e of t.hooks){let t=n.get(e.key);t!=null&&(t.enabled!=null&&(e.enabled=t.enabled),t.trustedHash!=null&&t.trustedHash===e.currentHash&&(e.trustStatus=`trusted`))}})}var $,dr,fr,pr=e((()=>{B(),u(),j(),ie(),a(),p(),$=[`hooks`],l(d,({hostId:e,cwd:t})=>({queryKey:[...$,e,t],queryFn:()=>{if(t==null)throw Error(`Cannot list hooks without a project root`);return M(`list-hooks-for-host`,{hostId:e,cwds:[t]})},staleTime:_.FIVE_MINUTES,refetchOnWindowFocus:!0,enabled:t!=null})),dr=l(d,({hostId:e,cwds:t})=>({queryKey:[...$,e,t],queryFn:()=>{if(t==null||t.length===0)throw Error(`Cannot list hooks without project roots`);return M(`list-hooks-for-host`,{hostId:e,cwds:t})},staleTime:_.FIVE_MINUTES,enabled:t!=null&&t.length>0})),fr=s(d,e=>({mutationFn:t=>M(`batch-write-config-value`,{hostId:e,edits:[{keyPath:`hooks.state`,value:Object.fromEntries(t.map(({key:e,enabled:t,trustedHash:n})=>[e,{...t==null?{}:{enabled:t},...n==null?{}:{trusted_hash:n}}])),mergeStrategy:`upsert`}],filePath:null,expectedVersion:null,reloadUserConfig:!0}),onMutate:async(t,{client:n})=>{await n.cancelQueries({predicate:({queryKey:t})=>lr(t,e)});let r=n.getQueriesData({predicate:({queryKey:t})=>lr(t,e)});return n.setQueriesData({predicate:({queryKey:t})=>lr(t,e)},e=>ur(e,t)),{previousResponses:r}},onError:(e,t,n,{client:r})=>{n?.previousResponses.forEach(([e,t])=>{r.setQueryData(e,t)})},onSettled:async(t,n,r,i,{client:a})=>{await cr(a,e,{broadcast:!0})}}))})),mr,hr,gr=e((()=>{o(),mr=f(),hr=e=>(0,mr.jsx)(`svg`,{width:16,height:16,viewBox:`0 0 16 16`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,...e,children:(0,mr.jsx)(`path`,{d:`M8 1.66797C11.497 1.66807 14.332 4.503 14.332 8C14.332 11.497 11.497 14.3319 8 14.332C4.50293 14.332 1.66797 11.4971 1.66797 8C1.66797 4.50293 4.50293 1.66797 8 1.66797ZM10.4734 5.39844C10.2332 5.22938 9.90115 5.28718 9.73203 5.52734L6.94688 9.48359L5.72734 8.14219L5.64688 8.07031C5.4472 7.9245 5.16595 7.93359 4.97578 8.10625C4.78548 8.27925 4.74924 8.5591 4.87578 8.77187L4.93984 8.85781L6.60625 10.6914L6.64922 10.7336C6.75422 10.8256 6.89263 10.8736 7.03359 10.8648C7.1945 10.8547 7.34232 10.7717 7.43516 10.6398L10.6023 6.13984C10.7712 5.89974 10.7133 5.56761 10.4734 5.39844Z`,fill:`currentColor`})})}));export{gn as A,Te as B,zn as C,An as D,jn as E,Ye as F,be as G,Ee as H,je as I,ve as K,Ae as L,tn as M,Xt as N,Dn as O,Xe as P,Oe as R,sr as S,Mn as T,xe as U,we as V,Se as W,dn as _,pr as a,ln as b,Z as c,Sn as d,Wn as f,on as g,rn as h,dr as i,Zt as j,pn as k,nn as l,an as m,gr as n,cr as o,yn as p,_e as q,$ as r,fr as s,hr as t,Un as u,cn as v,Ln as w,un as x,Bn as y,De as z};
