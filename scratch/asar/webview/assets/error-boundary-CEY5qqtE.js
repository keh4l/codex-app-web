...
import { n as t, t as n } from "./jsx-runtime-DXKlqYIQ.js";
import {
  R as r,
  c as i,
  h as a,
...
import { m as c } from "./vscode-api-DIjwnE7x.js";
import { M as l, N as u, j as d, ni as f } from "./src-X9SEQR78.js";
import {
  _s as p,
  gs as m,
  vs as h,
} from "./app-server-manager-signals-DixsiAkQ.js";
import { o as g } from "./lib-CUS32m6G.js";
import { t as ee } from "./button-C2sUepLV.js";
import { t as te } from "./spinner-7yDHieeT.js";
import { n as ne } from "./rpc-BySF7Whp.js";
import { m as re } from "./chunk-LFPYN7LY-DR8eRaIS.js";
import { t as ie } from "./use-platform-BKKsmCDx.js";
import { t as ae } from "./info-BmR4E0lq.js";
import { t as oe } from "./download-DMV6CJwk.js";
import { t as se } from "./with-window-CCO3bdQJ.js";
...
function le(e) {
  ...
  return ((t.version = t.version || `10.29.0`), (t[ce] = t[`10.29.0`] || {}));
}
function ue(e, t, n = v) {
...
function be() {
  return _ ? ue(`loggerSettings`, () => ({ enabled: !1 })) : { enabled: !1 };
}
var S = {
    enable: pe,
    disable: me,
...
function Ee(e) {
  ...
  return (
    ...
    t.reverse(),
    Ce.test(De(t).function || ``) &&
      (t.pop(), Ce.test(De(t).function || ``) && t.pop()),
    t
      .slice(0, xe)
      .map((e) => ({
        ...e,
        filename: e.filename || De(t).filename,
        function: e.function || `?`,
      }))
  );
}
...
function Be() {
  ((Re = v.onunhandledrejection),
    (v.onunhandledrejection = function (e) {
      return (w(`unhandledrejection`, e), Re ? Re.apply(this, arguments) : !0);
    }),
...
function Je(e) {
  return (
    e === null || qe(e) || (typeof e != `object` && typeof e != `function`)
  );
}
function Ye(e) {
  return Ue(e, `Object`);
...
function Xe(e) {
  return typeof Event < `u` && tt(e, Event);
}
function Ze(e) {
  return typeof Element < `u` && tt(e, Element);
}
function Qe(e) {
  return Ue(e, `RegExp`);
}
...
function rt(e) {
  return typeof Request < `u` && tt(e, Request);
}
var it = v,
  at = 80;
function E(e, t = {}) {
  ...
  try {
    let n = e,
      ...
      c = (!Array.isArray(t) && t.maxStringLength) || at;
    for (
      ;
      n &&
      i++ < 5 &&
...
function ot(e, t) {
  let n = e,
    r = [];
  if (!n?.tagName) return ``;
  if (it.HTMLElement && n instanceof HTMLElement && n.dataset) {
...
function st() {
  try {
    return it.document.location.href;
  } catch {
    return ``;
  }
}
function ct(e) {
  if (!it.HTMLElement) return null;
  let t = e;
  for (let e = 0; e < 5; e++) {
    if (!t) return null;
...
function dt(e) {
  if (He(e))
    return { message: e.message, name: e.name, stack: e.stack, ...pt(e) };
  if (Xe(e)) {
    let t = {
      type: e.type,
      target: ft(e.target),
      currentTarget: ft(e.currentTarget),
      ...pt(e),
    };
    return (
      typeof CustomEvent < `u` && tt(e, CustomEvent) && (t.detail = e.detail),
      t
    );
  } else return e;
}
...
function gt(e, t) {
  ...
  for (let t = 0; t < e.length; t++) {
    let r = e[t];
    try {
      nt(r) ? n.push(Ae(r)) : n.push(String(r));
    } catch {
...
function k(e = yt()) {
  ...
  return (
    (bt ||= `10000000100040008000100000000000`),
    bt.replace(/[018]/g, (e) => (e ^ ((xt() & 15) >> (e / 4))).toString(16))
  );
}
function St(e) {
...
function At() {
  let { performance: e } = v;
  if (!e?.now || !e.timeOrigin) return kt;
  let t = e.timeOrigin;
  return () => (t + e.now()) / Ot;
}
var jt;
  ...
  Ut = class e {
    ...
    setUser(e) {
      return (
        ...
        this._session && Ft(this._session, { user: e }),
    ...
    addBreadcrumb(e, t) {
      let n = typeof t == `number` ? t : Ht;
      if (n <= 0) return this;
      let r = {
        timestamp: kt(),
        ...e,
        message: e.message ? ht(e.message, 2048) : e.message,
      };
      return (
    ...
    setSDKProcessingMetadata(e) {
      return (
        (this._sdkProcessingMetadata = Rt(this._sdkProcessingMetadata, e, 2)),
        this
      );
    }
    ...
    captureEvent(e, t) {
      ...
      return this._client
        ...
        : (_ &&
            S.warn(`No client configured on scope - will not capture event!`),
          n);
    }
...
function Wt() {
  return ue(`defaultCurrentScope`, () => new Ut());
}
function Gt() {
  return ue(`defaultIsolationScope`, () => new Ut());
}
var Kt = class {
  constructor(e, t) {
    let n;
...
function qt() {
  let e = le(y());
  return (e.stack = e.stack || new Kt(Wt(), Gt()));
}
function Jt(e) {
  return qt().withScope(e);
}
function Yt(e, t) {
  let n = qt();
...
function Xt(e) {
  return qt().withScope(() => e(qt().getIsolationScope()));
}
function Zt() {
  return {
    ...
    withScope: Jt,
    withSetScope: Yt,
    withSetIsolationScope: (e, t) => Xt(t),
    getCurrentScope: () => qt().getScope(),
    getIsolationScope: () => qt().getIsolationScope(),
  };
}
function Qt(e) {
  let t = le(e);
...
function P() {
  return Qt(y()).getCurrentScope();
}
function F() {
  return Qt(y()).getIsolationScope();
}
function $t() {
  return ue(`globalScope`, () => new Ut());
}
function en(...e) {
  let t = Qt(y());
  if (e.length === 2) {
...
var L = `sentry.source`,
  nn = `sentry.sample_rate`,
  rn = `sentry.previous_trace_sample_rate`,
  R = `sentry.op`,
  z = `sentry.origin`,
  an = `sentry.idle_span_finish_reason`,
  on = `sentry.measurement_unit`,
  sn = `sentry.measurement_value`,
  cn = `sentry.custom_span_name`,
  ln = `sentry.profile_id`,
  un = `sentry.exclusive_time`,
  dn = `sentry.link.type`;
function fn(e) {
...
function vn(e, t, n) {
  e && (O(e, hn, gn(n)), O(e, mn, t));
}
function yn(e) {
  let t = e;
  return { scope: t[mn], isolationScope: _n(t[hn]) };
}
var bn = `sentry-`,
  xn = /^sentry-/;
function Sn(e) {
...
function Fn(e) {
  let t = e.getOptions(),
    { host: n } = e.getDsn() || {},
    r;
  return (t.orgId ? (r = String(t.orgId)) : n && (r = Pn(n)), r);
}
function In(e) {
  let t = typeof e == `string` ? jn(e) : Mn(e);
  if (!(!t || !Nn(t))) return t;
}
function Ln(e) {
...
var Rn = RegExp(`^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$`);
function zn(e) {
  if (!e) return;
  let t = e.match(Rn);
  if (!t) return;
...
function Hn(e = M(), t = N(), n) {
  return `00-${e}-${t}-${n ? `01` : `00`}`;
}
function Un(e, t) {
  let n = Ln(t?.sample_rand);
  if (n !== void 0) return n;
  let r = Ln(t?.sample_rate);
...
var nr = `_sentryChildSpans`,
  rr = `_sentryRootSpan`;
function ir(e, t) {
  (O(t, rr, e[rr] || e), e[nr] ? e[nr].add(t) : O(e, nr, new Set([t])));
}
function ar(e, t) {
  e[nr] && e[nr].delete(t);
}
...
function H() {
  let e = Qt(y());
  return e.getActiveSpan ? e.getActiveSpan() : Vt(P());
}
function sr() {
  Wn ||=
    (x(() => {
...
function lr() {
  ...
  ((e.tag = `sentry_tracingErrorCallback`), (cr = !0), Ie(e), ze(e));
}
function U(e) {
...
function dr(e, t) {
  ...
  for (let n of t) {
    if (pr(n)) {
      if (_t(e.description, n)) return (_ && ur(e), !0);
      continue;
    }
    if (!n.name && !n.op) continue;
    let t = n.name ? _t(e.description, n.name) : !0,
      r = n.op ? e.op && _t(e.op, n.op) : !0;
    if (t && r) return (_ && ur(e), !0);
  }
  return !1;
}
function fr(e, t) {
...
function yr(e) {
  ...
  let l = a?.get(`sentry.dsc`),
    u = l && Sn(l);
  if (u) return s(u);
  let d = _r(e.spanContext().traceId, t),
    f = i[L],
    p = r.description;
  return (
    f !== `url` && p && (d.transaction = p),
    U() &&
      ((d.sampled = String(er(n))),
      (d.sample_rand =
        a?.get(`sentry.sample_rand`) ??
        yn(n).scope?.getPropagationContext().sampleRand.toString())),
    s(d),
...
function xr(e, t = 3, n = 100 * 1024) {
  let r = W(e, t);
  return Er(r) > n ? xr(e, t - 1, n) : r;
}
function Sr(e, t, n = 1 / 0, r = 1 / 0, i = Dr()) {
  let [a, o] = i;
  if (
    t == null ||
...
function Cr(e, t) {
  try {
    ...
    if (typeof t == `function`) return `[Function: ${C(t)}]`;
...
function Mr(e) {
  ...
  function i(e) {
    typeof r == `string`
      ? (r = typeof e == `string` ? r + e : [jr(r), e])
      : r.push(typeof e == `string` ? jr(e) : e);
  }
  for (let e of n) {
    let [t, n] = e;
    if (
...
function Fr(e) {
  let t = typeof e.data == `string` ? jr(e.data) : e.data;
  return [
    {
      type: `attachment`,
      length: t.length,
...
function Hr(e, t, n, r) {
  ...
  Br(e, n?.sdk);
  let o = zr(e, i, r, t);
  return (delete e.sdkProcessingMetadata, Or(o, [[{ type: a }, e]]));
}
function Ur(e, t) {
  function n(e) {
  ...
  let r = yr(e[0]),
    ...
    l = c?.length ? e.filter((e) => !dr(B(e), c)) : e,
    u = e.length - l.length;
...
var Jr = 1e3,
  Yr = class {
    ...
    updateName(e) {
      ...
      this._endTime || ((this._endTime = Xn(e)), Gr(this), this._onSpanEnded());
    }
    getSpanJSON() {
      return {
    ...
    addEvent(e, t, n) {
      ...
      let r = Xr(t) ? t : n || A(),
        i = Xr(t) ? {} : t || {},
        a = { name: e, time: Xn(r), attributes: i };
    ...
    _onSpanEnded() {
      ...
      if (
        ...
        !(this._isStandaloneSpan || this === V(this)))
      )
        return;
      ...
      t && (yn(this).scope || P()).captureEvent(t);
    }
    _convertSpanToTransaction() {
      ...
      let { scope: e, isolationScope: t } = yn(this),
        n = e?.getScopeData().sdkProcessingMetadata?.normalizedRequest;
      if (this._sampled !== !0) return;
      let r = or(this)
          .filter((e) => e !== this && !Qr(e))
          .map((e) => B(e))
          .filter(Zr),
        i = this._attributes[L];
      (delete this._attributes[cn],
        r.forEach((e) => {
          delete e.data[cn];
        }));
      let a = {
          contexts: { trace: Gn(this) },
          spans:
            r.length > Jr
              ? r
          ...
          sdkProcessingMetadata: {
            ...
            dynamicSamplingContext: yr(this),
          },
          request: n,
...
var ri = `__SENTRY_SUPPRESS_TRACING__`;
function ii(e, t) {
  let n = li();
...
function ai(e) {
  ...
  return (
    ...
    return e.onlyIfParent && !a
      ? new br()
      : si({ parentSpan: a, spanArguments: n, forceTransaction: r, scope: t });
  });
}
function oi(e, t) {
  let n = li();
...
function si({
  ...
  let i = F(),
    a;
  if (e && !n) ((a = di(e, r, t)), ir(e, a));
  else if (e) {
    let n = yr(e),
      { traceId: i, spanId: o } = e.spanContext(),
      s = er(e);
    ((a = ui({ traceId: i, parentSpanId: o, ...t }, r, s)), gr(a, n));
  } else {
    let {
      traceId: e,
      dsc: n,
    ...
    ((a = ui({ traceId: e, parentSpanId: o, ...t }, r, s)), n && gr(a, n));
  }
  return (Wr(a), vn(a, r, i), a);
}
function ci(e) {
  let t = { isStandalone: (e.experimental || {}).standalone, ...e };
  if (e.startTime) {
    let n = { ...t };
    return ((n.startTimestamp = Xn(e.startTime)), delete n.startTime, n);
  }
  return t;
}
function li() {
...
function ui(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[ri]
      ? [!1]
      : ni(
          i,
          {
            ...
            parentSampled: s,
            attributes: c,
            parentSampleRate: Ln(l.dsc?.sample_rate),
          },
          l.sampleRand,
        ),
    p = new Yr({
      ...e,
      attributes: { [L]: `custom`, [nn]: d !== void 0 && f ? d : void 0, ...c },
      sampled: u,
    });
  return (
    !u &&
...
function di(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    a = t.getScopeData().sdkProcessingMetadata[ri] ? !1 : er(e),
    o = a
      ? new Yr({ ...n, parentSpanId: r, traceId: i, sampled: a })
      : new br({ traceId: i });
  ir(e, o);
  let s = I();
  return (
...
function pi(e) {
  return e === void 0 ? (e) => e() : (t) => oi(e, t);
}
var mi = { idleTimeout: 1e3, finalTimeout: 3e4, childSpanTimeout: 15e3 },
  hi = `heartbeatFailed`,
  gi = `idleTimeout`,
  _i = `finalTimeout`,
  vi = `externalFinish`;
function yi(e, t = {}) {
  let n = new Map(),
    ...
    s = [],
    {
      idleTimeout: c = mi.idleTimeout,
      finalTimeout: l = mi.finalTimeout,
      childSpanTimeout: u = mi.childSpanTimeout,
      beforeSpanEnd: d,
  ...
  if (!p || !U()) {
    let e = new br();
    return (gr(e, { sample_rate: `0`, sampled: `false`, ...yr(e) }), e);
  }
  let m = P(),
    h = H(),
    g = bi(e);
  g.end = new Proxy(g.end, {
    apply(e, t, n) {
      if ((d && d(g), t instanceof br)) return;
      let [r, ...i] = n,
        a = Xn(r || A()),
        o = or(g).filter((e) => e !== g),
        s = B(g);
  ...
  function ae(e) {
    ((r = !0), n.clear(), s.forEach((e) => e()), Bt(m, h));
    let t = B(g),
      { start_timestamp: i } = t;
    if (!i) return;
    t.data[`sentry.idle_span_finish_reason`] || g.setAttribute(an, a);
    let o = t.status;
    ((!o || o === `unknown`) && g.setStatus({ code: 1 }),
      S.log(`[Tracing] Idle span "${t.op}" finished`));
    let u = or(g).filter((e) => e !== g),
      d = 0;
    (u.forEach((t) => {
      t.isRecording() &&
    ...
    s.push(
      p.on(`spanStart`, (e) => {
        r ||
          e === g ||
          B(e).timestamp ||
          (e instanceof Yr && e.isStandaloneSpan()) ||
          (or(g).includes(e) && re(e.spanContext().spanId));
      }),
    ),
    s.push(
      p.on(`spanEnd`, (e) => {
...
function bi(e) {
  let t = ai(e);
  return (Bt(P(), t), _ && S.log(`[Tracing] Started span is an idle span`), t);
}
var xi = 0,
  Si = 1,
  Ci = 2;
...
var Ei = class e {
  constructor(e) {
    ((this._state = xi), (this._handlers = []), this._runExecutor(e));
  }
  then(t, n) {
    return new e((e, r) => {
      (this._handlers.push([
  ...
  _executeHandlers() {
    ...
    ((this._handlers = []),
      e.forEach((e) => {
        e[0] ||=
          (this._state === Si && e[1](this._value),
          this._state === Ci && e[2](this._value),
          !0);
      }));
  }
  _runExecutor(e) {
...
function Oi(e, t, n, r) {
  ...
  return (
    ...
    $e(a) ? a.then((e) => Oi(e, t, n, r + 1)) : Oi(a, t, n, r + 1)
  );
}
function ki(e, t) {
  let { fingerprint: n, span: r, breadcrumbs: i, sdkProcessingMetadata: a } = t;
  (Mi(e, t), r && Fi(e, r), Ii(e, n), Ni(e, i), Pi(e, a));
}
function Ai(e, t) {
  let {
    extra: n,
  ...
  (ji(e, `extra`, n),
    ...
    ji(e, `user`, i),
    ji(e, `contexts`, a),
    (e.sdkProcessingMetadata = Rt(e.sdkProcessingMetadata, s, 2)),
    o && (e.level = o),
...
function Fi(e, t) {
  ((e.contexts = { trace: Kn(t), ...e.contexts }),
    (e.sdkProcessingMetadata = {
      dynamicSamplingContext: yr(t),
      ...e.sdkProcessingMetadata,
    }));
...
function Vi(e) {
  ...
  let r = t ? Object.keys(t) : [],
    i = n ? Object.keys(n) : [];
  if (Bi && r.length === Ri && i.length === zi) return Bi;
  ((Ri = r.length), (zi = i.length), (Bi = {}), (Li ||= {}));
  let a = (t, n) => {
    for (let r of t) {
      let t = n[r],
        i = Li?.[r];
      if (i && Bi && t) ((Bi[i[0]] = t), Li && (Li[r] = [i[0], t]));
      else if (t) {
        let n = e(r);
...
function Hi(e, t, n, r, i, a) {
  ...
  (Ui(c, e),
    ...
    t.type === void 0 && Wi(c, e.stackParser));
  let u = Ji(r, n.captureContext);
  n.mechanism && Tt(c, n.mechanism);
  let d = i ? i.getEventProcessors() : [],
    f = $t().getScopeData();
  (a && Ai(f, a.getScopeData()), u && Ai(f, u.getScopeData()));
  let p = [...(n.attachments || []), ...f.attachments];
  return (
    p.length && (n.attachments = p),
    ki(c, f),
    Di([...d, ...f.eventProcessors], c, n).then(
      (e) => (e && Gi(e), typeof o == `number` && o > 0 ? qi(e, o, s) : e),
    )
  );
}
function Ui(e, t) {
  ...
  ((e.environment = e.environment || n || `production`),
    ...
    !e.dist && i && (e.dist = i));
  let o = e.request;
  (o?.url && a && (o.url = ht(o.url, a)),
    a &&
      e.exception?.values?.forEach((e) => {
        e.value &&= ht(e.value, a);
      }));
}
function Wi(e, t) {
  let n = Vi(t);
  ...
  return (
    e.contexts?.trace &&
      ...
      e.contexts.trace.data &&
        (r.contexts.trace.data = W(e.contexts.trace.data, t, n))),
    e.spans &&
    ...
    e.contexts?.flags &&
      r.contexts &&
      (r.contexts.flags = W(e.contexts.flags, 3, n)),
    r
  );
}
function Ji(e, t) {
  if (!t) return e;
  let n = e ? e.clone() : new Ut();
  return (n.update(t), n);
}
function Yi(e) {
  if (e) return Xi(e) || Qi(e) ? { captureContext: e } : e;
}
function Xi(e) {
...
function Qi(e) {
  return Object.keys(e).some((e) => Zi.includes(e));
}
function $i(e, t) {
  return P().captureException(e, Yi(t));
}
function ea(e, t) {
...
function ia(e) {
  let t = F(),
    ...
    a = t.getSession();
  return (
    a?.status === `ok` && Ft(a, { status: `exited` }),
    aa(),
    t.setSession(i),
    i
  );
...
function ua(e) {
  return `${la(e)}${e.projectId}/envelope/`;
}
function da(e, t) {
  let n = { sentry_version: ca };
  return (
...
function xa(e, t) {
  ...
  let r = e.getOptions(),
    i = ba(n, r._metadata, r.tunnel, e.getDsn());
  (Ca().set(e, []), e.emit(`flushLogs`), e.sendEnvelope(i));
}
function Sa(e) {
  return Ca().get(e);
}
function Ca() {
  return ue(`clientToLogBufferMap`, () => new WeakMap());
}
function wa(e) {
  return [
    {
...
function Ea(e, t) {
  ...
  if (n.length === 0) return;
  let r = e.getOptions(),
    i = Ta(n, r._metadata, r.tunnel, e.getDsn());
  (Oa().set(e, []), e.emit(`flushMetrics`), e.sendEnvelope(i));
}
function Da(e) {
  return Oa().get(e);
}
function Oa() {
  return ue(`clientToMetricBufferMap`, () => new WeakMap());
}
var ka = Symbol.for(`SentryBufferFullError`);
function Aa(e = 100) {
  let t = new Set();
  function n() {
    return t.size < e;
...
function Ma(e, t = Date.now()) {
  ...
  let r = Date.parse(`${e}`);
  return isNaN(r) ? ja : r - t;
}
function Na(e, t) {
  return e[t] || e.all || 0;
}
function Pa(e, t, n = Date.now()) {
  return Na(e, t) > n;
}
function Fa(e, { statusCode: t, headers: n }, r = Date.now()) {
  let i = { ...e },
  ...
  else o ? (i.all = r + Ma(o, r)) : t === 429 && (i.all = r + 60 * 1e3);
  return i;
}
function Ia(e, t, n = Aa(e.bufferSize || 64)) {
  let r = {},
    i = (e) => n.drain(e);
  function a(i) {
    let a = [];
    if (
      (Ar(i, (t, n) => {
        let i = Lr(n);
        Pa(r, i) ? e.recordDroppedEvent(`ratelimit_backoff`, i) : a.push(t);
      }),
      a.length === 0)
    )
...
function La(e, t, n) {
  let r = [
    { type: `client_report` },
    { timestamp: n || kt(), discarded_events: e },
  ];
  return Or(t ? { dsn: t } : {}, [r]);
}
function Ra(e) {
...
var Va = `Not capturing exception because it's already been captured.`,
  Ha = `Discarded session because of missing or non-string release`,
  Ua = Symbol.for(`SentryInternalError`),
  Wa = Symbol.for(`SentryDoNotSendEventError`),
  Ga = 5e3;
function Ka(e) {
...
var Za = class {
  constructor(e) {
    if (
      ...
      (this._hooks = {}),
      (this._eventProcessors = []),
      (this._promiseBuffer = Aa(e.transportOptions?.bufferSize ?? 64)),
      e.dsn
        ? (this._dsn = In(e.dsn))
        : _ && S.warn(`No DSN provided, client will not send events.`),
      this._dsn)
    ) {
      let t = fa(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
    ...
    ((this._options.enableLogs =
      ...
      this._options.enableLogs &&
        Xa(this, `afterCaptureLog`, `flushLogs`, io, xa),
      (this._options.enableMetrics ??
        this._options._experiments?.enableMetrics ??
        !0) &&
        Xa(this, `afterCaptureMetric`, `flushMetrics`, ro, Ea));
  }
  captureException(e, t, n) {
    let r = k();
    if (Et(e)) return (_ && S.log(Va), r);
    let i = { event_id: r, ...t };
    return (
      this._process(
        () =>
  ...
  captureEvent(e, t, n) {
    let r = k();
    if (t?.originalException && Et(t.originalException))
      return (_ && S.log(Va), r);
    let i = { event_id: r, ...t },
  ...
  captureSession(e) {
    (this.sendSession(e), Ft(e, { init: !1 }));
  }
  getDsn() {
    return this._dsn;
  }
  ...
  sendSession(e) {
    ...
    let r = Vr(e, this._dsn, this._options._metadata, this._options.tunnel);
    this.sendEnvelope(r);
  }
  recordDroppedEvent(e, t, n = 1) {
    if (this._options.sendClientReports) {
      let r = `${e}:${t}`;
      (_ && S.log(`Recording outcome: "${r}"${n > 1 ? ` (${n} times)` : ``}`),
  ...
  _setupIntegrations() {
    ...
    ((this._integrations = ga(this, e)), _a(this, e));
  }
  ...
  _prepareEvent(e, t, n, r) {
    ...
    return (
      ...
      Hi(i, e, t, n, this, r).then((e) =>
        e === null
          ? e
          : (this.emit(`postprocessEvent`, e, t),
            (e.contexts = { trace: tn(n), ...e.contexts }),
            (e.sdkProcessingMetadata = {
              dynamicSamplingContext: vr(this, n),
              ...e.sdkProcessingMetadata,
            }),
            e),
      )
  ...
  _captureEvent(e, t = {}, n = P(), r = F()) {
    return (
      _ &&
        to(e) &&
        S.log(`Captured error event \`${Ra(e)[0] || `<unknown>`}\``),
      this._processEvent(e, t, n, r).then(
        (e) => e.event_id,
        (e) => {
          _ &&
            (Ya(e) ? S.log(e.message) : Ja(e) ? S.warn(e.message) : S.warn(e));
        },
      )
    );
  }
    ...
    return this._prepareEvent(e, t, n, r)
      ...
      .then((i) => {
        if (i === null) {
          ...
          throw qa(`${c} returned \`null\`, will not send event.`);
        }
  ...
  _process(e, t) {
    (this._numProcessing++,
      this._promiseBuffer.add(e).then(
        ...
        (e) => (
          this._numProcessing--,
          e === ka && this.recordDroppedEvent(`queue_overflow`, t),
          e
        ),
      ));
  }
  ...
  _flushOutcomes() {
    ...
    let t = La(e, this._options.tunnel && An(this._dsn));
    this.sendEnvelope(t);
  }
};
function Qa(e) {
...
function $a(e, t) {
  ...
  if ($e(e))
    return e.then(
      (e) => {
        if (!Ye(e) && e !== null) throw Ka(n);
        return e;
      },
      (e) => {
        throw Ka(`${t} rejected with ${e}`);
      },
    );
  if (!Ye(e) && e !== null) throw Ka(n);
  return e;
...
function eo(e, t, n, r) {
  ...
  if (no(c)) {
    if (o || s) {
      let t = za(c);
      if (s?.length && dr(t, s)) return null;
      if (o) {
        let e = o(t);
        e ? (c = Rt(n, Ba(e))) : sr();
      }
...
function _o(e, t, n = [t], r = `npm`) {
  let i = e._metadata || {};
  ((i.sdk ||= {
    name: `sentry.javascript.${t}`,
    packages: n.map((e) => ({ name: `${r}:@sentry/${e}`, version: ce })),
    version: ce,
  }),
    (e._metadata = i));
}
...
function So(e, t) {
  let n = I(),
    r = F();
  if (!n) return;
  let { beforeBreadcrumb: i = null, maxBreadcrumbs: a = xo } = n.getOptions();
  if (a <= 0) return;
  let o = { timestamp: kt(), ...e },
    s = i ? x(() => i(o, t)) : o;
  s !== null &&
...
var Co,
  ...
  ko = G((e = {}) => {
    ...
    return {
      ...
      processEvent(n, r, i) {
        return ((t ||= jo(e, i.getOptions())), Mo(n, t) ? null : n);
      },
    };
  }),
  Ao = G((e = {}) => ({ ...ko(e), name: `InboundFilters` }));
function jo(e = {}, t = {}) {
  return {
...
function Mo(e, t) {
  ...
  } else if (e.type === `transaction` && Po(e, t.ignoreTransactions))
    return (
      _ &&
        S.warn(
...
function No(e, t) {
  return t?.length ? Ra(e).some((e) => vt(e, t)) : !1;
}
function Po(e, t) {
...
function Ro(e) {
  try {
    ...
    return (_ && S.error(`Cannot extract url for event ${Ct(e)}`), null);
  }
}
function zo(e) {
...
function Bo(e, t, n, r, i, a) {
  if (!i.exception?.values || !a || !tt(a.originalException, Error)) return;
  let o =
    i.exception.values.length > 0
      ? i.exception.values[i.exception.values.length - 1]
      : void 0;
  o &&
    (i.exception.values = Vo(
      e,
      t,
      r,
      a.originalException,
...
function Vo(e, t, n, r, i, a, o, s) {
  ...
  if (tt(r[i], Error)) {
    ...
    let a = e(t, r[i]),
      l = c.length;
    (Uo(a, i, l, s), (c = Vo(e, t, n, r[i], i, [a, ...c], a, l)));
  }
  return (
...
function Go() {
  `console` in v &&
    de.forEach(function (e) {
      e in v.console &&
        D(v.console, e, function (t) {
          return (
            (b[e] = t),
            function (...t) {
              (w(`console`, { args: t, level: e }), b[e]?.apply(v.console, t));
            }
          );
        });
    });
...
function rs(e, t, n, r) {
  let i = vo({ span: n, propagateTraceparent: r }),
    ...
    s = i.traceparent;
  if (!a) return;
  let c = t.headers || (rt(e) ? e.headers : void 0);
  if (!c) return { ...i };
  if (os(c)) {
    let e = new Headers(c);
    if (
      ...
      let t = e.get(`baggage`);
      t ? as(t) || e.set(`baggage`, `${t},${o}`) : e.set(`baggage`, o);
    }
    return e;
    ...
    let t = c.find((e) => e[0] === `baggage` && as(e[1]));
    ...
    let e = `sentry-trace` in c ? c[`sentry-trace`] : void 0,
      ...
      l = n && (Array.isArray(n) ? n.find((e) => as(e)) : as(n));
    o && !l && i.push(o);
    let u = {
      ...c,
      "sentry-trace": e ?? a,
...
function as(e) {
  return e.split(`,`).some((e) => e.trim().startsWith(bn));
}
function os(e) {
...
function ss(e, t, n) {
  let r = fo(e);
  return { name: r ? `${t} ${po(r)}` : t, attributes: cs(e, r, t, n) };
}
function cs(e, t, n, r) {
  let i = {
    url: e,
  ...
  return (
    t &&
      (uo(t) || ((i[`http.url`] = t.href), (i[`server.address`] = t.host)),
  ...
  if (t && typeof t.createElement == `function`)
    try {
      ...
      ((n.hidden = !0),
        ...
        n.contentWindow?.fetch && (e = ps(n.contentWindow.fetch)),
...
function Ss(e) {
  ...
  if (e.length === 2) {
    ...
    return {
      url: xs(t),
      method: bs(n, `method`) ? String(n.method).toUpperCase() : `GET`,
    };
  }
  let t = e[0];
  return {
    url: xs(t),
    method: bs(t, `method`) ? String(t.method).toUpperCase() : `GET`,
  };
}
function Cs(e) {
  let [t, n] = e;
  try {
    ...
    if (rt(t)) return new Headers(t.headers);
  } catch {}
}
function ws() {
...
var Fs = `sentry-electron-renderer-id`;
function Is(e) {
  let t = Ps(e);
...
function Rs(e = I()) {
  ...
  let n = e.getOptions().ipcNamespace,
    r = Is(n);
  return (Ls.set(e, r), r.sendRendererStart(), r);
}
var K = v,
  zs = 0;
function Bs() {
    ...
    try {
      ...
      throw (
        ...
        en((r) => {
          (r.addEventProcessor(
            (e) => (
              t.mechanism && (wt(e, void 0, void 0), Tt(e, t.mechanism)),
...
function Gs(e, t, n, r) {
  let i = I()?.getOptions().normalizeDepth,
    a = oc(t),
    o = { __serialized__: xr(t, i) };
  if (a) return { exception: { values: [Ws(e, a)] }, extra: o };
  let s = {
    exception: {
      values: [
        {
          type: Xe(t) ? t.constructor.name : r ? `UnhandledRejection` : `Error`,
          value: ic(t, { isUnhandledRejection: r }),
        },
      ],
    },
    extra: o,
...
function Ys(e) {
  return e && Js.test(e.message) ? 1 : 0;
}
function Xs(e) {
...
function ec(e, t, n, r) {
  let i = nc(e, t, n?.syntheticException || void 0, r);
  return (
    Tt(i),
    (i.level = `error`),
...
function tc(e, t, n = `info`, r, i) {
  let a = rc(e, t, r?.syntheticException || void 0, i);
  return ((a.level = n), r?.event_id && (a.event_id = r.event_id), wi(a));
}
function nc(e, t, n, r, i) {
  let a;
  if (We(t) && t.error) return Ks(e, t.error);
  if (Ge(t) || Ke(t)) {
    let i = t;
    if (`stack` in t) a = Ks(e, t);
    else {
  ...
  return He(t)
    ? Ks(e, t)
    : Ye(t) || Xe(t)
      ? ((a = Gs(e, t, n, i)), Tt(a, { synthetic: !0 }), a)
      : ((a = rc(e, t, n, r)),
        wt(a, `${t}`, void 0),
        Tt(a, { synthetic: !0 }),
        a);
...
function ic(e, { isUnhandledRejection: t }) {
  let n = mt(e),
    r = t ? `promise rejection` : `exception`;
  return We(e)
    ? `Event \`ErrorEvent\` captured as ${r} with message \`${e.message}\``
    : Xe(e)
      ? `Event \`${ac(e)}\` (type=${e.type}) captured as ${r}`
...
var sc = class extends Za {
  constructor(e) {
    let t = cc(e);
    (_o(t, `browser`, [`browser`], K.SENTRY_SDK_SOURCE || Ts()),
      t._metadata?.sdk &&
    ...
    (K.document &&
      ...
      K.document.addEventListener(`visibilitychange`, () => {
        K.document.visibilityState === `hidden` &&
          (r && this._flushOutcomes(), i && xa(this), s && Ea(this));
      }),
      n && this.on(`beforeSendSession`, go));
  }
  eventFromException(e, t) {
    return ec(this._options.stackParser, e, t, this._options.attachStacktrace);
  }
...
var lc = typeof __SENTRY_DEBUG__ > `u` || __SENTRY_DEBUG__,
  q = v,
  uc = (e, t) => (e > t[1] ? `poor` : e > t[0] ? `needs-improvement` : `good`),
  dc = (e, t, n, r) => {
    let i, a;
    return (o) => {
      t.value >= 0 &&
        ...
        ((a = t.value - (i ?? 0)),
        (a || i === void 0) &&
          ((i = t.value), (t.delta = a), (t.rating = uc(t.value, n)), e(t)));
    };
  },
  fc = (e = !0) => {
  ...
  yc = (e) => {
    if (xc(e) && gc > -1) {
      if (e.type === `visibilitychange` || e.type === `pagehide`)
        for (let e of _c) e();
      isFinite(gc) ||
        ((gc = e.type === `visibilitychange` ? e.timeStamp : 0),
        hc(`prerenderingchange`, yc, !0));
    }
  },
  bc = () => {
    if (q.document && gc < 0) {
      ...
      ((gc =
        (q.document.prerendering
          ...
          : globalThis.performance
              ...
              ?.startTime) ?? vc()),
        mc(`visibilitychange`, yc, !0),
        mc(`pagehide`, yc, !0),
        mc(`prerenderingchange`, yc, !0));
    }
    return {
      get firstHiddenTime() {
        return gc;
...
var Sc = () =>
  ...
  wc = new WeakMap();
function Tc(e, t) {
  return (wc.get(e) || wc.set(e, new t()), wc.get(e));
}
var Ec = class e {
    constructor() {
          ...
          for (let t of e)
            t.name === `first-contentful-paint` &&
              ...
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - pc(), 0)),
                r.entries.push(t),
                i(!0)));
        });
      a && (i = dc(e, r, Ac, t.reportAllChanges));
    });
  },
  Mc = [0.1, 0.25],
  Nc = (e, t = {}) => {
    jc(
      Oc(() => {
        let n = Cc(`CLS`, 0),
          ...
          s = Dc(`layout-shift`, o);
        s &&
          ((r = dc(e, n, Mc, t.reportAllChanges)),
          i.onHidden(() => {
            (o(s.takeRecords()), r(!0));
          }),
          q?.setTimeout?.(r));
  ...
  Lc = (e) => {
    e.forEach((e) => {
      e.interactionId &&
        ((Fc = Math.min(Fc, e.interactionId)),
        (Ic = Math.max(Ic, e.interactionId)),
        (Pc = Ic ? (Ic - Fc) / 7 + 1 : 0));
    });
  },
  Rc,
  zc = () => (Rc ? Pc : performance.interactionCount || 0),
  Bc = () => {
  ...
  Wc = class e {
    ...
    _processEntry(e) {
      ...
      if (
        n ||
        this._longestInteractionList.length < Vc ||
        ...
        if (
          ...
          let e = this._longestInteractionList.splice(Vc);
  ...
  Gc = (e) => {
    let t = (t) => {
      (t.type === `pagehide` || q.document?.visibilityState === `hidden`) &&
        e(t);
    };
    (mc(`visibilitychange`, t, !0), mc(`pagehide`, t, !0));
  },
  Kc = (e) => {
    ...
    q.document?.visibilityState === `hidden`
      ...
      : ((e = Oc(e)),
        ...
        t(() => {
          (e(), hc(`visibilitychange`, e, { capture: !0 }));
        }),
        Gc(e));
  },
  qc = [200, 500],
  ...
  Yc = (e, t = {}) => {
    ...
    kc(() => {
      ...
      let r = Cc(`INP`),
        ...
        s = Dc(`event`, o, { durationThreshold: t.durationThreshold ?? Jc });
      ((i = dc(e, r, qc, t.reportAllChanges)),
        s &&
  ...
  Qc = (e, t = {}) => {
    kc(() => {
      let n = bc(),
        ...
        s = Dc(`largest-contentful-paint`, o);
      if (s) {
        i = dc(e, r, Zc, t.reportAllChanges);
        let n = Oc(() => {
            (o(s.takeRecords()), s.disconnect(), i(!0));
          }),
          a = (e) => {
            e.isTrusted && (Kc(n), hc(e.type, a, { capture: !0 }));
          };
  ...
  el = (e) => {
    q.document?.prerendering
      ...
      : q.document?.readyState === `complete`
        ? setTimeout(e)
        : addEventListener(`load`, () => el(e), !0);
  },
  tl = (e, t = {}) => {
    let n = Cc(`TTFB`),
      r = dc(e, n, $c, t.reportAllChanges);
    el(() => {
      let e = fc();
      e &&
        ((n.value = Math.max(e.responseStart - pc(), 0)),
        (n.entries = [e]),
        r(!0));
    });
  },
  ...
  sl;
function cl(e, t = !1) {
  return vl(`cls`, e, ml, il, t);
}
function ll(e, t = !1) {
  return vl(`lcp`, e, hl, al, t);
}
function ul(e) {
  return vl(`ttfb`, e, gl, ol);
}
function dl(e) {
  return vl(`inp`, e, _l, sl);
}
function fl(e, t) {
  return (bl(e, t), rl[e] || (yl(e), (rl[e] = !0)), xl(e, t));
}
function pl(e, t) {
  let n = nl[e];
  if (n?.length)
...
function gl() {
  return tl((e) => {
    (pl(`ttfb`, { metric: e }), (ol = e));
  });
}
function _l() {
  return Yc((e) => {
    (pl(`inp`, { metric: e }), (sl = e));
  });
}
...
function jl(e, t, n, r) {
  ...
  let c = Tl({ name: o, transaction: a, attributes: s, startTime: i });
  c && (c.addEvent(`cls`, { [on]: ``, [sn]: e }), c.end(i));
}
function Ml(e) {
  let t = 0,
    n;
  if (!Ol(`largest-contentful-paint`)) return;
  let r = ll(({ metric: e }) => {
    let r = e.entries[e.entries.length - 1];
    r && ((t = e.value), (n = r));
  }, !0);
...
function Nl(e, t, n, r) {
  ...
  let c = Tl({ name: o, transaction: a, attributes: s, startTime: i });
  c && (c.addEvent(`lcp`, { [on]: `millisecond`, [sn]: e }), c.end(i));
}
function Y(e) {
...
function Pl(e) {
  ...
  if (e.nextHopProtocol != null) {
    let { name: n, version: r } = Dl(e.nextHopProtocol);
    ((t[`network.protocol.version`] = r), (t[`network.protocol.name`] = n));
  }
  return j() || El()?.timeOrigin
    ? Fl({
        ...t,
      ...
      for (let n of e)
        if (n.name === `click`) {
          let e = J(j() + n.startTime),
            ...
            a = ct(n.target);
          (a && (i.attributes[`ui.component_name`] = a), wl(t, e, e + r, i));
        }
    }
  });
}
function Ul() {
  return cl(({ metric: e }) => {
    ...
    t && ((X.cls = { value: e.value, unit: `` }), (Rl = t));
  }, !0);
}
function Wl() {
  return ll(({ metric: e }) => {
  ...
  (a.slice(Ll).forEach((n) => {
    ...
    if (!(o === `navigation` && s && i + r < s))
      switch (n.entryType) {
        ...
        case `paint`:
        case `measure`: {
          Jl(e, n, r, a, i, t.ignorePerformanceApiSpans);
          let o = bc(),
        ...
        case `resource`:
          eu(e, n, n.name, r, a, i, t.ignoreResourceSpans);
          break;
      }
  }),
    (Ll = Math.max(a.length - 1, 0)),
    tu(e),
    o === `pageload` &&
      (iu(X),
      ...
      e.setAttribute(`performance.activationStart`, pc()),
      nu(e, t)),
    (Z = void 0),
    (Rl = void 0),
    (X = {}));
...
function Jl(e, t, n, r, i, a) {
  if (ql(t) || ([`mark`, `measure`].includes(t.entryType) && vt(t.name, a)))
    return;
  let o = fc(!1),
  ...
  (c !== l &&
    ...
    Yl(d, t),
    c <= u && wl(e, c, u, { name: t.name, op: t.entryType, attributes: d }));
}
function Yl(e, t) {
  try {
    let n = t.detail;
...
function Xl(e, t, n) {
  ([
    ...
    Zl(e, t, `secureConnection`, n, `TLS/SSL`),
    Zl(e, t, `fetch`, n, `cache`),
    Zl(e, t, `domainLookup`, n, `DNS`),
    $l(e, t, n));
}
function Zl(e, t, n, r, i = n) {
  let a = t[Ql(n)],
    o = t[`${n}Start`];
  !o ||
    !a ||
...
function tu(e) {
  ...
  (n &&
    ...
    Cl(n.rtt) && (X[`connection.rtt`] = { value: n.rtt, unit: `millisecond` })),
    Cl(t.deviceMemory) &&
      e.setAttribute(`deviceMemory`, `${t.deviceMemory} GB`),
    Cl(t.hardwareConcurrency) &&
...
function ru(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
    i != null &&
      ((typeof i == `number` && i < Il) || typeof i == `string`) &&
      (t[r] = i);
  });
}
function iu(e) {
...
function au() {
  return El() && j() ? fl(`element`, ou) : () => void 0;
}
var ou = ({ entries: e }) => {
    let t = H(),
      n = t ? V(t) : void 0,
...
function pu(e) {
  if (e.type !== lu) return !1;
  try {
    if (!e.target || e.target._sentryId !== uu) return !1;
  } catch {}
  return !0;
}
function mu(e, t) {
  ...
  if (
    (q.addEventListener(`popstate`, () => {
      let e = q.location.href,
        t = _u;
      ((_u = e), t !== e && w(`history`, { from: t, to: e }));
    }),
    !ds())
  )
    return;
  function e(e) {
    return function (...t) {
      ...
      if (n) {
        let r = _u,
          i = bu(String(n));
        if (((_u = i), r === i)) return e.apply(this, t);
...
function Su(e) {
  ...
  return n && (xu[e] = n.bind(q));
}
function Cu(e) {
  xu[e] = void 0;
}
var wu = `__sentry_xhr_v3__`;
function Tu(e) {
  (Ne(`xhr`, e), Pe(`xhr`, Eu));
}
function Eu() {
  ...
  ((e.open = new Proxy(e.open, {
    apply(e, t, n) {
      let r = Error(),
        i = A() * 1e3,
        a = T(n[0]) ? n[0].toUpperCase() : void 0,
        o = Du(n[1]);
      if (!a || !o) return e.apply(t, n);
      ((t[wu] = { method: a, url: o, request_headers: {} }),
        a === `POST` &&
          o.match(/sentry_key/) &&
        ...
        (t.setRequestHeader = new Proxy(t.setRequestHeader, {
          apply(e, t, n) {
            let [r, i] = n,
              a = t[wu];
            return (
              a && T(r) && T(i) && (a.request_headers[r.toLowerCase()] = i),
              e.apply(t, n)
            );
          },
        })),
...
function Ou(e) {
  ...
  try {
    ...
    return (lc && S.error(t, `Failed to get xhr response headers`, e), {});
  }
  return t
    ? t
        .split(
...
var Iu = ({ metric: e }) => {
  ...
  let t = J(e.value);
  if (t > Mu) return;
  let n = e.entries.find((t) => t.duration === e.value && Pu[t.name]);
  if (!n) return;
  ...
  d &&
    (d.addEvent(`inp`, { [on]: `millisecond`, [sn]: e.value }), d.end(a + t));
};
function Lu() {
  let e = Object.keys(Pu);
  Ds() &&
    e.forEach((e) => {
  ...
  function t(e) {
    ...
    if ((ju.set(r, n), ju.size > 50)) {
      let e = ju.keys().next().value;
      e !== void 0 && ju.delete(e);
    }
  }
  function n(e) {
  ...
  let r = ({ entries: e }) => {
    ...
    e.forEach((e) => {
      ...
      if (t == null || Au.has(t)) return;
      let i = e.target ? E(e.target) : n(e);
      if (ku.length > 10) {
        let e = ku.shift();
        Au.delete(e);
      }
      (ku.push(t), Au.set(t, { span: r, elementName: i }));
    });
  };
  (fl(`event`, r), fl(`first-input`, r));
}
var Ru = 40;
function zu(e, t = Su(`fetch`)) {
  let n = 0,
    r = 0;
  async function i(i) {
    let a = i.body.length;
  ...
  return Ia(e, i, Aa(e.bufferSize || Ru));
}
  ...
  qu = [
    ...
    (e) => {
      ...
      if (r) {
        ...
        let [e, t] = Zu(r[1] || `?`, r[2]);
        return Hu(t, e, r[3] ? +r[3] : void 0, r[4] ? +r[4] : void 0);
      }
    },
  ],
  Ju =
    /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
  Yu = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
  Xu = we(qu, [
    Vu,
    (e) => {
      let t = Ju.exec(e);
      if (t) {
        ...
        return (
          ([n, e] = Zu(n, e)),
          Hu(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0)
        );
      }
    },
  ]),
    ...
    return {
      ...
      setup(e) {
        (t.console && Wo(rd(e)),
          ...
          t.fetch && hs(ad(e)),
          t.history && vu(od(e)),
          t.sentry && e.on(`beforeSendEvent`, td(e)));
      },
    };
  });
function td(e) {
...
function nd(e, t) {
  return function (n) {
    ...
    (o &&
      ...
      (Q &&
        S.warn(
          `\`dom.maxStringLength\` cannot exceed ${Qu}, but a value of ${o} was configured. Sentry will use ${Qu} instead.`,
        ),
      (o = Qu)),
      typeof a == `string` && (a = [a]));
    try {
      let e = n.event,
        t = sd(e) ? e.target : e;
      ((r = E(t, { keyAttrs: a, maxStringLength: o })), (i = ct(t)));
    } catch {
      r = `<unknown>`;
    }
    ...
    (i && (s.data = { "ui.component_name": i }),
      So(s, { event: n.event, name: n.name, global: n.global }));
  };
}
function rd(e) {
  return function (t) {
    ...
    So(n, { input: t.args, level: t.level });
  };
}
function id(e) {
  return function (t) {
    ...
    let { method: a, url: o, status_code: s, body: c } = i,
      ...
      d = { category: `xhr`, data: l, type: `http`, level: ls(s) };
    (e.emit(`beforeOutgoingRequestBreadcrumb`, d, u), So(d, u));
  };
}
function ad(e) {
  return function (t) {
    ...
    if (
      ...
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        (e.emit(`beforeOutgoingRequestBreadcrumb`, o, a), So(o, a));
      } else {
        let i = t.response,
        ...
        (e.emit(`beforeOutgoingRequestBreadcrumb`, s, o), So(s, o));
      }
  };
}
function od(e) {
...
var cd =
  ...
  ud = G((e = {}) => {
    ...
    return {
      name: ld,
      setupOnce() {
        (t.setTimeout && D(K, `setTimeout`, dd),
          t.setInterval && D(K, `setInterval`, dd),
          t.requestAnimationFrame && D(K, `requestAnimationFrame`, fd),
          t.XMLHttpRequest &&
            `XMLHttpRequest` in K &&
            D(XMLHttpRequest.prototype, `send`, pd));
        let e = t.eventTarget;
        e && (Array.isArray(e) ? e : cd).forEach((e) => md(e, t));
      },
    };
  });
function dd(e) {
  return function (...t) {
    ...
    return (
      (t[0] = Hs(n, {
        mechanism: {
          handled: !1,
          type: `auto.browser.browserapierrors.${C(e)}`,
        },
      })),
      e.apply(this, t)
    );
        ...
        e in n &&
          ...
          D(n, e, function (t) {
            let n = {
              ...
              r = ut(t);
            return (r && (n.mechanism.data.handler = C(r)), Hs(t, n));
          });
      }),
      e.apply(this, t)
    );
  ...
  n?.hasOwnProperty?.(`addEventListener`) &&
    (D(n, `addEventListener`, function (n) {
      return function (r, i, a) {
        try {
          hd(i) &&
            (i.handleEvent = Hs(i.handleEvent, {
              mechanism: {
                data: { handler: C(i), target: e },
                handled: !1,
        ...
        return (
          t.unregisterOriginalCallbacks && gd(this, r, i),
          n.apply(this, [
            r,
            Hs(i, {
              mechanism: {
...
var _d = G(() => ({
    ...
    setupOnce() {
      ...
      (ia({ ignoreDuration: !0 }),
        sa(),
        vu(({ from: e, to: t }) => {
          e !== void 0 && e !== t && (ia({ ignoreDuration: !0 }), sa());
        }));
    },
  })),
  vd = `GlobalHandlers`,
  yd = G((e = {}) => {
    ...
    return {
      ...
      setup(e) {
        (t.onerror && (bd(e), Td(`onerror`)),
          t.onunhandledrejection && (xd(e), Td(`onunhandledrejection`)));
      },
    };
  });
function bd(e) {
  Ie((t) => {
    ...
    let { msg: i, url: a, line: o, column: s, error: c } = t,
      l = wd(nc(n, c || i, void 0, r, !1), a, o, s);
    ((l.level = `error`),
      ea(l, {
        originalException: c,
        mechanism: {
  ...
  Md = G((e = {}) => {
    ...
    return {
      ...
      preprocessEvent(e, r, i) {
        Bo(Ws, i.getOptions().stackParser, n, t, e, r);
      },
    };
  });
function Nd() {
...
function Fd(e) {
  return [Ao(), Eo(), ud(), ed(), yd(), Md(), Jo(), Od(), _d()];
}
function Id(e = {}) {
  let t = !e.skipBrowserExtensionCheck && Nd(),
    n = e.defaultIntegrations == null ? Fd() : e.defaultIntegrations;
  return so(sc, {
    ...e,
    enabled: t ? !1 : e.enabled,
    stackParser: Te(e.stackParser || Xu),
    integrations: ha({ integrations: e.integrations, defaultIntegrations: n }),
    transport: e.transport || zu,
  });
}
function Ld(e) {
...
function Wd(e, t) {
  ...
  (n &&
    ...
    i &&
      gs((e) => {
        if (e.response) {
          let t = Vd.get(e.response);
          t && e.endTimestamp && Hd.set(t, e.endTimestamp);
        }
      }),
    hs((e) => {
      let t = ts(e, u, d, f, { propagateTraceparent: p, onRequestSpanEnd: l });
      if (
        (e.response &&
          e.fetchData.__span &&
          Vd.set(e.response, e.fetchData.__span),
        t)
      ) {
        let n = Rd(e.fetchData.url),
          r = n ? mo(n).host : void 0;
    ...
    r &&
      Tu((e) => {
        let t = qd(e, u, d, f, p, l);
        t &&
          (o && Gd(t),
          c?.(t, { headers: Bd(e.xhr.__sentry_xhr_v3__?.request_headers) }));
      }));
}
function Gd(e) {
  let { url: t } = B(e).data;
  if (!t || typeof t != `string`) return;
  let n = fl(`resource`, ({ entries: r }) => {
    r.forEach((r) => {
      zd(r) && r.name.endsWith(t) && (e.setAttributes(Pl(r)), setTimeout(n));
    });
  });
}
function Kd(e, t) {
  ...
  if (n) {
    ...
    let a = r.origin === i;
    return t ? vt(r.toString(), t) || (a && vt(r.pathname, t)) : a;
  } else {
    let n = !!e.match(/^\/(?!\/)/);
    return t ? vt(e, t) : n;
  }
...
function qd(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (pn(n, s.status_code),
      n.end(),
      a?.(n, { headers: Bd(Ou(o)), error: e.error }),
      delete r[t]);
    return;
  }
  let d = Rd(c),
  ...
  if (!(i?.[`sentry-trace`] || !e.setRequestHeader))
    try {
      if (
        ...
        let t = i?.baggage;
        (!t || !Ld(t)) && e.setRequestHeader(`baggage`, n);
      }
    } catch {}
}
function Xd() {
...
var Zd = `sentry_previous_trace`,
  Qd = `sentry.previous_trace`;
function $d(e, { linkPreviousTrace: t, consistentTraceSampling: n }) {
    ...
    e.on(`beforeSampling`, (e) => {
      ...
      (t.setPropagationContext({
        ...
        dsc: {
          ...
          sampled: String(rf(i.spanContext)),
        },
        sampleRand: i.sampleRand,
      }),
        (e.parentSampled = rf(i.spanContext)),
        (e.parentSampleRate = i.sampleRate),
        (e.spanAttributes = { ...e.spanAttributes, [rn]: i.sampleRate }));
    });
}
function ef(e, t, n) {
  let r = B(t);
  ...
  return o.traceId === r.trace_id
    ...
    : (Date.now() / 1e3 - e.startTimestamp <= 3600 &&
        ...
        t.setAttribute(Qd, `${o.traceId}-${o.spanId}-${rf(o) ? 1 : 0}`)),
      a);
}
function tf(e) {
  try {
    K.sessionStorage.setItem(Zd, JSON.stringify(e));
  } catch (e) {
...
function nf() {
  try {
    let e = K.sessionStorage?.getItem(Zd);
    return JSON.parse(e);
  } catch {
    return;
  }
      ...
      setup(e) {
        ...
        function t() {
          ...
          t &&
            ...
            (Q &&
              S.log(
                `[Tracing] Finishing current active span with op: ${B(t).op}`,
              ),
            t.setAttribute(an, `cancelled`),
            t.end());
        }
        (e.on(`startNavigationSpan`, (n, r) => {
          ...
          if (r?.isRedirect) {
            (Q &&
              ...
              x(e, { op: `navigation.redirect`, ...n }, !1));
            return;
          }
          ((fe = void 0),
            t(),
          ...
          e.on(`startPageLoadSpan`, (n, r = {}) => {
            ...
            t();
            let i = Bn(
                r.sentryTrace || uf(`sentry-trace`),
                r.baggage || uf(`baggage`),
              ),
              a = P();
            (a.setPropagationContext(i),
              U() || (a.getPropagationContext().propagationSpanId = N()),
              a.setSDKProcessingMetadata({ normalizedRequest: Us() }),
              x(e, { op: `pageload`, ...n }));
          }),
          e.on(`endPageloadSpan`, () => {
            y && b && (b.setAttribute(an, `reportPageLoaded`), b.end());
          }));
      },
      afterAllSetup(e) {
        let n = st();
        if (
          (_ !== `off` &&
            $d(e, { linkPreviousTrace: _, consistentTraceSampling: ce }),
          K.location)
        ) {
          if (ae) {
            let t = j();
...
function lf(e, t, n) {
  ...
  return (
    ...
    r &&
      !i &&
      a.setSDKProcessingMetadata({ normalizedRequest: { ...Us(), url: r } }),
    pf(e)
  );
}
function uf(e) {
  ...
  a &&
    addEventListener(
      ...
      () => {
        ...
        if (
          ((o &&=
            (o.setAttribute(an, `interactionInterrupted`), o.end(), void 0)),
          !i.name)
        ) {
          Q &&
            S.warn(
...
function gf(e, t) {
  let n = B(e),
    r = kt();
  return !(r - n.start_timestamp > hf || (t && r - t <= hf));
}
function _f() {
  let e = $t().getScopeData(),
    t = F().getScopeData(),
    n = P().getScopeData();
  return (Ai(e, t), Ai(e, n), (e.eventProcessors = []), e);
}
function vf(e) {
...
var yf = G(() => ({
  ...
  setup(e) {
    let t = Rs(e);
    vf((e, n) => {
      (t.sendScope(JSON.stringify(W(e, 20, 2e3))),
        n.clearBreadcrumbs(),
        n.clearAttachments());
    });
  },
...
function bf(e) {
  ...
  return Ia(
    e,
    async (e) => ((t ||= Rs()), t.sendEnvelope(e.body), { statusCode: 200 }),
  );
}
var xf = 50,
  [, Sf] = qu,
...
function Tf(e) {
  return [...Fd(e).filter((e) => e.name !== `BrowserSession`), yf()];
}
function Ef(e = {}, t = Id) {
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
  ...
  ((window.__SENTRY__RENDERER_INIT__ = !0),
    ...
    e.defaultIntegrations === void 0 && (e.defaultIntegrations = Tf(e)),
    e.stackParser === void 0 && (e.stackParser = wf),
    e.ipcNamespace === void 0 && (e.ipcNamespace = `sentry-ipc`),
    e.dsn === void 0 && (e.dsn = `https://12345@dummy.dsn/12345`),
    e.transport === void 0 && (e.transport = bf),
...
function kf() {
  ...
  (Ef({
    ...
    tracesSampleRate: 0,
    integrations: (e) => (t ? [...e, sf()] : e),
  }),
    ta(`sessionId`, e.codexAppSessionId),
    ta(`buildFlavor`, e.buildFlavor),
    ta(`preRelease`, r),
    ta(`bundle`, `webview`),
    ta(`host`, `app`),
    h(Mf));
...
var Nf = a(s, {
  ...
  Pf = i(s, ({ get: e }) => e(Nf).isUpdateReady),
  Ff = i(s, ({ get: e }) => e(Nf).lifecycleState),
  If = i(s, ({ get: e }) => e(Nf).downloadProgressPercent),
  Lf = i(s, ({ get: e }) => e(Nf).installProgressPercent),
  Rf = i(s, ({ get: e }) => e(Nf).relaunchNotice);
function zf(e) {
  switch (e) {
    case `ready`:
    case `downloading`:
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      t[0] === r
        ...
        : ((e = () => {
            if (r === `macOS`) {
              ne.appUpdates?.installUpdate();
              return;
            }
            ne.appUpdates?.checkForUpdates();
          }),
          (t[0] = r),
          (t[1] = e));
      let n, i;
      t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, $.jsx)(oe, { className: `icon-xs` })),
          (i = (0, $.jsx)(g, {
      ...
      return (
        t[4] === e
          ? (a = t[5])
          : ((a = (0, $.jsxs)(ee, { onClick: e, children: [n, i] })),
            (t[4] = e),
            (t[5] = a)),
        a
      );
...
var qf = { componentStack: null, error: null, eventId: `` };
function Jf(e, t) {
  let n = new WeakMap();
  function r(e, t) {
    if (!n.has(e)) {
...
function Yf(e) {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(se, { electron: !0, children: (0, $.jsx)(Vf, {}) })),
      (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
      ...
      : ((l = (0, $.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, $.jsxs)(`div`, {
              ...
              children: [o, (0, $.jsx)(ee, { onClick: s, children: c })],
            }),
          ],
        })),
        (t[7] = s),
...
var Xf = class extends Uf.Component {
  state = qf;
  ...
  componentDidCatch(e, { componentStack: t }) {
    let n = t ?? ``,
      r = Kf(e) ? e : Error(String(e));
    if (Kf(e)) {
      let t = Error(e.message);
      ((t.name = `React ErrorBoundary ${t.name}`), (t.stack = n), Jf(e, t));
    }
    let i = jf(r, { boundaryName: this.props.name, componentStack: n });
    this.props.onError && this.props.onError(r, n, i);
    try {
      c.error(`error boundary`, {
  ...
  resetErrorBoundary = () => {
    ...
    (e && e(t, n ?? ``, r), this.setState(qf));
  };
  render() {
    let { fallback: e, children: t } = this.props,
      n = this.state,
      r = e ?? ((e) => (0, $.jsx)(Yf, { resetError: () => e.resetError() }));
    if (n.error) {
      let e;
      return (
        (e =
...
//# sourceMappingURL=error-boundary-CEY5qqtE.js.map
