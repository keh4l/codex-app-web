import{s as e}from"./chunk-Bj-mKKzh.js";import{Ui as t,z as n}from"./app-server-manager-signals-BAE2L06u.js";import{n as r,t as i}from"./jsx-runtime-Bj4hVTj7.js";import{H as a,I as o,U as s,c,n as l,o as u,pt as d,r as f,s as p}from"./vscode-api-DH_DWhkY.js";import{r as m}from"./path-inT_TB1l.js";import{d as h,l as g,o as _}from"./global-settings-DXoSDNqc.js";import{t as v}from"./button-B0wCHa0n.js";import{t as y}from"./x-BXpKtPcc.js";import{t as b}from"./use-platform-CGZEzfcC.js";import{t as x}from"./route-scope-CQdNlWes.js";import{n as S,r as C}from"./use-resolved-theme-variant-B_pLzfN5.js";import{t as ee}from"./use-stable-callback-CcVBBljJ.js";import{t as te}from"./context-menu-5WduLoHb.js";import{t as w}from"./search-BSGaeEUb.js";import{t as T}from"./copy-to-clipboard-HROK9-1F.js";import{n as ne,r as E}from"./open-target-selection-lVWoDpoE.js";import{a as D,i as O,n as k,t as A}from"./iconResolver-BiDXw7G6.js";var j=`file-tree-container`,M=`data-file-tree-style`,re=`data-file-tree-unsafe-css`,ie=`data-file-tree-scrollbar-measure`,ae=`data-file-tree-scrollbar-gutter-measured`,N=`--trees-scrollbar-gutter-measured`,oe=`header`,se=`context-menu`,ce=`context-menu-trigger`,P=e(r(),1),F=i(),le=typeof window>`u`?P.useEffect:P.useLayoutEffect;function ue(e,t,n){let r=e==null?null:(0,F.jsx)(`div`,{slot:oe,children:e}),i=t!=null&&n!=null?(0,F.jsx)(`div`,{slot:se,children:t(n.item,n.context)}):null;return r==null&&i==null?null:(0,F.jsxs)(F.Fragment,{children:[r,i]})}function de(e,t){return typeof window>`u`&&t!=null?(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(`template`,{shadowrootmode:`open`,dangerouslySetInnerHTML:{__html:t.shadowHtml}}),e]}):(0,F.jsx)(F.Fragment,{children:e})}function fe(e){let t=e.shadowRoot;return t?.querySelector(`[data-file-tree-id]`)instanceof HTMLElement||t?.querySelector(`[data-file-tree-id]`)instanceof SVGElement?!0:e.querySelector(`template[shadowrootmode="open"]`)instanceof HTMLTemplateElement}function pe(e,t,n,r,i){let a={...e??{}};if(t!=null&&delete a.header,n){let t=e?.contextMenu,n=t?.onClose,o=t?.onOpen;a.contextMenu={...t??{},enabled:!0,onClose:()=>{n?.(),r()},onOpen:(e,t)=>{i(e,t),o?.(e,t)}},delete a.contextMenu.render}return a.header!=null||a.contextMenu!=null?a:void 0}function me({header:e,id:t,model:n,preloadedData:r,renderContextMenu:i,...a}){let[o,s]=(0,P.useState)(null),[c,l]=(0,P.useState)(null),u=(0,P.useRef)(n.getComposition()),d=(0,P.useRef)(n);d.current!==n&&(d.current=n,u.current=n.getComposition());let f=i!=null,p=(0,P.useCallback)(()=>{s(null)},[]),m=(0,P.useCallback)((e,t)=>{s({context:t,item:e})},[]),h=u.current,g=(0,P.useMemo)(()=>pe(h,e,f,p,m),[h,p,m,f,e]),_=(0,P.useCallback)(e=>{l(e)},[]);(0,P.useEffect)(()=>{f||s(null)},[f]),le(()=>{n.setComposition(g)},[g,n]),le(()=>{if(c!=null)return r!=null&&fe(c)?n.hydrate({fileTreeContainer:c}):n.render({fileTreeContainer:c}),()=>{n.unmount(),n.setComposition(h)}},[h,c,n,r]);let v=de(ue(e,i,o),r),y=t??r?.id,b={"--trees-item-height":`${String(n.getItemHeight())}px`,"--trees-density-override":n.getDensityFactor(),...a.style};return(0,F.jsx)(j,{...a,id:y,ref:_,style:b,suppressHydrationWarning:r!=null,children:v})}var he={compact:{itemHeight:24,factor:.8},default:{itemHeight:30,factor:1},relaxed:{itemHeight:36,factor:1.2}};function ge(e,t){if(typeof e==`number`)return{itemHeight:t??he.default.itemHeight,factor:e};let n=he[e??`default`];return{itemHeight:t??n.itemHeight,factor:n.factor}}var _e=he.default.itemHeight,ve=`@layer base, theme, unsafe;
...
@layer unsafe {
  ${e}
    ...
    `},t[24]=le,t[25]=E,t[26]=Ce,t[27]=l,t[28]=y,t[29]=I,t[30]=N,t[31]=we):we=t[31];let{model:L}=Cc(we),Te;t[32]===L?Te=t[33]:(Te=()=>L.getVisibleCount(),t[32]=L,t[33]=Te);let[Ee,De]=(0,P.useState)(Te),Oe;t[34]!==l||t[35]!==D||t[36]!==L||t[37]!==N?(Oe=()=>{let e=null,t=0;fe.current=Array.from(l??[]),L.resetPaths(N,{initialExpandedPaths:l}),De(L.getVisibleCount()),pe.current=D>0?D:null;let n=pe.current;if(n==null)return;let r=()=>{if(e=null,pe.current!==n)return;if(L.getScrollMetrics()==null){if(t>=Lc){pe.current=null;return}t+=1,e=window.requestAnimationFrame(r);return}L.setScrollTop(n);let i=L.getScrollMetrics()?.scrollTop??L.getScrollTop();if(ge.current=i,Jc(i,n)){pe.current=null;return}if(t>=Lc){pe.current=null;return}t+=1,e=window.requestAnimationFrame(r)};return e=window.requestAnimationFrame(r),()=>{e!=null&&window.cancelAnimationFrame(e),pe.current===n&&(pe.current=null)}},t[34]=l,t[35]=D,t[36]=L,t[37]=N,t[38]=Oe):Oe=t[38];let ke;t[39]!==l||t[40]!==D||t[41]!==L||t[42]!==x||t[43]!==N?(ke=[l,D,L,x,N],t[39]=l,t[40]=D,t[41]=L,t[42]=x,t[43]=N,t[44]=ke):ke=t[44],(0,P.useEffect)(Oe,ke);let Ae;t[45]!==L||t[46]!==O||t[47]!==w?(Ae=()=>{if(_e.current=w??null,Kc(L,w),!O||w==null){he.current=null;return}he.current!==w&&(pe.current=null,qc(L,w)&&(he.current=w))},t[45]=L,t[46]=O,t[47]=w,t[48]=Ae):Ae=t[48];let je;t[49]!==L||t[50]!==O||t[51]!==w||t[52]!==N?(je=[L,O,w,N],t[49]=L,t[50]=O,t[51]=w,t[52]=N,t[53]=je):je=t[53],(0,P.useEffect)(Ae,je);let Me,Ne;t[54]!==le||t[55]!==L?(Me=()=>{L.setIcons(le)},Ne=[le,L],t[54]=le,t[55]=L,t[56]=Me,t[57]=Ne):(Me=t[56],Ne=t[57]),(0,P.useEffect)(Me,Ne);let Pe,Fe;t[58]!==xe||t[59]!==L||t[60]!==N?(Pe=()=>L.subscribe(()=>{De(e=>{let t=L.getVisibleCount();return e===t?e:t}),ge.current=L.getScrollTop(),xe(Gc(L,N))}),Fe=[xe,L,N],t[58]=xe,t[59]=L,t[60]=N,t[61]=Pe,t[62]=Fe):(Pe=t[61],Fe=t[62]),(0,P.useEffect)(Pe,Fe);let Ie,R;t[63]!==L||t[64]!==ye?(Ie=()=>{let e=null,t=0,n=null,r=e=>{ge.current=e;let t=pe.current;if(t!=null)if(Jc(e,t))pe.current=null;else if(e===0)return;else pe.current=null;ye()},i=()=>{if(e=null,L.getScrollMetrics()!=null){n=L.subscribeToScroll(r);return}t>=Lc||(t+=1,e=window.requestAnimationFrame(i))};return i(),()=>{e!=null&&window.cancelAnimationFrame(e),n?.()}},R=[L,ye],t[63]=L,t[64]=ye,t[65]=Ie,t[66]=R):(Ie=t[65],R=t[66]),(0,P.useEffect)(Ie,R);let Le;t[67]!==r||t[68]!==s?(Le=(0,F.jsx)(Nc,{cwd:r,hostId:s}),t[67]=r,t[68]=s,t[69]=Le):Le=t[69];let Re;t[70]!==j||t[71]!==r||t[72]!==ie||t[73]!==s||t[74]!==M||t[75]!==se?(Re=()=>{let e=Wc(se,ue.current);return Tc({...Hc({cwd:r,fallbackOpenTargets:ie,hostId:s,queryClient:M,targetPath:e}),onAddToChat:s==null?void 0:e=>{j.mutateAsync({hostId:s,path:e})},onCopyPath:T,onOpenInTarget:(e,t,n)=>{ie.open(e,{appPath:t,persistPreferred:!1,path:n})},targetPath:e})},t[70]=j,t[71]=r,t[72]=ie,t[73]=s,t[74]=M,t[75]=se,t[76]=Re):Re=t[76];let ze;t[77]!==r||t[78]!==s||t[79]!==M||t[80]!==se?(ze=()=>Uc({cwd:r,hostId:s,queryClient:M,targetPath:Wc(se,ue.current)}),t[77]=r,t[78]=s,t[79]=M,t[80]=se,t[81]=ze):ze=t[81];let Be;t[82]===Symbol.for(`react.memo_cache_sentinel`)?(Be=e=>{ue.current=kc(e.nativeEvent)},t[82]=Be):Be=t[82];let Ve;t[83]!==ne||t[84]!==Ee?(Ve=ne?{height:`${Ee*Ic}px`}:{},t[83]=ne,t[84]=Ee,t[85]=Ve):Ve=t[85];let He;t[86]!==k||t[87]!==Ve?(He={backgroundColor:`var(--color-token-main-surface-primary)`,color:`var(--color-token-foreground)`,colorScheme:k,...Ve,width:`100%`},t[86]=k,t[87]=Ve,t[88]=He):He=t[88];let Ue;t[89]!==L||t[90]!==d||t[91]!==He?(Ue=(0,F.jsx)(me,{onClick:d,onContextMenu:Be,model:L,style:He}),t[89]=L,t[90]=d,t[91]=He,t[92]=Ue):Ue=t[92];let We;t[93]!==Re||t[94]!==ze||t[95]!==Ue?(We=(0,F.jsx)(te,{awaitBeforeOpen:!1,getItems:Re,onBeforeOpen:ze,children:Ue}),t[93]=Re,t[94]=ze,t[95]=Ue,t[96]=We):We=t[96];let z;return t[97]!==Le||t[98]!==We?(z=(0,F.jsxs)(F.Fragment,{children:[Le,We]}),t[97]=Le,t[98]=We,t[99]=z):z=t[99],z}function zc(e){return typeof e==`string`?e:e.displayPath}function Bc(e,t){if(t==null||t.length===0)return e;let n=t.map(e=>`<symbol id="${e.name}" viewBox="${e.viewBox??`0 0 ${e.width??0} ${e.height??0}`}">${e.body}</symbol>`).join(``),r=Vc(typeof e==`string`?void 0:e?.spriteSheet,n);return e==null?{set:`complete`,spriteSheet:r}:typeof e==`string`?{set:e,spriteSheet:r}:{...e,spriteSheet:r}}function Vc(e,t){return e==null?`<svg data-icon-sprite aria-hidden="true" width="0" height="0" xmlns="http://www.w3.org/2000/svg">${t}</svg>`:e.replace(`</svg>`,`${t}</svg>`)}function Hc({cwd:e,fallbackOpenTargets:t,hostId:n,queryClient:r,targetPath:i}){if(i==null)return{isLoadingOpenTargets:!1,primaryTarget:null,visibleTargets:[]};let a=f(`open-in-targets`,{cwd:e,hostId:n,path:i}),o=r.getQueryData(a),s=o?.targets??t.targets,c=o?.availableTargets??t.availableTargets,l=o?.preferredTarget??t.preferredTarget,u=o?.mode??t.mode;return{isLoadingOpenTargets:o==null&&!t.hasLoadedTargets&&r.getQueryState(a)?.status!==`error`,primaryTarget:E({preferredTarget:l,targets:s,availableTargets:c,mode:u}),visibleTargets:ne({targets:s,availableTargets:c,includeHiddenTargets:!0,mode:u})}}function Uc({cwd:e,hostId:t,queryClient:n,targetPath:r}){if(r!=null)return n.prefetchQuery({gcTime:c.INFINITE,queryKey:f(`open-in-targets`,{cwd:e,hostId:t,path:r}),queryFn:()=>l(`open-in-targets`,{params:{cwd:e,hostId:t,path:r}}),staleTime:c.ONE_MINUTE})}function Wc(e,t){return t==null?null:e.get(t)??t}function Gc(e,t){let n=[];for(let r of t){if(!r.endsWith(`/`))continue;let t=r.slice(0,-1),i=e.getItem(t);i==null||!Yc(i)||!i.isExpanded()||n.push(t)}return n}function Kc(e,t){let n=e.getSelectedPaths();if(t==null){for(let t of n)e.getItem(t)?.deselect();return}if(!(n.length===1&&n[0]===t)){for(let t of n)e.getItem(t)?.deselect();e.getItem(t)?.select()}}function qc(e,t){return e.getItem(t)==null?!1:(e.focusPath(t),!0)}function Jc(e,t){return Math.abs(e-t)<=1}function Yc(e){return e.isDirectory()}function Xc(e){let t=(0,jc.c)(22),{inputId:n,inputRef:r,onQueryChange:i,searchQuery:a}=e,o=n===void 0?`file-tree-search`:n,s=h(),c;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(c=(0,F.jsx)(g,{id:`codex.fileTreeSearch.label`,defaultMessage:`Filter files`,description:`Label for a file tree filter input`}),t[0]=c):c=t[0];let l;t[1]===o?l=t[2]:(l=(0,F.jsx)(`label`,{className:`sr-only`,htmlFor:o,children:c}),t[1]=o,t[2]=l);let u;t[3]===Symbol.for(`react.memo_cache_sentinel`)?(u=(0,F.jsx)(w,{className:`icon-xs ms-2 shrink-0 text-token-input-placeholder-foreground`}),t[3]=u):u=t[3];let d;t[4]===i?d=t[5]:(d=e=>i(e.target.value),t[4]=i,t[5]=d);let f;t[6]===s?f=t[7]:(f=s.formatMessage({id:`codex.fileTreeSearch.placeholder`,defaultMessage:`Filter files…`,description:`Placeholder text for a file tree filter input`}),t[6]=s,t[7]=f);let p;t[8]!==o||t[9]!==r||t[10]!==a||t[11]!==d||t[12]!==f?(p=(0,F.jsx)(`input`,{id:o,ref:r,className:`w-full appearance-none border-none bg-transparent py-0 ps-0 pe-1.5 text-token-foreground ring-0 outline-none placeholder:text-token-input-placeholder-foreground focus:border-none focus:ring-0 focus:outline-none`,type:`text`,value:a,onChange:d,placeholder:f}),t[8]=o,t[9]=r,t[10]=a,t[11]=d,t[12]=f,t[13]=p):p=t[13];let m;t[14]!==s||t[15]!==i||t[16]!==a.length?(m=a.length>0?(0,F.jsx)(v,{"aria-label":s.formatMessage({id:`codex.fileTreeSearch.clear`,defaultMessage:`Clear file filter`,description:`Button label to clear a file tree filter input`}),className:`text-token-input-placeholder-foreground hover:text-token-foreground`,color:`ghost`,size:`icon`,onClick:()=>i(``),children:(0,F.jsx)(y,{className:`icon-2xs`})}):null,t[14]=s,t[15]=i,t[16]=a.length,t[17]=m):m=t[17];let _;return t[18]!==l||t[19]!==p||t[20]!==m?(_=(0,F.jsxs)(`div`,{className:`relative flex h-token-button-composer w-full items-center gap-1.5 rounded-lg border border-token-border bg-token-bg-fog text-base leading-[18px]`,children:[l,u,p,m]}),t[18]=l,t[19]=p,t[20]=m,t[21]=_):_=t[21],_}export{Ac as a,Mc as i,Rc as n,kc as o,Nc as r,wc as s,Xc as t};
//# sourceMappingURL=file-tree-search-input-BPftdiQ-.js.map