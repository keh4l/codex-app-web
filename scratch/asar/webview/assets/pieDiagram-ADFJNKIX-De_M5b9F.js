import"./chunk-FPAJGGOC-kFn3jHDB.js";import{f as e,r as t}from"./chunk-S3R3BYOJ-CE6B08V4.js";import"./chunk-O7ZBX7Z2-ByIogv_q.js";import"./chunk-S6J4BHB3-LGUDlwWF.js";import"./chunk-LBM3YZW2-adpG9oMZ.js";import"./chunk-76Q3JFCE-TaEPlm6S.js";import"./chunk-T53DSG4Q-ZJwZF0Tl.js";import"./chunk-LHMN2FUI-DPemRKQ9.js";import"./chunk-FWNWRKHM-CGDyzUGX.js";import{i as n,r}from"./src-NXbN5CeA.js";import{t as i}from"./ordinal-B2r5L1v4.js";import{t as a}from"./arc-CXO8OBHM.js";import{t as o}from"./pie-BMZjtBhA.js";import{B as s,C as c,U as l,_ as u,a as d,b as f,c as p,d as m,v as h,z as g}from"./chunk-ABZYJK2D-DJcNOowt.js";import{t as _}from"./chunk-EXTU4WIE-ByDBJ5eP.js";import"./dist-D25Bp08D.js";import{t as v}from"./chunk-4BX2VUAB-aQp0VpZV.js";import{t as y}from"./mermaid-parser.core-DhtAC1wK.js";var b=m.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:r(()=>structuredClone(w),`getConfig`),clear:r(()=>{S=new Map,C=x.showData,d()},`clear`),setDiagramTitle:l,getDiagramTitle:c,setAccTitle:s,getAccTitle:h,setAccDescription:g,getAccDescription:u,addSection:r(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),n.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:r(()=>S,`getSections`),setShowData:r(e=>{C=e},`setShowData`),getShowData:r(()=>C,`getShowData`)},E=r((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:r(async e=>{let t=await y(`pie`,e);n.debug(t),E(t,T)},`parse`)},O=r(e=>`
  .pieCircle{
...
//# sourceMappingURL=pieDiagram-ADFJNKIX-De_M5b9F.js.map