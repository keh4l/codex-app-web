import{n as e}from"./src-DdjD_HBn.js";import{i as t,p as n}from"./chunk-ICXQ74PX-CwpPikM0.js";import{U as r,V as i,z as a}from"./runtime.worker-CX5elhOJ.js";import{n as o}from"./mermaid-parser.core-B0xji8DL.js";import{n as s}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{H as c,K as l,U as u,a as d,c as f,f as p,v as m,w as h,x as g,y as _}from"./chunk-WYO6CB5R-C7hhxtf-.js";import{t as v}from"./chunk-VAUOI2AC-Cwd_zWyx.js";import{t as y}from"./chunk-JWPE2WC7-DVXcaiue.js";var b=p.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:s(()=>structuredClone(w),`getConfig`),clear:s(()=>{S=new Map,C=x.showData,d()},`clear`),setDiagramTitle:l,getDiagramTitle:h,setAccTitle:u,getAccTitle:_,setAccDescription:c,getAccDescription:m,addSection:s(({label:t,value:n})=>{if(n<0)throw Error(`"${t}" has invalid value: ${n}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(t)||(S.set(t,n),e.debug(`added new section: ${t}, with value: ${n}`))},`addSection`),getSections:s(()=>S,`getSections`),setShowData:s(e=>{C=e},`setShowData`),getShowData:s(()=>C,`getShowData`)},E=s((e,t)=>{y(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:s(async t=>{let n=await o(`pie`,t);e.debug(n),E(n,T)},`parse`)},O=s(e=>`
  .pieCircle{
...
//# sourceMappingURL=pieDiagram-ENE6RG2P-Cq3lL5_Y.js.map