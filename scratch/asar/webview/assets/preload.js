...
var t = `codex_desktop:mcp-app-sandbox-host-message`, n = `codex_desktop:show-context-menu`, r = `codex_desktop:show-application-menu`, i = `codex_desktop:get-sentry-init-options`, a = `codex_desktop:get-build-flavor`, o = `codex_desktop:get-system-theme-variant`, s = `codex_desktop:get-fast-mode-rollout-metrics`, c = `codex_desktop:system-theme-variant-updated`, l = `codex_desktop:trigger-sentry-test`;
function u(e) {
...
var f = `electron`, p = `codex_desktop:message-from-view`, m = `codex_desktop:message-for-view`, h = e.ipcRenderer.sendSync(i), g = e.ipcRenderer.sendSync(a), _ = e.ipcRenderer.sendSync(`codex_desktop:get-shared-object-snapshot`) ?? {}, v = e.ipcRenderer.sendSync(o), y = () => v, b = /* @__PURE__ */ new Set();
...
var S = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), w = {
	windowType: f,
	sendMessageFromView: async (t) => {
		t.type === `shared-object-set` && x(t.key, t.value), await e.ipcRenderer.invoke(p, t);
	},
	getPathForFile: (t) => e.webUtils.getPathForFile(t) || null,
	sendWorkerMessageFromView: async (t, n) => {
		await e.ipcRenderer.invoke(u(t), n);
	},
	subscribeToWorkerMessages: (t, n) => {
		...
		}, C.set(t, i), e.ipcRenderer.on(d(t), i)), r.add(n), () => {
			let r = S.get(t);
			if (!r || (r.delete(n), r.size > 0)) return;
			S.delete(t);
			let i = C.get(t);
			i && e.ipcRenderer.removeListener(d(t), i), C.delete(t);
		};
	},
	...
	getFastModeRolloutMetrics: async (t) => e.ipcRenderer.invoke(s, t),
	getSharedObjectSnapshotValue: (e) => _[e],
	getSystemThemeVariant: y,
	subscribeToSystemThemeVariant: (e) => (b.add(e), () => {
		b.delete(e);
	}),
	triggerSentryTestError: async () => {
		await e.ipcRenderer.invoke(l);
	},
	getSentryInitOptions: () => h,
	getAppSessionId: () => h.codexAppSessionId,
	getBuildFlavor: () => g
};
e.ipcRenderer.on(m, (e, t) => {
	let n = t;
	n.type === `shared-object-updated` && x(n.key, n.value), window.dispatchEvent(new MessageEvent(`message`, { data: t }));
