...
import { In as n, Ln as r, Wn as i, Zn as a, s as o } from "./src-CdfxiY-T.js";
import { t as s } from "./apps-Au-fp4y1.js";
import {
  Bn as c,
  Vr as l,
  zn as u,
} from "./app-server-manager-signals-BAE2L06u.js";
import { n as d, t as f } from "./jsx-runtime-Bj4hVTj7.js";
import { t as p } from "./clsx-Duxel1Jl.js";
import { t as m } from "./react-dom-waJIBoyA.js";
import { u as h } from "./chunk-LFPYN7LY-CRkYzDF0.js";
import {
  V as g,
  c as _,
  n as v,
...
import { t as S } from "./useQueries-9g51Qk4y.js";
import { r as C, t as w } from "./skill-path-utils-DxuI19n4.js";
import { c as T, i as E, l as D } from "./path-inT_TB1l.js";
import { t as O } from "./score-query-match-SnTbaBQj.js";
import { d as k, l as A, o as j, s as ee } from "./global-settings-DXoSDNqc.js";
import { _ as M } from "./config-queries-BpTFBidJ.js";
import { t as N } from "./send-open-file-request-D8QNbjwE.js";
import { t as P } from "./use-platform-CGZEzfcC.js";
import { t as F } from "./get-build-flavor-CA2L_fyR.js";
import { p as te } from "./use-plugins-TlmKKXMH.js";
import { t as ne } from "./route-scope-CQdNlWes.js";
import { f as I, s as L } from "./apps-queries--Cxfz_0k.js";
import { n as re } from "./use-skills-yfC0r7O6.js";
import { l as ie } from "./codex-api-BlFw_ca9.js";
import { r as R } from "./parse-owner-repo-DMAz4xDA.js";
import { t as z } from "./use-debounced-value-B9rAFt3X.js";
import { t as ae } from "./globe-8aDYUmS5.js";
import {
  C as oe,
  T as se,
  _ as ce,
...
import {
  ...
  w as Ve,
  y as He,
} from "./external-link-source-bjQvnWJl.js";
import { t as Ue } from "./use-is-background-subagents-enabled-BnUEsTgI.js";
import { t as We } from "./sortBy-B-Mxfm_Y.js";
import { n as Ge, t as Ke } from "./plugin-install-store-Cak_chGF.js";
import { t as qe } from "./list-navigation-DgVOmqFU.js";
import { r as Je } from "./format-skill-scope-BwF_1tF3.js";
import { t as Ye } from "./use-workspace-file-search-DXBN6EIl.js";
var Xe = b(`ComposerScope`, { key: U, parent: ne, retain: { max: 100 } });
function U(e) {
  switch (e.kind) {
    case `new`:
...
function Ze(e, t = `main`) {
  return { conversationId: e, kind: `local`, placement: t };
}
function Qe(e) {
  switch (e.routeKind) {
    case `home`:
      return { entrypoint: `home`, kind: `new` };
    case `new-thread-panel`:
      return { entrypoint: `panel`, kind: `new` };
    case `local-thread`:
      return Ze(e.conversationId);
    case `remote-thread`:
      return { kind: `cloud`, taskId: e.taskId };
    case `other`:
      return { kind: `other` };
  }
}
function $e(e) {
  ...
  return r == null
    ? null
    : { displayText: tt(t, n, r), href: t, sourceAppId: r.appId };
}
function et({ displayText: e, href: t }) {
  let n;
  try {
    n = new URL(t);
  } catch {
...
function rt(e) {
  let t = at(e);
  return t == null ? null : st(t.replace(/-[a-f0-9]{32}$/iu, ``));
}
function it(e) {
  let t = at(e);
...
var lt = /\[\$[^\]]+\]\((?:\\.|[^)])+\)/,
  ...
  pt = /\[([^\]]+)\]\(((?:https?:\/\/)(?:\\.|[^)])+)\)/g,
  mt = /^(?:[A-Za-z][A-Za-z0-9+.-]*:\/\/|www\.|mailto:|tel:)/;
function ht(e) {
  return gt(e) || yt(e);
}
function gt(e) {
  return lt.test(e) || ut.test(e) || dt.test(e) || ft.test(e);
}
function _t({ schema: e, text: t }) {
...
function vt(e, t) {
  let n = e.nodes.paragraph,
    r = e.nodes.skillMention,
    i = e.nodes.appMention,
    a = e.nodes.pluginMention,
    o = e.nodes.atMention,
    s = e.nodes.agentMention,
    l = e.nodes.richLink;
  if (!n) throw Error(`promptTextToDoc requires doc+paragraph nodes`);
  let u = [],
    d = 0,
    f = 0,
    p = (n) => {
      n <= f || u.push(e.text(t.slice(f, n)));
    };
  for (; d < t.length; ) {
    let n = t.indexOf(`[`, d);
    if (n === -1) break;
    ...
    let v = t.slice(n + 1, m),
      y = c(g);
    p(n);
    let b = ce({ href: y, label: v }),
      x = et({ displayText: v, href: y }),
      S = ge(v);
    if (a && y.startsWith(`plugin://`))
      u.push(
        a.create({
          name: S,
          displayName: S,
    ...
    else if (b === `app` || b === `skill`) {
      let t = v.startsWith(`$`) ? S : v;
      b === `app` && i
        ? u.push(
            i.create({
              name: ye(t),
      ...
      n != null || r != null
        ? u.push(
            s.create({ name: t, displayName: t, conversationId: n, path: y }),
          )
        : u.push(e.text(`[@${t}](${y})`));
    } else
      l && x != null
        ...
        : mt.test(y)
          ? u.push(e.text(`[${v}](${g})`))
          : o
            ? u.push(o.create({ label: v, path: y, fsPath: y }))
            : u.push(e.text(`[${v}](${g})`));
    ((f = h + 1), (d = f));
  }
  return (p(t.length), u.length ? u : null);
}
function yt(e) {
  for (let t of e.matchAll(pt)) {
    let e = t[1],
      n = t[2];
    if (!(e == null || n == null) && et({ displayText: e, href: c(n) }) != null)
      return !0;
  }
  return !1;
}
function bt({ schema: e, text: t }) {
  let n = e.nodes.paragraph,
    r = e.nodes.doc;
...
`,
    ...
    .map((t) => {
      let r = vt(e, t);
      return n.create(null, r);
    });
  return r.create(null, i.length ? i : [n.create()]);
}
var xt = `above-composer-portal`,
  St = `above-composer-queue-portal`,
  Ct = `data-above-composer-portal`,
  wt = `data-above-composer-queue-portal`;
function Tt(e) {
  return Dt({ attr: Ct, fallbackId: xt, conversationId: e });
}
function Et(e) {
  return Dt({ attr: wt, fallbackId: St, conversationId: e });
}
function Dt({ attr: e, fallbackId: t, conversationId: n }) {
...
function Ot(e) {
  let t = (0, W.c)(10),
    ...
    c;
  t[0] !== r || t[1] !== a || t[2] !== o
    ? ((c = kt({ isLoading: r, query: a, resultCount: o })),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o),
      (t[3] = c))
...
function kt({ isLoading: e, query: t, resultCount: n }) {
  return t.trim().length > 0 && /\s/.test(t) && !e && n === 0;
}
var At = `data-hotkey-window-home-composer-menu-open`;
function jt(e) {
...
function Nt(e) {
  let t = (0, W.c)(12),
    ...
    s = h(),
    c = o === `embeddedExpandedTopTray`,
    l;
  t[0] !== o || t[1] !== s || t[2] !== c
    ? ((l = o === `expandedTopTray` || c || jt(s.pathname)),
      (t[0] = o),
      (t[1] = s),
      (t[2] = c),
      (t[3] = l))
  ...
  t[4] !== r || t[5] !== c || t[6] !== u
    ? ((d = p(
        u
          ? p(
              Mt.expandedTopTrayPanel,
              c && Mt.embeddedExpandedTopTrayPanel,
  ...
  return (
    t[8] !== n || t[9] !== a || t[10] !== d
      ? ((f = (0, K.jsx)(`div`, { ref: a, className: d, children: n })),
        (t[8] = n),
        (t[9] = a),
        (t[10] = d),
        (t[11] = f))
...
function Pt(e) {
  ...
  let c;
  t[0] !== r || t[1] !== s
    ? ((c = p(s, `flex w-full flex-1 flex-col overflow-y-auto`, r)),
      (t[0] = r),
      (t[1] = s),
      (t[2] = c))
    : (c = t[2]);
  ...
  return (
    t[3] !== n || t[4] !== a || t[5] !== c
      ? ((l = (0, K.jsx)(`div`, { ref: a, className: c, children: n })),
        (t[3] = n),
        (t[4] = a),
        (t[5] = c),
        (t[6] = l))
...
function Ft(e) {
  let t = (0, W.c)(6),
    ...
    c;
  t[0] !== r || t[1] !== s
    ? ((c = p(s, r)), (t[0] = r), (t[1] = s), (t[2] = c))
    : (c = t[2]);
  let l;
  return (
    t[3] !== n || t[4] !== c
      ? ((l = (0, K.jsx)(`div`, { className: c, children: n })),
        (t[3] = n),
        (t[4] = c),
        (t[5] = l))
      : (l = t[5]),
...
var Rt = 8,
  zt = `--composer-top-menu-max-height`;
function Bt(e) {
  let t = (0, W.c)(4),
        ...
        let e = null,
          ...
          i = () => {
            let e = n.getBoundingClientRect(),
              ...
              i = `${Math.max(0, Math.floor(r - 46 - Rt))}px`;
            i !== t && ((t = i), n.style.setProperty(zt, i));
          },
          a = () => {
...
function Ut(e) {
  ...
  for (let e = 0; e < g.length; e += 1) {
    let t = g[e];
    t != null && S.set(t.key, e);
  }
  let C = h.length > 1 || h.some(Kt),
    w = !(g.length > 0) && h.every(Xt),
    T;
  (t[5] === r ? (T = t[6]) : ((T = r.some(Gt)), (t[5] = r), (t[6] = T)),
    Ot({ isLoading: T, onRequestClose: o, query: d, resultCount: g.length }));
  let E = f === `default` ? `both` : `bottom`,
    D = Vt(m),
    O = m ? `composer-home-top-menu` : `max-h-[320px]`,
    k;
  t[7] !== n || t[8] !== O
    ? ((k = p(n, O)), (t[7] = n), (t[8] = O), (t[9] = k))
    : (k = t[9]);
  let j;
  return (
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((j = p(`flex w-full flex-col`)), (t[10] = j))
      : (j = t[10]),
    (0, K.jsxs)(Nt, {
      className: k,
      chromeVariant: f,
      containerRef: m ? D : void 0,
      children: [
        (0, K.jsx)(Pt, {
          fadeMaskVariant: E,
          listRef: b,
  ...
  t[9] !== c.items
    ? ((u =
        c.items.length > 0
          ...
          : c.emptyState == null
            ? null
            : (0, K.jsx)(It, { children: (0, K.jsx)(A, { ...c.emptyState }) })),
      (t[5] = i),
      (t[6] = o),
      (t[7] = s),
      (t[8] = c.emptyState),
...
function Yt(e) {
  ...
  t[0] === n.icon
    ? (s = t[1])
    : ((s = n.icon
        ? (0, K.jsx)(n.icon, { className: `icon-xs shrink-0` })
        : null),
      (t[0] = n.icon),
      (t[1] = s));
  let c = n.detail != null && `flex-shrink-0`,
    l;
  t[2] !== n.labelClassName || t[3] !== c
    ? ((l = p(`truncate`, c, n.labelClassName)),
      (t[2] = n.labelClassName),
      (t[3] = c),
      (t[4] = l))
    : (l = t[4]);
  let u;
  t[5] !== n.label || t[6] !== n.labelStyle || t[7] !== l
    ? ((u = (0, K.jsx)(`span`, {
        className: l,
        style: n.labelStyle,
        children: n.label,
...
((Qt.prototype = {
  ...
  remove: function (e) {
    ...
    return (n.splice(t, 2), new Qt(n));
  },
  addToStart: function (e, t) {
    return new Qt([e, t].concat(this.remove(e).content));
  },
  addToEnd: function (e, t) {
    var n = this.remove(e).content.slice();
    return (n.push(e, t), new Qt(n));
  },
  addBefore: function (e, t, n) {
    var r = this.remove(t),
      i = r.content.slice(),
      a = r.find(e);
    return (i.splice(a == -1 ? i.length : a, 0, t, n), new Qt(i));
  },
  forEach: function (e) {
    for (var t = 0; t < this.content.length; t += 2)
  ...
  prepend: function (e) {
    return (
      (e = Qt.from(e)),
      e.size ? new Qt(e.content.concat(this.subtract(e).content)) : this
    );
  },
  append: function (e) {
    return (
      (e = Qt.from(e)),
      e.size ? new Qt(this.subtract(e).content.concat(e.content)) : this
    );
  },
  subtract: function (e) {
    var t = this;
...
function q(e, t, n, r) {
  for (let i = e.childCount, a = t.childCount; ; ) {
    ...
    if (o.content.size || s.content.size) {
      let e = q(o.content, s.content, n - 1, r - 1);
      if (e) return e;
    }
    ((n -= c), (r -= c));
  }
...
J.empty = new J([], 0);
var en = { index: 0, offset: 0 };
function tn(e, t) {
  return ((en.index = e), (en.offset = t), en);
}
function nn(e, t) {
  if (e === t) return !0;
...
var rn = class extends Error {},
  X = class e {
    ...
    insertAt(t, n) {
      let r = on(this.content, t + this.openStart, n);
      return r && new e(r, this.openStart, this.openEnd);
    }
    removeBetween(t, n) {
      return new e(
        an(this.content, t + this.openStart, n + this.openStart),
        this.openStart,
        this.openEnd,
      );
    }
...
function cn(e, t, n, r) {
  ...
  if (i == t.index(r) && r < e.depth - n.openStart) {
  ...
  } else if (!n.content.size) return pn(a, hn(e, t, r));
    ...
    return pn(a, mn(e, i, o, t, r));
  }
}
function ln(e, t) {
  if (!t.type.compatibleContent(e.type))
    throw new rn(`Cannot join ` + t.type.name + ` onto ` + e.type.name);
}
function un(e, t, n) {
  let r = e.node(n);
  return (ln(r, t.node(n)), r);
}
function dn(e, t) {
  let n = t.length - 1;
...
function fn(e, t, n, r) {
  ...
  e &&
    ((a = e.index(n)),
    e.depth > n ? a++ : e.textOffset && (dn(e.nodeAfter, r), a++));
  for (let e = a; e < o; e++) dn(i.child(e), r);
  t && t.depth == n && t.textOffset && dn(t.nodeBefore, r);
}
function pn(e, t) {
  return (e.type.checkContent(t), e.copy(t));
}
function mn(e, t, n, r, i) {
  let a = e.depth > i && un(e, t, i + 1),
    o = r.depth > i && un(n, r, i + 1),
    s = [];
  return (
    fn(null, e, i, s),
    a && o && t.index(i) == n.index(i)
      ? (ln(a, o), dn(pn(a, mn(e, t, n, r, i + 1)), s))
      : (a && dn(pn(a, hn(e, t, i + 1)), s),
        fn(t, n, i, s),
        o && dn(pn(o, hn(n, r, i + 1)), s)),
    fn(r, null, i, s),
    new J(s)
  );
}
function hn(e, t, n) {
  ...
  return (
    fn(null, e, n, r),
    e.depth > n && dn(pn(un(e, t, n + 1), hn(e, t, n + 1)), r),
    fn(t, null, n, r),
    new J(r)
  );
}
...
var _n = class e {
    ...
    marks() {
      let e = this.parent,
        t = this.index();
      if (e.content.size == 0) return Y.none;
    ...
    static resolveCached(t, n) {
      ...
      else bn.set(t, (r = new vn()));
      let i = (r.elts[r.i] = e.resolve(t, n));
      return ((r.i = (r.i + 1) % yn), i);
    }
  },
  vn = class {
    constructor() {
  ...
  Cn = class e {
    constructor(e, t, n, r = Y.none) {
      ((this.type = e),
        (this.attrs = t),
        (this.marks = r),
        (this.content = n || J.empty));
    }
    get children() {
    ...
    hasMarkup(e, t, n) {
      return (
        this.type == e &&
        nn(this.attrs, t || e.defaultAttrs || Sn) &&
        Y.sameSet(this.marks, n || Y.none)
      );
    }
    copy(t = null) {
...
var wn = class e extends Cn {
  ...
  toString() {
    return this.type.spec.toDebugString
      ...
      : Tn(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
var En = class e {
  ...
  fillBefore(e, t = !1, n = 0) {
    ...
    function i(a, o) {
      ...
      if (s && (!t || s.validEnd))
        return J.from(o.map((e) => e.createAndFill()));
...
function Rn(e) {
  ...
  function n(r) {
    ...
    let a = (t[r.join(`,`)] = new En(r.indexOf(e.length - 1) > -1));
    for (let e = 0; e < i.length; e++) {
      let r = i[e][1].sort(In);
...
function Un(e, t) {
  let n = Object.create(null);
  if (t) for (let r in t) n[r] = new Kn(e, r, t[r]);
  return n;
}
var Wn = class e {
  constructor(e, t, n) {
    ((this.name = e),
      ...
      (this.attrs = Un(e, n.attrs)),
      (this.defaultAttrs = Bn(this.attrs)),
  ...
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : Vn(this.attrs, e);
  }
  create(e = null, t, n) {
    if (this.isText) throw Error(`NodeType.create can't construct text nodes`);
    return new Cn(this, this.computeAttrs(e), J.from(t), Y.setFrom(n));
  }
  createChecked(e = null, t, n) {
    return (
      (t = J.from(t)),
      this.checkContent(t),
      new Cn(this, this.computeAttrs(e), t, Y.setFrom(n))
    );
  }
  createAndFill(e = null, t, n) {
    ...
    let r = this.contentMatch.matchFragment(t),
      i = r && r.fillBefore(J.empty, !0);
    return i ? new Cn(this, e, t.append(i), Y.setFrom(n)) : null;
  }
  validContent(e) {
  ...
  checkAttrs(e) {
    Hn(this.attrs, e, `node`, this.name);
  }
  allowsMarkType(e) {
...
var Kn = class {
    constructor(e, t, n) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(n, `default`)),
        ...
        (this.validate =
          typeof n.validate == `string` ? Gn(e, t, n.validate) : n.validate));
    }
    get isRequired() {
  ...
  qn = class e {
    constructor(e, t, n, r) {
      ((this.name = e),
        ...
        (this.schema = n),
        (this.spec = r),
        (this.attrs = Un(e, r.attrs)),
        (this.excluded = null));
      let i = Bn(this.attrs);
      this.instance = i ? new Y(this, i) : null;
    }
    create(e = null) {
      return !e && this.instance
        ? this.instance
        : new Y(this, Vn(this.attrs, e));
    }
    static compile(t, n) {
      let r = Object.create(null),
        i = 0;
    ...
    checkAttrs(e) {
      Hn(this.attrs, e, `mark`, this.name);
    }
    excludes(e) {
  ...
  Jn = class {
    constructor(e) {
      ...
      ((t.nodes = Qt.from(e.nodes)),
        (t.marks = Qt.from(e.marks || {})),
        (this.nodes = Wn.compile(this.spec.nodes, this)),
        (this.marks = qn.compile(this.spec.marks, this)));
      let n = Object.create(null);
      for (let e in this.nodes) {
        ...
        let t = this.nodes[e],
          ...
          i = t.spec.marks;
        if (
          ((t.contentMatch = n[r] || (n[r] = En.parse(r, this.nodes))),
      ...
      for (let e in this.marks) {
        let t = this.marks[e],
          n = t.spec.excludes;
        t.excluded = n == null ? [t] : n == `` ? [] : Yn(this, n.split(` `));
      }
      ((this.nodeFromJSON = (e) => Cn.fromJSON(this, e)),
        (this.markFromJSON = (e) => Y.fromJSON(this, e)),
        (this.topNodeType = this.nodes[this.spec.topNode || `doc`]),
        (this.cached.wrappings = Object.create(null)));
    }
    node(e, t = null, n, r) {
      if (typeof e == `string`) e = this.nodeType(e);
      else if (!(e instanceof Wn)) throw RangeError(`Invalid node type: ` + e);
    ...
    text(e, t) {
      ...
      return new wn(n, n.defaultAttrs, e, Y.setFrom(t));
    }
    mark(e, t) {
...
var Qn = class e {
    ...
    parse(e, t = {}) {
      let n = new sr(this, t, !1);
      return (n.addAll(e, Y.none, t.from, t.to), n.finish());
    }
    parseSlice(e, t = {}) {
      let n = new sr(this, t, !0);
      return (n.addAll(e, Y.none, t.from, t.to), X.maxOpen(n.finish()));
    }
    matchTag(e, t, n) {
      for (
    ...
    static schemaRules(e) {
      ...
      for (let t in e.marks) {
        ...
        r &&
          r.forEach((e) => {
            (n((e = ur(e))), e.mark || e.ignore || e.clearMark || (e.mark = t));
          });
      }
      for (let t in e.nodes) {
        ...
        r &&
          r.forEach((e) => {
            (n((e = ur(e))), e.node || e.ignore || e.mark || (e.node = t));
          });
      }
      return t;
    }
  ...
  er = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  tr = { ol: !0, ul: !0 },
  nr = 1,
  rr = 2,
  ir = 4;
...
var or = class {
    constructor(e, t, n, r, i, a) {
      ((this.type = e),
        ...
        (this.options = a),
        (this.content = []),
        (this.activeMarks = Y.none),
        (this.match = i || (a & ir ? null : e.contentMatch)));
    }
    findWrapping(e) {
      if (!this.match) {
        if (!this.type) return [];
    ...
    finish(e) {
      ...
      return (
        !e && this.match && (t = t.append(this.match.fillBefore(J.empty, !0))),
    ...
    inlineContext(e) {
      return this.type
        ...
        : this.content.length
          ...
          : e.parentNode &&
            !$n.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
    }
  },
  sr = class {
    constructor(e, t, n) {
      ...
      let r = t.topNode,
        i,
        a = ar(null, t.preserveWhitespace, 0) | (n ? ir : 0);
      ((i = r
        ? new or(
            r.type,
            r.attrs,
        ...
        : n
          ? new or(null, null, Y.none, !0, null, a)
          : new or(e.schema.topNodeType, null, Y.none, !0, null, a)),
        (this.nodes = [i]),
    ...
    addTextNode(e, t) {
      let n = e.nodeValue,
        ...
        i =
          r.options & rr
            ? `full`
            : this.localPreserveWS || (r.options & nr) > 0,
...
`,
    ...
    addElement(e, t, n) {
      ...
      let a = e.nodeName.toLowerCase(),
        o;
      tr.hasOwnProperty(a) && this.parser.normalizeLists && cr(e);
      let s =
        (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
        (o = this.parser.matchTag(e, this, n));
      out: if (s ? s.ignore : er.hasOwnProperty(a))
...
`),
    ...
    insertNode(e, t, n) {
      ...
      if (r) {
        ...
        for (let i of r.concat(e.marks))
          (t.type ? t.type.allowsMarkType(i.type) : dr(i.type, e.type)) &&
            (n = i.addToSet(n));
    ...
    enterInner(e, t, n, r = !1, i) {
      ...
      let o = ar(e, i, a.options);
      a.options & ir && a.content.length == 0 && (o |= ir);
      let s = Y.none;
      return (
        (n = n.filter((t) =>
          (a.type ? a.type.allowsMarkType(t.type) : dr(t.type, e))
            ? ((s = t.addToSet(s)), !1)
            : !0,
        )),
        this.nodes.push(new or(e, t, s, r, null, o)),
        this.open++,
        n
      );
    }
    ...
    sync(e) {
      for (let t = this.open; t >= 0; t--)
        ...
        else this.localPreserveWS && (this.nodes[t].options |= nr);
      return !1;
    }
    get currentPos() {
      this.closeExtra();
...
var fr = class e {
  ...
  serializeMark(e, t, n = {}) {
    ...
    return r && vr(mr(n), r(e, t), null, e.attrs);
  }
...
function gr(e) {
  let t = hr.get(e);
  return (t === void 0 && hr.set(e, (t = _r(e))), t);
}
function _r(e) {
  let t = null;
  function n(e) {
...
var wr = 1,
  ...
  Or = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (wr | Er)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (Tr | Er)) > 0;
    }
    get deletedAcross() {
      ...
      for (let o = 0; o < this.ranges.length; o += 3) {
        ...
        if (e <= u) {
          let i = c ? (e == s ? -1 : e == u ? 1 : t) : t,
            a = s + r + (i < 0 ? 0 : l);
          if (n) return a;
          let d = e == (t < 0 ? s : u) ? null : xr(o / 3, e - s),
            f = e == s ? Tr : e == u ? wr : Er;
          return ((t < 0 ? e != s : e != u) && (f |= Dr), new Or(a, f, d));
        }
        r += l - c;
      }
      return n ? e + r : new Or(e + r, 0, null);
    }
    touches(e, t) {
      let n = 0,
        r = Sr(t),
...
var Ar = class e {
  ...
  Mr = class {
    ...
    static jsonID(e, t) {
      if (e in jr) throw RangeError(`Duplicate use of step JSON ID ` + e);
  ...
  Nr = class e {
    ...
    static fromReplace(t, n, r, i) {
      try {
        ...
        if (t instanceof rn) return e.fail(t.message);
        throw t;
      }
    }
  };
function Pr(e, t, n) {
  ...
  for (let i = 0; i < e.childCount; i++) {
    let a = e.child(i);
    (a.content.size && (a = a.copy(Pr(a.content, t, a))),
      a.isInline && (a = t(a, n, i)),
      r.push(a));
  }
  return J.fromArray(r);
}
var Fr = class e extends Mr {
  constructor(e, t, n) {
  ...
  apply(e) {
    ...
    return Nr.fromReplace(e, this.from, this.to, i);
  }
  invert() {
...
Mr.jsonID(`addMark`, Fr);
var Ir = class e extends Mr {
  constructor(e, t, n) {
    (super(), (this.from = e), (this.to = t), (this.mark = n));
  }
  apply(e) {
    let t = e.slice(this.from, this.to),
      n = new X(
        Pr(t.content, (e) => e.mark(this.mark.removeFromSet(e.marks)), e),
        t.openStart,
        t.openEnd,
      );
    return Nr.fromReplace(e, this.from, this.to, n);
  }
  invert() {
...
var Lr = class e extends Mr {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return Nr.fail(`No node at mark step's position`);
    let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return Nr.fromReplace(
      e,
      this.pos,
      this.pos + 1,
      new X(J.from(n), 0, t.isLeaf ? 0 : 1),
    );
  }
  invert(t) {
...
Mr.jsonID(`addNodeMark`, Lr);
var Rr = class e extends Mr {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
...
Mr.jsonID(`removeNodeMark`, Rr);
var zr = class e extends Mr {
  ...
  apply(e) {
    return this.structure && Vr(e, this.from, this.to)
      ? Nr.fail(`Structure replace would overwrite content`)
      : Nr.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  static fromJSON(t, n) {
    ...
    return new e(n.from, n.to, X.fromJSON(t, n.slice), !!n.structure);
  }
};
((zr.MAP_BIAS = 1), Mr.jsonID(`replace`, zr));
var Br = class e extends Mr {
  ...
  apply(e) {
    if (
      this.structure &&
      (Vr(e, this.from, this.gapFrom) || Vr(e, this.gapTo, this.to))
    )
      return Nr.fail(`Structure gap-replace would overwrite content`);
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return Nr.fail(`Gap is not a flat range`);
    let n = this.slice.insertAt(this.insert, t.content);
    return n
      ? Nr.fromReplace(e, this.from, this.to, n)
      : Nr.fail(`Content does not fit in gap`);
  }
  getMap() {
    return new kr([
      this.from,
  ...
  static fromJSON(t, n) {
    ...
    return new e(
      ...
      n.gapFrom,
      n.gapTo,
      X.fromJSON(t, n.slice),
      n.insert,
      !!n.structure,
    );
  }
};
Mr.jsonID(`replaceAround`, Br);
function Vr(e, t, n) {
  let r = e.resolve(t),
    i = n - t,
    a = r.depth;
      ...
      for (let e = 0; e < u.length; e++)
        u[e].isInSet(f) ||
          (o && o.to == l && o.mark.eq(u[e])
            ? (o.to = d)
            : i.push((o = new Ir(l, d, u[e]))));
      s && s.to == l ? (s.to = d) : a.push((s = new Fr(l, d, r)));
    }
  }),
...
function Ur(e, t, n, r) {
  ...
  (e.doc.nodesBetween(t, n, (e, o) => {
    ...
    i.forEach((t) => e.step(new Ir(t.from, t.to, t.style))));
}
function Wr(e, t, n, r = n.contentMatch, i = !0) {
  ...
  for (let t = 0; t < a.childCount; t++) {
    ...
    if (!u) o.push(new zr(s, l, X.empty));
    else {
      r = u;
      for (let t = 0; t < c.marks.length; t++)
        n.allowsMarkType(c.marks[t].type) || e.step(new Ir(s, l, c.marks[t]));
      if (i && c.isText && n.whitespace != `pre`) {
        ...
        for (; (e = t.exec(c.text)); )
          ((r ||= new X(
            J.from(n.schema.text(` `, n.allowedMarks(c.marks))),
            0,
            0,
          )),
            o.push(new zr(s + e.index, s + e.index + e[0].length, r)));
      }
    }
    s = l;
  }
...
function Gr(e, t, n) {
  ...
  for (let e = a, t = !1; e > n; e--)
    t || r.index(e) > 0
      ? ((t = !0), (u = J.from(r.node(e).copy(u))), d++)
      : c--;
  let f = J.empty,
    p = 0;
  for (let e = a, t = !1; e > n; e--)
    t || i.after(e + 1) < i.end(e)
      ? ((t = !0), (f = J.from(i.node(e).copy(f))), p++)
      : l++;
  e.step(new Br(c, l, o, s, new X(u.append(f), d, p), u.size - d, !0));
}
function Kr(e, t, n) {
  let r = J.empty;
  ...
  let i = t.start,
    a = t.end;
  e.step(new Br(i, a, i, a, new X(r, 0, 0), n.length, !0));
}
function qr(e, t, n, r, i) {
  ...
  e.doc.nodesBetween(t, n, (t, n) => {
    ...
    if (
      t.isTextblock &&
      !t.hasMarkup(r, o) &&
      Xr(e.doc, e.mapping.slice(a).map(n), r)
    ) {
      let i = null;
      ...
      (i === !1 && Yr(e, t, n, a),
        Wr(e, e.mapping.slice(a).map(n, 1), r, void 0, i === null));
      ...
      return (
        e.step(
          new Br(
            ...
            c + 1,
            l - 1,
            new X(J.from(r.create(o, null, t.marks)), 0, 0),
            1,
            !0,
          ),
        ),
...
function Qr(e, t, n = 1, r) {
  ...
  e.step(new zr(t, t, new X(a.append(o), n, n), !0));
}
function $r(e, t, n) {
  let r = null,
  ...
  if (r === !1) {
    ...
    Yr(e, r.node(), r.before(), s);
  }
  o.inlineContent &&
    Wr(e, t + n - 1, o, a.node().contentMatchAt(a.index()), r == null);
  let c = e.mapping.slice(s),
    l = c.map(t - n);
  if ((e.step(new zr(l, c.map(t + n, -1), X.empty, !0)), r === !0)) {
    let t = e.doc.resolve(l);
    Jr(e, t.node(), t.before(), e.steps.length);
  }
  return e;
}
function ei(e, t, n) {
...
function ni(e, t, n = t, r = X.empty) {
  if (t == n && !r.size) return null;
  let i = e.resolve(t),
    a = e.resolve(n);
  return ri(i, a, r) ? new zr(t, n, r) : new ii(i, a, r).fit();
}
function ri(e, t, n) {
  return (
    !n.openStart &&
...
var ii = class {
  constructor(e, t, n) {
    ...
    for (let t = e.depth; t > 0; t--)
      this.placed = J.from(e.node(t).copy(this.placed));
  }
  get depth() {
  ...
  fit() {
    ...
    let s = new X(i, a, o);
    return e > -1
      ? new Br(n.pos, e, this.$to.pos, this.$to.end(), s, t)
      : s.size || n.pos != this.$to.pos
        ? new zr(n.pos, r.pos, s)
        : null;
  }
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let e,
          r = null;
        n
          ? ((r = si(this.unplaced.content, n - 1).firstChild), (e = r.content))
        ...
        for (let e = this.depth; e >= 0; e--) {
          ...
          if (
            t == 1 &&
            (i
              ? o.matchType(i.type) || (c = o.fillBefore(J.from(i), !1))
  ...
  dropNode() {
    ...
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new X(ai(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new X(ai(e, t, 1), t, n);
  }
  placeNodes({
    sliceDepth: e,
    frontierDepth: t,
    ...
    (p || (f = -1),
      (this.placed = oi(this.placed, t, J.from(l))),
    ...
    this.unplaced = p
      ? e == 0
        ? X.empty
        : new X(ai(a.content, e - 1, 1), e - 1, f < 0 ? a.openEnd : e - 1)
      : new X(ai(a.content, e, c), a.openStart, a.openEnd);
  }
  mustMoveInline() {
  ...
  close(e) {
    ...
    (t.fit.childCount && (this.placed = oi(this.placed, t.depth, t.fit)),
      (e = t.move));
  ...
  openFrontierNode(e, t = null, n) {
    ...
    ((r.match = r.match.matchType(e)),
      (this.placed = oi(this.placed, this.depth, J.from(e.create(t, n)))),
...
function ai(e, t, n) {
  return t == 0
    ...
    : e.replaceChild(0, e.firstChild.copy(ai(e.firstChild.content, t - 1, n)));
}
function oi(e, t, n) {
  return t == 0
    ? e.append(n)
    : e.replaceChild(
        e.childCount - 1,
        e.lastChild.copy(oi(e.lastChild.content, t - 1, n)),
      );
}
function si(e, t) {
...
function ci(e, t, n) {
  ...
  return (
    t > 1 &&
      (r = r.replaceChild(
        0,
        ci(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0),
      )),
    t > 0 &&
      ((r = e.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 &&
        (r = r.append(
          e.type.contentMatch.matchFragment(r).fillBefore(J.empty, !0),
        ))),
    e.copy(r)
  );
}
...
function fi(e, t, n, r) {
  ...
  let i = e.doc.resolve(t),
    a = e.doc.resolve(n);
  if (ri(i, a, r)) return e.step(new zr(t, n, r));
  let o = gi(i, a);
      ...
      for (let t = 0; t < o.length; t++) {
        ...
        if (f.canReplaceWith(p, p, d.type, d.marks))
          return e.replace(
            i.before(l),
            u ? a.after(l) : n,
            new X(pi(r.content, 0, r.openStart, s), s, r.openEnd),
          );
      }
  }
...
function mi(e, t, n, r) {
  ...
  e.replaceRange(t, n, new X(J.from(r), 0, 0));
}
function hi(e, t, n) {
...
var _i = class e extends Mr {
  constructor(e, t, n) {
    (super(), (this.pos = e), (this.attr = t), (this.value = n));
  }
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return Nr.fail(`No node at attribute step's position`);
    let n = Object.create(null);
...
((yi = function e(t) {
  ...
  (yi.prototype.name = `TransformError`));
var bi = class {
    constructor(e) {
      ((this.doc = e),
        (this.steps = []),
    ...
    replaceWith(e, t, n) {
      return this.replace(e, t, new X(J.from(n), 0, 0));
    }
    delete(e, t) {
    ...
    setBlockType(e, t = e, n, r = null) {
      return (qr(this, e, t, n, r), this);
    }
    setNodeMarkup(e, t, n = null, r) {
      return (Zr(this, e, t, n, r), this);
    }
    ...
    removeNodeMark(e, t) {
      ...
      if (t instanceof Y) t.isInSet(n.marks) && this.step(new Rr(e, t));
      else {
        let r = n.marks,
          i,
          a = [];
        for (; (i = t.isInSet(r)); )
          (a.push(new Rr(e, i)), (r = i.removeFromSet(r)));
  ...
  Z = class {
    constructor(e, t, n) {
      ((this.$anchor = e),
        (this.$head = t),
        (this.ranges = n || [new Si(e.min(t), e.max(t))]));
    }
    get anchor() {
    ...
    replace(e, t = X.empty) {
      ...
      for (let o = 0; o < a.length; o++) {
        let { $from: s, $to: c } = a[o],
          l = e.mapping.slice(i);
        (e.replaceRange(l.map(s.pos), l.map(c.pos), o ? X.empty : t),
          o == 0 && Ai(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1));
      }
    }
    replaceWith(e, t) {
      ...
      for (let i = 0; i < r.length; i++) {
        ...
        i
          ? e.deleteRange(c, l)
          : (e.replaceRangeWith(c, l, t), Ai(e, n, t.isInline ? -1 : 1));
      }
    }
    static findFrom(e, t, n = !1) {
      let r = e.parent.inlineContent
        ? new Q(e)
        : ki(e.node(0), e.parent, e.pos, e.index(), t, n);
      if (r) return r;
      for (let r = e.depth - 1; r >= 0; r--) {
        let i =
          t < 0
            ? ki(e.node(0), e.node(r), e.before(r + 1), e.index(r), t, n)
            : ki(e.node(0), e.node(r), e.after(r + 1), e.index(r) + 1, t, n);
        if (i) return i;
      }
      return null;
    }
  ...
  static between(t, n, r) {
    ...
    return (
      t.parent.inlineContent ||
        (i == 0
          ? (t = n)
          : ((t = (Z.findFrom(t, -r, !0) || Z.findFrom(t, r, !0)).$anchor),
            t.pos < n.pos != i < 0 && (t = n))),
      new e(t, n)
    );
  }
...
var Ti = class e {
  ...
  $ = class e extends Z {
    ...
    content() {
      return new X(J.from(this.node), 0, 0);
    }
    eq(t) {
...
(($.prototype.visible = !1), Z.jsonID(`node`, $));
var Ei = class e {
    constructor(e) {
      this.anchor = e;
    }
    ...
    resolve(e) {
      let t = e.resolve(this.anchor),
        n = t.nodeAfter;
      return n && $.isSelectable(n) ? new $(t) : Z.near(t);
    }
  },
  Di = class e extends Z {
    constructor(e) {
...
function ki(e, t, n, r, i, a = !1) {
  ...
  for (let o = r - (i > 0 ? 0 : 1); i > 0 ? o < t.childCount : o >= 0; o += i) {
    ...
    if (!r.isAtom) {
      ...
      if (t) return t;
    } else if (!a && $.isSelectable(r))
      return $.create(e, n - (i < 0 ? r.nodeSize : 0));
    n += r.nodeSize * i;
  }
  return null;
}
function Ai(e, t, n) {
  ...
  if (r < t) return;
  let i = e.steps[r];
  if (!(i instanceof zr || i instanceof Br)) return;
  ...
  Pi = class extends bi {
    ...
    setSelection(e) {
      ...
      return (
        (this.curSelection = e),
        (this.curSelectionFor = this.steps.length),
        (this.updated = (this.updated | ji) & ~Mi),
    ...
    ensureMarks(e) {
      return (
        Y.sameSet(this.storedMarks || this.selection.$from.marks(), e) ||
    ...
    addStep(e, t) {
      (super.addStep(e, t), (this.updated &= ~Mi), (this.storedMarks = null));
    }
    setTime(e) {
        ...
        t &&
          (e = e.mark(
            this.storedMarks ||
              (n.empty
                ? n.$from.marks()
                : n.$from.marksAcross(n.$to) || Y.none),
          )),
...
var Ii = class {
    constructor(e, t, n) {
      ((this.name = e),
        (this.init = Fi(t.init, n)),
        (this.apply = Fi(t.apply, n)));
    }
  },
  Li = [
    new Ii(`doc`, {
        ...
        t &&
          t.forEach((e) => {
            ...
            (this.plugins.push(e),
              ...
              e.spec.state && this.fields.push(new Ii(e.key, e.spec.state, e)));
          }));
    }
  },
  zi = class e {
    ...
    static create(t) {
      let n = new Ri(t.doc ? t.doc.type.schema : t.schema, t.plugins),
        r = new e(n);
    ...
    reconfigure(t) {
      let n = new Ri(this.schema, t.plugins),
        r = n.fields,
        i = new e(n);
      for (let e = 0; e < r.length; e++) {
        let n = r[e].name;
    ...
    static fromJSON(t, n, r) {
      ...
      let i = new Ri(t.schema, t.plugins),
        a = new e(i);
      return (
        i.fields.forEach((e) => {
          if (e.name == `doc`) a.doc = Cn.fromJSON(t.schema, n.doc);
          else if (e.name == `selection`)
            a.selection = Z.fromJSON(a.doc, n.selection);
...
var Vi = class {
    constructor(e) {
      ((this.spec = e),
        (this.props = {}),
        e.props && Bi(e.props, this, this.props),
        (this.key = e.key ? e.key.key : Ui(`plugin`)));
    }
    getState(e) {
      return e[this.key];
    }
...
function Ui(e) {
  return e in Hi ? e + `$` + ++Hi[e] : ((Hi[e] = 0), e + `$`);
}
var Wi = class {
    constructor(e = `key`) {
      this.key = Ui(e);
  ...
  Gi = new Wi(`transactionEventPlugin`),
  Ki = `prosemirrorDispatchTransaction`;
function qi(e, t) {
  let { eventTarget: n } = Gi.getState(e.state);
  return (
    n.addEventListener(Ki, t),
    () => {
...
var Yi = () => {
  ...
  Xi = (e, t) => {
    ...
    n[0] === e.view
      ? (r = n[1])
      : ((r = (t) => qi(e.view, t)), (n[0] = e.view), (n[1] = r));
    let i, a;
    return (
      n[2] !== e || n[3] !== t
        ? ((i = () => t(e)),
          ...
          (n[5] = a))
        : ((i = n[4]), (a = n[5])),
      (0, G.useSyncExternalStore)(r, i, a)
    );
  },
  Zi = `Files`;
function Qi(e) {
  ...
  let { types: t } = e;
  for (let e = 0; e < t.length; e += 1) if (t[e] === Zi) return !0;
  return !1;
}
function $i(e) {
  return ra(e).filter(o);
}
function ea(e) {
  let t = [],
    n = [];
  for (let r of ra(e)) o(r) ? t.push(r) : n.push(r);
...
function na(e, t) {
  ...
  for (let i of e) {
    ...
    let a = D(e),
      o = T(a);
    r.has(o) ||
      (r.add(o), n.push({ label: E(a) || i.name || a, path: a, fsPath: a }));
  }
  return n;
}
function ra(e) {
...
function ia(e, t) {
  let i = w(e.path)?.pluginMarketplaceName ?? null;
  return t == null || i == null || !r(i) || i === n(t);
}
var aa = e(We(), 1),
  oa = e(R(), 1);
function sa(e) {
  ...
  t[0] === l
    ? (g = t[1])
    : ((g = { enabled: !0, hostId: l }), (t[0] = l), (t[1] = g));
  let _ = L(g),
    v = _.data == null ? null : _.data.filter(ua),
    { skills: y, isLoading: b } = re(c ?? s, l),
    x = F(),
    S;
  t[2] !== s || t[3] !== c
    ? ((S = c ?? (s ? [s] : [])), (t[2] = s), (t[3] = c), (t[4] = S))
    : (S = t[4]);
  let C = S,
    w = m.formatMessage({
  ...
  let E = da(
      [
        ...(0, oa.default)(y.filter((e) => e.enabled && ia(e, x)).map(T), la),
        ...(v == null
          ? []
          : v.map((e) => {
              let t = me(e);
    ...
    D = E.map(ca),
    O = E.length === 0 && (b || (v == null && _.isLoading)),
    j = f === `default` ? `both` : `bottom`;
  Ot({ isLoading: O, onRequestClose: o, query: r, resultCount: E.length });
  let {
      highlightedIndex: ee,
      listRef: M,
      getItemProps: N,
  ...
  t[9] === n
    ? (te = t[10])
    : ((te = p(`max-h-[240px] electron:text-base`, n)),
      (t[9] = n),
      (t[10] = te));
  let ne = Pt,
    I = O
                ...
                children: (0, K.jsxs)(`div`, {
                  ...
                  children: [
                    e.kind === `app`
                      ...
                      : e.Icon
                        ? (0, K.jsx)(e.Icon, { className: `icon-xs shrink-0` })
                        : (0, K.jsx)(n, { className: `icon-xs shrink-0` }),
                    (0, K.jsx)(`span`, {
    ...
    R;
  t[11] !== ne || t[12] !== j || t[13] !== M || t[14] !== I
    ? ((R = (0, K.jsx)(ne, { fadeMaskVariant: j, listRef: M, children: I })),
      (t[11] = ne),
      (t[12] = j),
      (t[13] = M),
      (t[14] = I),
  ...
  let z;
  return (
    t[16] !== P || t[17] !== f || t[18] !== te || t[19] !== R
      ? ((z = (0, K.jsx)(P, { chromeVariant: f, className: te, children: R })),
        (t[16] = P),
        (t[17] = f),
        (t[18] = te),
        (t[19] = R),
...
function da(e, t) {
  ...
  return n.length === 0
    ? e
    : (0, aa.default)(
        e.map((e, t) => ({ item: e, score: fa(e, n), index: t })),
...
function fa(e, t) {
  return Math.max(O(e.name, t), O(e.displayName, t), O(e.path, t));
}
function pa(e) {
...
function ma({
  ...
  let r = e.filter((e) => !t.includes(e.conversationId)),
    i = n.trim(),
    a = i.length === 0 ? r : ha(r, i).filter((e) => _a(e, i) > 0);
  return {
    sections: [
      {
        id: `agents`,
        ...
        items: a.map((e) => ({
          ...
          label: e.displayName,
          detail: e.agentRole,
          labelStyle: { color: l(e.conversationId) },
...
function ha(e, t) {
  return (0, aa.default)(
    e.map((e, n) => ({ agent: e, score: _a(e, t), index: n })),
...
var va = e(I(), 1);
function ya({ agents: e, query: t }) {
  if (e.length === 0) return null;
  let n = t.trim(),
    r = n.length === 0 ? e : ba(e, n).filter((e) => xa(e, n) > 0);
  return {
    sections: [
      {
        id: `custom-agents`,
...
function ba(e, t) {
  return (0, aa.default)(
    e.map((e, n) => ({ agent: e, score: xa(e, t), index: n })),
...
function xa(e, t) {
  return Math.max(
    ...
    O(`@${e.roleName}`, t),
    O(e.description ?? ``, t),
    ...e.nicknameCandidates.map((e) => O(e, t)),
  );
}
var Sa = [],
  Ca = { sections: [] };
function wa(e) {
  ...
  t[0] !== n || t[1] !== i || t[2] !== a
    ? ((s = { hostId: n, includeDirectories: !0, query: i, roots: a }),
      ...
      (t[3] = s))
    : (s = t[3]);
  let { files: c, isLoading: l } = Ye(s),
    u = i.trim();
  if (a == null || a.length === 0) return Ca;
  let d = null;
  if (u.length === 0) {
    let e;
  ...
  t[7] === c
    ? (p = t[8])
    : ((p = c == null ? Sa : c.map(Ta)), (t[7] = c), (t[8] = p));
  let m = l || o,
    h;
  return (
...
var Ea = [`chrome-dev`, `chrome-internal`, `chrome`],
  Da = ee({
    macTitle: {
...
function Oa(e) {
  ...
  let { nativeApps: p, isLoading: m } = Ie(f),
    h;
  t[2] === l ? (h = t[3]) : ((h = Na(l)), (t[2] = l), (t[3] = h));
  let g = h,
    y = c.formatMessage({
    ...
    C = p.find(ja) ?? null,
    w =
      u.length > 0 && b != null && Ma(b, u)
        ? {
            kind: `chrome-plugin`,
            plugin: b,
            mention: { ...Ee(b, a), name: Ve, displayName: Ve, description: y },
            nativeApp: C == null ? null : { ...C, displayName: Ce(C) },
          }
        : null,
    T =
      u.length === 0 || r == null
        ...
        : p
            ...
            .filter((e) => Pa(e.app.displayName, u)),
    E = [...(w == null ? [] : [w]), ...T].slice(0, 2),
    D = E.flatMap(Aa),
    O = S({
      queries: D.map((e) => ({
        queryKey: x(`computer-use-native-desktop-app-icon`, {
          appPath: e.appPath,
        }),
        queryFn: () =>
          v(`computer-use-native-desktop-app-icon`, {
    ...
    A = u.length > 0 && m && w == null && T.length === 0 ? g.loading : null;
  if ((r == null && w == null) || (E.length === 0 && A == null)) return null;
  let j = g.title,
    ee = E.map((e) => {
    ...
    M;
  t[4] !== m || t[5] !== O
    ? ((M = m || O.some(ka)), (t[4] = m), (t[5] = O), (t[6] = M))
    : (M = t[6]);
  let N;
  return (
    t[7] !== A || t[8] !== ee || t[9] !== M || t[10] !== g.title
      ? ((N = {
          id: `native-apps`,
          title: j,
          items: ee,
...
function Na(e) {
  return e === `macOS`
    ? { title: Da.macTitle, loading: Da.macLoading }
    : { title: Da.desktopTitle, loading: Da.desktopLoading };
}
function Pa(e, t) {
  return e
    .toLocaleLowerCase()
...
function La(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = { additionalMarketplaceKinds: [`shared-with-me`] }), (t[0] = s))
    : (s = t[0]);
  let { availablePlugins: c, isLoading: l } = te(n, i, s),
    { openPluginInstall: u } = Ke(),
    d = fe(a),
    f = r.trim(),
    p = c.filter(Ra),
    m = Te(p),
    ...
    g = h ? Ba(p) : [],
    _ = new Set(g),
    v = h ? p.filter((e) => !_.has(e) && (e.plugin.installed || !za(e))) : p,
    y;
  t[1] === u
    ? (y = t[2])
    : ((y = (e) => {
  ...
  let b = y,
    x = Oa({
      chromeAppPlugins: g,
      computerUsePlugin: m,
      onPluginMentionInserted: b,
      pluginMentionLabels: d,
      query: r,
    }),
    S = f.length === 0 ? v : Ha(v, f, d).filter((e) => Ua(e, f, d) > 0),
    C = l && S.length === 0;
  if (S.length === 0 && !C && x == null) {
    let e;
    return (
      t[3] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = { sections: [] }), (t[3] = e))
        ...
        items: S.map((e) => {
          ...
          return {
            ...
            insertMention: (n) => {
              ...
              (r.insertMentionFromAtMention(t, i), b(e));
            },
          };
        }),
        emptyState: n,
  ...
  return (x != null && w.push(x), { sections: w });
}
function Ra(e) {
  return e.plugin.availability === Ia
    ? !1
    : e.plugin.enabled
      ? !0
      : !e.plugin.installed && Fa.includes(e.plugin.name);
}
function za(e) {
  return Ea.includes(e.plugin.name);
}
function Ba(e) {
  let t = F(),
    r = n(t),
    i = Va(t);
  return (0, aa.default)(
    e.filter((e) => za(e) && e.marketplaceName === r),
    [(e) => (e.plugin.name === i ? 0 : 1), (e) => Ea.indexOf(e.plugin.name)],
  );
}
function Va(e) {
  switch (e) {
...
function Ha(e, t, n) {
  return (0, aa.default)(
    e.map((e, r) => ({ plugin: e, score: Ua(e, t, n), index: r })),
    [(e) => -e.score, (e) => Ee(e.plugin, n).displayName, (e) => e.index],
  ).map((e) => e.plugin);
}
function Ua(e, t, n) {
  let r = Ee(e, n);
  return Math.max(
    ...
    O(r.displayName, t),
    O(`@${r.displayName}`, t),
    O(`@${e.displayName ?? e.plugin.name}`, t),
  );
}
function Wa(e) {
  let t = (0, W.c)(14),
  ...
  let { skills: c, isLoading: l } = re(i, n, s),
    u;
  t[2] === o ? (u = t[3]) : ((u = { enabled: o }), (t[2] = o), (t[3] = u));
  let { installedPlugins: d, isLoading: f } = te(n ?? `local`, i, u),
    p = new Set(d.map(Ka)),
    m = F();
  if (!o) {
    let e;
  ...
  return (
    t[9] !== l || t[10] !== _ || t[11] !== v || t[12] !== y
      ? ((b = {
          sections: [
            { id: `skills`, title: _, items: v, emptyState: y, isLoading: l },
          ],
        }),
        (t[9] = l),
        (t[10] = _),
...
function qa(e, t, n, r = null) {
  if (!e.enabled || !ia(e, r)) return !1;
  let i = w(e.path)?.pluginId;
  return i == null || !Ea.includes(i) || (!n && !t.has(i));
}
function Ja(e, t) {
  return (0, aa.default)(
    e.map((e, n) => ({ skill: e, score: Ya(e, t), index: n })),
    [
      (e) => -e.score,
      (e) =>
...
function Za(e) {
  ...
  let x = Wa(b),
    ...
    T = S?.roles.filter((e) => !w.has(e.roleName)) ?? [],
    E = ma({ backgroundAgents: u, excludedConversationIds: d, query: c }),
    D = f ? ya({ agents: T, query: c }) : null,
    O = E?.sections[0] ?? null,
    k = D?.sections[0] ?? null,
    A = [...(O?.items ?? []), ...(k?.items ?? [])],
    ee =
    ...
    N = $a(Qa(pa([ee == null ? null : { sections: [ee] }, y, x, g]), c)),
    P;
  return (
    t[13] === N
      ? (P = t[14])
      : ((P = { sections: N }), (t[13] = N), (t[14] = P)),
    P
  );
}
function Qa(e, t = ``) {
...
for (
  var to = {
    ...
    ro = typeof navigator < `u` && /Mac/.test(navigator.platform),
    io =
      typeof navigator < `u` &&
  ...
  to[48 + ao] = to[96 + ao] = String(ao);
for (var ao = 1; ao <= 24; ao++) to[ao + 111] = `F` + ao;
for (var ao = 65; ao <= 90; ao++)
  ((to[ao] = String.fromCharCode(ao + 32)), (no[ao] = String.fromCharCode(ao)));
for (var oo in to) no.hasOwnProperty(oo) || (no[oo] = to[oo]);
function so(e) {
  var t =
    (!(
      (ro && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
      (io && e.shiftKey && e.key && e.key.length == 1) ||
      e.key == `Unidentified`
    ) &&
      e.key) ||
    (e.shiftKey ? no : to)[e.keyCode] ||
    e.key ||
    `Unidentified`;
  return (
    t == `Esc` && (t = `Escape`),
...
var co =
  ...
  lo = typeof navigator < `u` && /Win/.test(navigator.platform);
function uo(e) {
  let t = e.split(/-(?!$)/),
    n = t[t.length - 1];
  n == `Space` && (n = ` `);
  ...
  for (let e = 0; e < t.length - 1; e++) {
    ...
    else if (/^mod$/i.test(n)) co ? (o = !0) : (i = !0);
...
function mo(e) {
  return new Vi({ props: { handleKeyDown: ho(e) } });
}
function ho(e) {
  let t = fo(e);
  return function (e, n) {
...
function _o(e) {
  return { ...go, suppressedAnchorPos: e.anchorPos, suppressedQuery: e.query };
}
function vo(e, t) {
...
function yo(e, t, n) {
  let { state: r } = e,
    i = t.getState(r);
  return i?.active !== !0 || !vo(i, n)
    ? !1
    : (e.dispatch(r.tr.setMeta(t, _o(i))), !0);
}
var bo = 50;
function xo(e, t) {
  let { $from: n } = e.selection,
    r = n.parent,
    i = n.parentOffset,
    a = r.textBetween(Math.max(0, i - bo), i, void 0, `￼`),
    o = t.exec(a);
  if (!o) return null;
  let s = i - o[2].length,
    c = n.start() + s;
          ...
          if ((l && (c = { ...c, ...l }), e.selectionSet || e.docChanged)) {
            ...
            if (e && e.text.startsWith(n)) {
              ...
              c = Co(c, r, t)
                ...
                : { ...go, active: !0, anchorPos: r, query: t };
            } else (c.active && a?.(), (c = go));
          }
          return c;
        },
      },
    ...
    mo({
      Escape: (e, n) =>
        t.getState(e)?.active && n !== void 0
          ? (n(e.tr.setMeta(t, go)), a(), !0)
          : !1,
    }),
    mo({
      Tab: (e, n) =>
        t.getState(e)?.active && n !== void 0
          ? (n(e.tr.setMeta(t, go)), i(), !0)
          : !1,
      Enter: (e, n) =>
        t.getState(e)?.active && n !== void 0
          ? (n(e.tr.setMeta(t, go)), i(), !0)
...
var wo = new Wi(`mention-ui`);
function To(e = {}) {
  return So({ key: wo, trigger: `@`, wordPattern: /(^|\s)(@[^@]*)$/, ...e });
}
function Eo(e) {
  let t = (0, W.c)(15),
    n = Xi(e, Do),
...
function Do(e) {
  return wo.getState(e.view.state);
}
var Oo = 65535,
  ko = 2 ** 16;
function Ao(e, t) {
...
var No = 1,
  ...
  Lo = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (No | Fo)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (Po | Fo)) > 0;
    }
    get deletedAcross() {
      ...
      for (let o = 0; o < this.ranges.length; o += 3) {
        ...
        if (e <= u) {
          let i = c ? (e == s ? -1 : e == u ? 1 : t) : t,
            a = s + r + (i < 0 ? 0 : l);
          if (n) return a;
          let d = e == (t < 0 ? s : u) ? null : Ao(o / 3, e - s),
            f = e == s ? Po : e == u ? No : Fo;
          return ((t < 0 ? e != s : e != u) && (f |= Io), new Lo(a, f, d));
        }
        r += l - c;
      }
      return n ? e + r : new Lo(e + r, 0, null);
    }
    touches(e, t) {
      let n = 0,
        r = jo(t),
...
var zo = Object.create(null),
  Bo = class {
    ...
    static jsonID(e, t) {
      if (e in zo) throw RangeError(`Duplicate use of step JSON ID ` + e);
...
function Ho(e, t, n) {
  ...
  for (let i = 0; i < e.childCount; i++) {
    let a = e.child(i);
    (a.content.size && (a = a.copy(Ho(a.content, t, a))),
      a.isInline && (a = t(a, n, i)),
      r.push(a));
  }
  return J.fromArray(r);
}
var Uo = class e extends Bo {
  constructor(e, t, n) {
    (super(), (this.from = e), (this.to = t), (this.mark = n));
  }
  apply(e) {
    ...
    return Vo.fromReplace(e, this.from, this.to, i);
  }
  invert() {
    return new Wo(this.from, this.to, this.mark);
  }
  map(t) {
    let n = t.mapResult(this.from, 1),
      r = t.mapResult(this.to, -1);
...
Bo.jsonID(`addMark`, Uo);
var Wo = class e extends Bo {
  constructor(e, t, n) {
    (super(), (this.from = e), (this.to = t), (this.mark = n));
  }
  apply(e) {
    let t = e.slice(this.from, this.to),
      n = new X(
        Ho(t.content, (e) => e.mark(this.mark.removeFromSet(e.marks)), e),
        t.openStart,
        t.openEnd,
      );
    return Vo.fromReplace(e, this.from, this.to, n);
  }
  invert() {
    return new Uo(this.from, this.to, this.mark);
  }
  map(t) {
    let n = t.mapResult(this.from, 1),
      r = t.mapResult(this.to, -1);
...
Bo.jsonID(`removeMark`, Wo);
var Go = class e extends Bo {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return Vo.fail(`No node at mark step's position`);
    let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return Vo.fromReplace(
      e,
      this.pos,
      this.pos + 1,
      new X(J.from(n), 0, t.isLeaf ? 0 : 1),
  ...
  invert(t) {
    ...
    return new Ko(this.pos, this.mark);
  }
  map(t) {
    let n = t.mapResult(this.pos, 1);
    return n.deletedAfter ? null : new e(n.pos, this.mark);
...
Bo.jsonID(`addNodeMark`, Go);
var Ko = class e extends Bo {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
...
Bo.jsonID(`removeNodeMark`, Ko);
var qo = class e extends Bo {
  constructor(e, t, n, r = !1) {
    (super(),
      (this.from = e),
      (this.to = t),
  ...
  apply(e) {
    return this.structure && Yo(e, this.from, this.to)
      ? Vo.fail(`Structure replace would overwrite content`)
      : Vo.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
    return new Ro([this.from, this.to - this.from, this.slice.size]);
  }
  invert(t) {
    return new e(
      this.from,
...
Bo.jsonID(`replace`, qo);
var Jo = class e extends Bo {
  constructor(e, t, n, r, i, a, o = !1) {
    (super(),
      (this.from = e),
      (this.to = t),
  ...
  apply(e) {
    if (
      this.structure &&
      (Yo(e, this.from, this.gapFrom) || Yo(e, this.gapTo, this.to))
    )
      return Vo.fail(`Structure gap-replace would overwrite content`);
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return Vo.fail(`Gap is not a flat range`);
    let n = this.slice.insertAt(this.insert, t.content);
    return n
      ? Vo.fromReplace(e, this.from, this.to, n)
      : Vo.fail(`Content does not fit in gap`);
  }
  getMap() {
    return new Ro([
      this.from,
...
function Zo(e) {
  ...
  for (let n = e.depth; ; --n) {
    ...
    if (n == 0 || r.type.spec.isolating || !Xo(r, i, a)) break;
  }
  return null;
}
...
function $o(e, t) {
  let n = e.resolve(t),
    r = n.index();
  return ts(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function es(e, t) {
...
function ts(e, t) {
  return !!(e && t && !e.isLeaf && es(e, t));
}
function ns(e, t, n = t, r = X.empty) {
  if (t == n && !r.size) return null;
  let i = e.resolve(t),
    a = e.resolve(n);
  return rs(i, a, r) ? new qo(t, n, r) : new is(i, a, r).fit();
}
function rs(e, t, n) {
  return (
    !n.openStart &&
...
var is = class {
  ...
  fit() {
    ...
    let s = new X(i, a, o);
    return e > -1
      ? new Jo(n.pos, e, this.$to.pos, this.$to.end(), s, t)
      : s.size || n.pos != this.$to.pos
        ? new qo(n.pos, r.pos, s)
        : null;
  }
  findFittable() {
    let e = this.unplaced.openStart;
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let e,
          r = null;
        n
          ? ((r = cs(this.unplaced.content, n - 1).firstChild), (e = r.content))
          : (e = this.unplaced.content);
        let i = e.firstChild;
        for (let e = this.depth; e >= 0; e--) {
          let { type: a, match: o } = this.frontier[e],
  ...
  dropNode() {
    ...
    if (r.childCount <= 1 && t > 0) {
      let i = e.size - t <= t + r.size;
      this.unplaced = new X(as(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new X(as(e, t, 1), t, n);
  }
  placeNodes({
    sliceDepth: e,
    frontierDepth: t,
    ...
    let p = c == o.childCount;
    (p || (f = -1),
      (this.placed = ss(this.placed, t, J.from(l))),
      (this.frontier[t].match = u),
      p &&
        f < 0 &&
        n &&
    ...
    this.unplaced = p
      ? e == 0
        ? X.empty
        : new X(as(a.content, e - 1, 1), e - 1, f < 0 ? a.openEnd : e - 1)
      : new X(as(a.content, e, c), a.openStart, a.openEnd);
  }
  mustMoveInline() {
    if (!this.$to.parent.isTextblock) return -1;
    let e = this.frontier[this.depth],
    ...
    if (
      !e.type.isTextblock ||
      !us(this.$to, this.$to.depth, e.type, e.match, !1) ||
      (this.$to.depth == this.depth &&
        (t = this.findCloseLevel(this.$to)) &&
        t.depth == this.depth)
    )
  ...
  close(e) {
    ...
    if (!t) return null;
    for (; this.depth > t.depth; ) this.closeFrontierNode();
    (t.fit.childCount && (this.placed = ss(this.placed, t.depth, t.fit)),
      (e = t.move));
    for (let n = t.depth + 1; n <= e.depth; n++) {
      let t = e.node(n),
        r = t.type.contentMatch.fillBefore(t.content, !0, e.index(n));
  ...
  openFrontierNode(e, t = null, n) {
    let r = this.frontier[this.depth];
    ((r.match = r.match.matchType(e)),
      (this.placed = ss(this.placed, this.depth, J.from(e.create(t, n)))),
      this.frontier.push({ type: e, match: e.contentMatch }));
  }
  closeFrontierNode() {
    let e = this.frontier.pop().match.fillBefore(J.empty, !0);
    e.childCount && (this.placed = ss(this.placed, this.frontier.length, e));
  }
};
function as(e, t, n) {
  return t == 0
    ? e.cutByIndex(n, e.childCount)
    : e.replaceChild(0, e.firstChild.copy(as(e.firstChild.content, t - 1, n)));
}
function ss(e, t, n) {
  return t == 0
    ? e.append(n)
    : e.replaceChild(
        e.childCount - 1,
        e.lastChild.copy(ss(e.lastChild.content, t - 1, n)),
      );
}
function cs(e, t) {
  for (let n = 0; n < t; n++) e = e.firstChild.content;
...
function ls(e, t, n) {
  ...
  return (
    t > 1 &&
      (r = r.replaceChild(
        0,
        ls(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0),
      )),
    t > 0 &&
      ((r = e.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 &&
...
function us(e, t, n, r, i) {
  ...
  if (o == a.childCount && !n.compatibleContent(a.type)) return null;
  let s = r.fillBefore(a.content, !0, o);
  return s && !ds(n, a.content, o) ? s : null;
}
function ds(e, t, n) {
  for (let r = n; r < t.childCount; r++)
    if (!e.allowsMarks(t.child(r).marks)) return !0;
...
var fs = class e extends Bo {
  constructor(e, t, n) {
    (super(), (this.pos = e), (this.attr = t), (this.value = n));
  }
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return Vo.fail(`No node at attribute step's position`);
    let n = Object.create(null);
    for (let e in t.attrs) n[e] = t.attrs[e];
    n[this.attr] = this.value;
    let r = t.type.create(n, null, t.marks);
...
((ms = function e(t) {
  ...
  (ms.prototype.name = `TransformError`));
var hs = (e, t) =>
  e.selection.empty
    ? !1
...
var _s = (e, t, n) => {
  ...
  let a = i.nodeBefore;
  if (Ps(e, i, t, -1)) return !0;
  if (r.parent.content.size == 0 && (vs(a, `end`) || $.isSelectable(a)))
    for (let n = r.depth; ; n--) {
      let o = ns(e.doc, r.before(n), r.after(n), X.empty);
      if (o && o.slice.size < o.to - o.from) {
        if (t) {
          let n = e.tr.step(o);
          (n.setSelection(
            vs(a, `end`)
              ? Z.findFrom(n.doc.resolve(n.mapping.map(i.pos, -1)), -1)
              : $.create(n.doc, i.pos - a.nodeSize),
          ),
            t(n.scrollIntoView()));
        }
        return !0;
...
var ys = (e, t, n) => {
  ...
  return !o || !$.isSelectable(o)
    ? !1
    : (t &&
        t(
          e.tr
            .setSelection($.create(e.doc, a.pos - o.nodeSize))
            .scrollIntoView(),
        ),
      !0);
};
...
var Ss = (e, t, n) => {
    ...
    let a = i.nodeAfter;
    if (Ps(e, i, t, 1)) return !0;
    if (r.parent.content.size == 0 && (vs(a, `start`) || $.isSelectable(a))) {
      let n = ns(e.doc, r.before(), r.after(), X.empty);
      if (n && n.slice.size < n.to - n.from) {
        if (t) {
          let r = e.tr.step(n);
          (r.setSelection(
            vs(a, `start`)
              ? Z.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1)
              : $.create(r.doc, r.mapping.map(i.pos)),
          ),
            t(r.scrollIntoView()));
        }
        return !0;
  ...
  Cs = (e, t, n) => {
    ...
    return !o || !$.isSelectable(o)
      ? !1
      : (t && t(e.tr.setSelection($.create(e.doc, a.pos)).scrollIntoView()),
        !0);
  };
function ws(e) {
  if (!e.parent.type.spec.isolating)
...
var Ds = (e, t) => {
  ...
  Os = (e, t) => {
    ...
    if (n instanceof Di || r.parent.inlineContent || i.parent.inlineContent)
      return !1;
    let a = Es(i.parent.contentMatchAt(i.indexAfter()));
  ...
  ks = (e, t) => {
    ...
    if (n.depth > 1 && n.after() != n.end(-1)) {
      let r = n.before();
      if (Qo(e.doc, r)) return (t && t(e.tr.split(r).scrollIntoView()), !0);
    }
    let r = n.blockRange(),
      i = r && Zo(r);
...
function As(e) {
  return (t, n) => {
    ...
    if (t.selection instanceof $ && t.selection.node.isBlock)
      return !r.parentOffset || !Qo(t.doc, r.pos)
        ? !1
    ...
    for (let t = r.depth; ; t--)
      if (r.node(t).isBlock) {
        ((c = r.end(t) == r.pos + (r.depth - t)),
          ...
          (s = Es(r.node(t - 1).contentMatchAt(r.indexAfter(t - 1)))));
    ...
    let u = t.tr;
    (t.selection instanceof Q || t.selection instanceof Di) &&
      u.deleteSelection();
    let d = u.mapping.map(r.pos),
      f = Qo(u.doc, d, a.length, a);
    if (
      ((f ||= ((a[0] = s ? { type: s } : null), Qo(u.doc, d, a.length, a))), !f)
    )
      return !1;
...
var js = As(),
  Ms = (e, t) => (t && t(e.tr.setSelection(new Di(e.doc))), !0);
function Ns(e, t, n) {
  let r = t.nodeBefore,
    i = t.nodeAfter,
    a = t.index();
  return !r || !i || !r.type.compatibleContent(i.type)
    ...
    : !r.content.size && t.parent.canReplace(a - 1, a)
      ...
      : !t.parent.canReplace(a, a + 1) || !(i.isTextblock || $o(e.doc, t.pos))
        ? !1
...
function Ps(e, t, n, r) {
  ...
  if (
    ...
    if (n) {
      ...
      s = J.from(i.copy(s));
      let c = e.tr.step(
          new Jo(t.pos - 1, r, t.pos, r, new X(s, 1, 0), o.length, !0),
        ),
  ...
  let u = a.type.spec.isolating || (r > 0 && c) ? null : Z.findFrom(t, 1),
    d = u && u.$from.blockRange(u.$to),
    f = d && Zo(d);
  if (f != null && f >= t.depth)
    return (n && n(e.tr.lift(d, f).scrollIntoView()), !0);
  if (l && vs(a, `start`, !0) && vs(i, `end`)) {
    let r = i,
      o = [];
...
function Fs(e) {
  return function (t, n) {
    ...
    return i.node(a).isTextblock
      ? (n &&
          n(t.tr.setSelection(Q.create(t.doc, e < 0 ? i.start(a) : i.end(a)))),
        !0)
      : !1;
  };
}
...
var zs = Rs(hs, _s, ys),
  ...
  Hs = {
    "Ctrl-h": Vs.Backspace,
    "Alt-Backspace": Vs[`Mod-Backspace`],
    "Ctrl-d": Vs.Delete,
    "Ctrl-Alt-Backspace": Vs[`Mod-Delete`],
    "Alt-Delete": Vs[`Mod-Delete`],
    "Alt-d": Vs[`Mod-Delete`],
    "Ctrl-a": Is,
    "Ctrl-e": Ls,
  };
for (let e in Vs) Hs[e] = Vs[e];
var Us = (
    typeof navigator < `u`
  ...
  Ys = function (e, t, n, r) {
    return n && (Zs(e, t, n, r, -1) || Zs(e, t, n, r, 1));
  },
  Xs = /^(img|br|input|textarea|hr)$/i;
...
function $s(e, t) {
  for (;;) {
    ...
    if (e.nodeType == 1 && t > 0) {
      ...
      ((e = e.childNodes[t - 1]), (t = Qs(e)));
    } else if (e.parentNode && !nc(e)) ((t = Ws(e)), (e = e.parentNode));
    else return null;
  }
}
function ec(e, t) {
  for (;;) {
    ...
    } else if (e.parentNode && !nc(e)) ((t = Ws(e) + 1), (e = e.parentNode));
    else return null;
  }
}
function tc(e, t, n) {
  for (let r = t == 0, i = t == Qs(e); r || i; ) {
    if (e == n) return !0;
    let t = Ws(e);
...
var rc = function (e) {
  return (
    e.focusNode && Ys(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
  );
};
function ic(e, t) {
  ...
  if (e.caretPositionFromPoint)
    try {
      ...
      if (r)
        return {
          node: r.offsetNode,
          offset: Math.min(Qs(r.offsetNode), r.offset),
        };
    } catch {}
  if (e.caretRangeFromPoint) {
    ...
    if (r)
      return {
        ...
        offset: Math.min(Qs(r.startContainer), r.startOffset),
      };
  }
}
var sc = typeof navigator < `u` ? navigator : null,
  cc = typeof document < `u` ? document : null,
  lc = (sc && sc.userAgent) || ``,
  uc = /Edge\/(\d+)/.exec(lc),
  dc = /MSIE \d/.exec(lc),
  fc = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(lc),
  pc = !!(dc || fc || uc),
  mc = dc ? document.documentMode : fc ? +fc[1] : uc ? +uc[1] : 0,
  hc = !pc && /gecko\/(\d+)/i.test(lc);
hc && +(/Firefox\/(\d+)/.exec(lc) || [0, 0])[1];
var gc = !pc && /Chrome\/(\d+)/.exec(lc),
  _c = !!gc,
  vc = gc ? +gc[1] : 0,
  yc = !pc && !!sc && /Apple Computer/.test(sc.vendor),
  bc = yc && (/Mobile\/\w+/.test(lc) || (!!sc && sc.maxTouchPoints > 2)),
  xc = bc || (sc ? /Mac/.test(sc.platform) : !1),
  Sc = sc ? /Win/.test(sc.platform) : !1,
  Cc = /Android \d/.test(lc),
  wc = !!cc && `webkitFontSmoothing` in cc.documentElement.style,
  Tc = wc
...
function kc(e, t, n) {
  ...
  for (let o = n || e.dom; o; ) {
    ...
    let e = o,
      ...
      l = 0;
    if (
      (t.top < s.top + Dc(r, `top`)
        ? (l = -(s.top - t.top + Dc(i, `top`)))
        : t.bottom > s.bottom - Dc(r, `bottom`) &&
          (l =
            t.bottom - t.top > s.bottom - s.top
              ? t.top + Dc(i, `top`) - s.top
              : t.bottom - s.bottom + Dc(i, `bottom`)),
      t.left < s.left + Dc(r, `left`)
        ? (c = -(s.left - t.left + Dc(i, `left`)))
        : t.right > s.right - Dc(r, `right`) &&
          (c = t.right - s.right + Dc(i, `right`)),
      c || l)
    )
    ...
    o = u == `absolute` ? o.offsetParent : Gs(o);
  }
}
function Ac(e) {
  ...
  return { refDOM: r, refTop: i, stack: jc(e.dom) };
}
function jc(e) {
  let t = [],
    n = e.ownerDocument;
...
function Mc({ refDOM: e, refTop: t, stack: n }) {
...
function Ic(e, t) {
  ...
  for (let u = e.firstChild, d = 0; u; u = u.nextSibling, d++) {
    ...
    else if (u.nodeType == 3) e = qs(u).getClientRects();
    else continue;
...
function Uc(e, t) {
  ...
  if (!o || !e.dom.contains(o.nodeType == 1 ? o : o.parentNode)) {
    ...
    if (!Rc(t, n) || ((o = Hc(e.dom, t, n)), !o)) return null;
  }
  if (yc) for (let e = o; r && e; e = Gs(e)) e.draggable && (r = void 0);
  if (((o = zc(o, t)), r)) {
    if (
      hc &&
      r.nodeType == 1 &&
...
function Gc(e, t) {
  ...
  return Array.prototype.find.call(n, Wc) || e.getBoundingClientRect();
}
var Kc = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function qc(e, t, n) {
  let { node: r, offset: i, atom: a } = e.docView.domFromPos(t, n < 0 ? -1 : 1),
    o = wc || hc;
  if (r.nodeType == 3)
    if (o && (Kc.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      let e = Gc(qs(r, i, i), n);
      if (hc && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let t = Gc(qs(r, i - 1, i - 1), -1);
        if (t.top == e.top) {
          let n = Gc(qs(r, i, i + 1), -1);
          if (n.top != e.top) return Jc(n, n.left < t.left);
        }
      }
      return e;
    } else {
        ...
        n < 0 && !i
          ...
          : n >= 0 && i == r.nodeValue.length
            ...
            : n < 0
              ? e--
              : t++,
        Jc(Gc(qs(r, e, t), a), a < 0)
      );
    }
  if (!e.state.doc.resolve(t - (a || 0)).parent.inlineContent) {
    if (a == null && i && (n < 0 || i == Qs(r))) {
      let e = r.childNodes[i - 1];
      if (e.nodeType == 1) return Yc(e.getBoundingClientRect(), !1);
    }
    if (a == null && i < Qs(r)) {
      let e = r.childNodes[i];
      if (e.nodeType == 1) return Yc(e.getBoundingClientRect(), !0);
    }
    ...
    let t = e
      ? e.nodeType == 3
        ...
        : e.nodeType == 1
          ...
          : null
      : null;
    if (t) return Jc(Gc(t, -1), !0);
  }
  return Jc(Gc(r.nodeType == 3 ? qs(r) : r, -n), n >= 0);
}
function Jc(e, t) {
  ...
  return Xc(e, t, () => {
    ...
    for (let e = t.firstChild; e; e = e.nextSibling) {
      ...
      if (e.nodeType == 1) t = e.getClientRects();
        ...
        t = qs(e, 0, e.nodeValue.length).getClientRects();
      else continue;
      for (let e = 0; e < t.length; e++) {
        let i = t[e];
        if (
...
function $c(e, t, n) {
  ...
  let i = r.parentOffset,
    ...
    s = e.domSelection();
  return s
    ? !Qc.test(r.parent.textContent) || !s.modify
      ? n == `left` || n == `backward`
        ? a
        : o
      : Xc(e, t, () => {
...
function rl(e, t, n) {
  return el == t && tl == n
    ...
    : ((el = t),
      (tl = n),
      (nl = n == `up` || n == `down` ? Zc(e, t, n) : $c(e, t, n)));
}
var il = 0,
  al = 1,
  ol = 2,
  ...
  cl = class {
    ...
    localPosFromDOM(e, t, n) {
      ...
      let r;
      if (e == this.dom && this.contentDOM) r = t > Ws(this.contentDOM);
      else if (
        this.contentDOM &&
    ...
    domFromPos(e, t) {
      ...
      for (
        let e;
        n && !(e = this.children[n - 1]).size && e instanceof ll && e.side >= 0;
        n--
      );
      if (t <= 0) {
        let e,
        ...
        return e && t && r && !e.border && !e.domAtom
          ...
          : { node: this.contentDOM, offset: e ? Ws(e.dom) + 1 : 0 };
      } else {
        let e,
          r = !0;
        for (
        ...
        return e && r && !e.border && !e.domAtom
          ...
          : {
              ...
              offset: e ? Ws(e.dom) : this.contentDOM.childNodes.length,
            };
      }
    }
    parseRange(e, t, n = 0) {
...
`
            ...
            for (let t = e, n; t; t = t.parentNode) {
              if ((n = t.nextSibling)) {
                n.nodeName == `BR` &&
                  (o = s = { node: n.parentNode, offset: Ws(n) + 1 });
                break;
              }
              let e = t.pmViewDesc;
      ...
      if (
        !(r || (u && yc)) &&
        Ys(o.node, o.offset, l.anchorNode, l.anchorOffset) &&
        Ys(s.node, s.offset, l.focusNode, l.focusOffset)
      )
        return;
      let d = !1;
      if ((c.extend || e == t) && !(u && hc)) {
  ...
  ll = class extends cl {
    ...
    matchesWidget(e) {
      return this.dirty == il && e.type.eq(this.widget.type);
    }
    parseRule() {
      return { ignore: !0 };
    }
  ...
  dl = class e extends cl {
    ...
    static create(t, n, r, i) {
      ...
      return (
        (!o || !o.dom) &&
          (o = fr.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
        new e(t, n, o.dom, o.contentDOM || o.dom, o)
      );
    }
    parseRule() {
      return this.dirty & sl || this.mark.type.spec.reparseInView
        ? null
        : {
    ...
    matchesMark(e) {
      return this.dirty != sl && this.mark.eq(e);
    }
    markDirty(e, t) {
      if ((super.markDirty(e, t), this.dirty != il)) {
        let e = this.parent;
        for (; !e.node; ) e = e.parent;
        (e.dirty < this.dirty && (e.dirty = this.dirty), (this.dirty = il));
      }
    }
    slice(t, n, r) {
      let i = e.create(this.parent, this.mark, !0, r),
        a = this.children,
        o = this.size;
      (n < o && (a = Ml(a, n, o, r)), t > 0 && (a = Ml(a, 0, t, r)));
  ...
  fl = class e extends cl {
    ...
    static create(t, n, r, i, a, o) {
      ...
      if (n.isText) {
        ...
        let e = fr.renderSpec(document, n.type.spec.toDOM(n), null, n.attrs);
      ...
      return (
        (u = Cl(u, r, n)),
        l
          ? (c = new gl(t, n, r, i, u, d || null, f, l, a, o + 1))
          : n.isText
            ? new ml(t, n, r, i, u, f, a)
    ...
    updateChildren(e, t) {
      ...
      (kl(
        ...
        (t, i, a) => {
          (t.spec.marks
            ...
            : t.type.side >= 0 &&
              !a &&
              s.syncToMarks(
                i == this.node.childCount ? Y.none : this.node.child(i).marks,
                n,
                e,
                i,
              ),
        ...
        s.destroyRest(),
        (s.changed || this.dirty == ol) &&
          (a && this.protectLocalComposition(e, a),
          _l(this.contentDOM, this.children, e),
          bc && Al(this.dom)));
    }
    localCompositionInfo(e, t) {
      ...
      if (this.node.inlineContent) {
        let e = i.nodeValue,
          a = jl(this.node.content, e, n - t, r - t);
    ...
    protectLocalComposition(e, { node: t, pos: n, text: r }) {
      ...
      let a = new ul(this, i, t, r);
      (e.input.compositionNodes.push(a),
        (this.children = Ml(this.children, n, n + r.length, e, a)));
    }
    update(e, t, n, r) {
      return this.dirty == sl || !e.sameMarkup(this.node)
        ? !1
    ...
    updateOuterDeco(e) {
      if (wl(e, this.outerDeco)) return;
      let t = this.nodeDOM.nodeType != 1,
        n = this.dom;
      ((this.dom = xl(
        this.dom,
        this.nodeDOM,
        bl(this.outerDeco, this.node, t),
        bl(e, this.node, t),
      )),
        this.dom != n &&
...
function pl(e, t, n, r, i) {
  Cl(r, t, e);
  let a = new fl(void 0, e, t, n, r, r, r, i, 0);
  return (a.contentDOM && a.updateChildren(i, 0), a);
}
var ml = class e extends fl {
    ...
    update(e, t, n, r) {
      return this.dirty == sl ||
        (this.dirty != il && !this.inParent()) ||
        !e.sameMarkup(this.node)
        ? !1
        : (this.updateOuterDeco(t),
          (this.dirty != il || e.text != this.node.text) &&
  ...
  hl = class extends cl {
    ...
    matchesHack(e) {
      return this.dirty == il && this.dom.nodeName == e;
    }
    get domAtom() {
      return !0;
    }
...
function _l(e, t, n) {
  ...
  for (let a = 0; a < t.length; a++) {
    ...
    if (o instanceof dl) {
      ...
      (_l(o.contentDOM, o.children, n), (r = t ? t.nextSibling : e.firstChild));
    }
  }
  for (; r; ) ((r = Tl(r)), (i = !0));
...
vl.prototype = Object.create(null);
var yl = [new vl()];
function bl(e, t, n) {
  if (e.length == 0) return yl;
  let r = n ? yl[0] : new vl(),
    i = [r];
  for (let a = 0; a < e.length; a++) {
    let o = e[a].type.attrs;
    if (o) {
      o.nodeName && i.push((r = new vl(o.nodeName)));
      for (let e in o) {
        let a = o[e];
        a != null &&
          (n &&
            i.length == 1 &&
            i.push((r = new vl(t.isInline ? `span` : `div`))),
          e == `class`
...
function Cl(e, t, n) {
  return xl(e, e, yl, bl(t, n, e.nodeType != 1));
}
function wl(e, t) {
  if (e.length != t.length) return !1;
...
var El = class {
  constructor(e, t, n) {
    ((this.lock = t),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = Dl(e.node.content, e)));
  }
  destroyBetween(e, t) {
    if (e != t) {
  ...
  syncToMarks(e, t, n, r) {
    ...
    for (; a < e.length; ) {
      ...
      if (i > -1)
        ...
        let r = dl.create(this.top, e[a], t, n);
  ...
  updateNodeAt(e, t, n, r, i) {
    let a = this.top.children[r];
    return (
      a.dirty == sl && a.dom == a.contentDOM && (a.dirty = ol),
      a.update(e, t, n, i)
      ...
      if (s instanceof fl) {
        ...
        if (!d && (u = this.recreateWrapper(s, e, t, n, r, a)))
          return (
            ...
            u.contentDOM &&
              ((u.dirty = ol), u.updateChildren(r, a + 1), (u.dirty = il)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  recreateWrapper(e, t, n, r, i, a) {
    if (
      ...
      return null;
    let o = fl.create(this.top, t, n, r, i, a);
    if (o.contentDOM) {
  ...
  addNode(e, t, n, r, i) {
    let a = fl.create(this.top, e, t, n, r, i);
  ...
  outer: for (; i > 0; ) {
    ...
    for (;;)
      if (r) {
        ...
        if (e instanceof dl) ((n = e), (r = e.children.length));
        else {
          ((s = e), r--);
          break;
        }
...
function Nl(e, t = null) {
  ...
  if (rc(n)) {
    ...
    if (
      ...
      $.isSelectable(e) &&
      i.parent &&
      !(e.isInline && tc(n.focusNode, n.focusOffset, i.dom))
    ) {
      let e = i.posBefore;
      l = new $(o == e ? s : r.resolve(e));
    }
  } else {
    if (
...
function Pl(e) {
  return e.editable
    ? e.hasFocus()
    : Kl(e) && document.activeElement && document.activeElement.contains(e.dom);
}
function Fl(e, t = !1) {
  let n = e.state.selection;
  if ((Hl(e, n), Pl(e))) {
    if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && _c) {
      let t = e.domSelectionRange(),
        n = e.domObserver.currentSelection;
      if (
        t.anchorNode &&
        n.anchorNode &&
        Ys(t.anchorNode, t.anchorOffset, n.anchorNode, n.anchorOffset)
      ) {
    ...
    if ((e.domObserver.disconnectSelection(), e.cursorWrapper)) Vl(e);
    else {
      ...
      (Il &&
        !(n instanceof Q) &&
        (n.$from.parent.inlineContent || (a = Ll(e, n.from)),
        !n.empty && !n.$from.parent.inlineContent && (o = Ll(e, n.to))),
        ...
        n.visible
          ...
          : (e.dom.classList.add(`ProseMirror-hideselection`),
            `onselectionchange` in document && Bl(e)));
    }
...
function Ll(e, t) {
  ...
  if (yc && i && i.contentEditable == `false`) return Rl(i);
  if (
...
function Rl(e) {
  return (
    ...
    yc && e.draggable && ((e.draggable = !1), (e.wasDraggable = !0)),
    e
  );
}
function zl(e) {
  ...
  t.addEventListener(
    ...
    (e.input.hideSelectionGuard = () => {
      (n.anchorNode != r || n.anchorOffset != i) &&
        (t.removeEventListener(`selectionchange`, e.input.hideSelectionGuard),
        setTimeout(() => {
          (!Pl(e) || e.state.selection.visible) &&
            e.dom.classList.remove(`ProseMirror-hideselection`);
        }, 20));
    }),
  );
...
function Vl(e) {
  ...
  let n = e.cursorWrapper.dom,
    r = n.nodeName == `IMG`;
  (r ? t.collapse(n.parentNode, Ws(n) + 1) : t.collapse(n, 0),
    !r &&
...
function Hl(e, t) {
  if (t instanceof $) {
    ...
    n != e.lastSelectedViewDesc &&
      (Ul(e), n && n.selectNode(), (e.lastSelectedViewDesc = n));
  } else Ul(e);
}
function Ul(e) {
...
function Gl(e) {
  return e.editable && !e.hasFocus() ? !1 : Kl(e);
}
function Kl(e) {
  let t = e.domSelectionRange();
...
function ql(e) {
  ...
  return Ys(t.node, t.offset, n.anchorNode, n.anchorOffset);
}
function Jl(e, t) {
...
function Xl(e, t, n) {
  ...
  if (r instanceof Q) {
    if (n.indexOf(`s`) > -1) {
      ...
      return Yl(e, new Q(r.$anchor, a));
    } else if (!r.empty) return !1;
    else if (e.endOfTextblock(t > 0 ? `forward` : `backward`)) {
      let n = Jl(e.state, t);
      return n && n instanceof $ ? Yl(e, n) : !1;
    } else if (!(xc && n.indexOf(`m`) > -1)) {
      let n = r.$head,
        i = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter,
        a;
      ...
      return i.isAtom || ((a = e.docView.descAt(o)) && !a.contentDOM)
        ? $.isSelectable(i)
          ? Yl(e, new $(t < 0 ? e.state.doc.resolve(n.pos - i.nodeSize) : n))
          : wc
            ? Yl(e, new Q(e.state.doc.resolve(t < 0 ? o : o + i.nodeSize)))
            : !1
        : !1;
    }
  } else if (r instanceof $ && r.node.isInline)
    return Yl(e, new Q(t > 0 ? r.$to : r.$from));
  else {
    let n = Jl(e.state, t);
    return n ? Yl(e, n) : !1;
  }
...
function eu(e) {
  ...
  let i,
    ...
    o = !1;
  for (
    hc && n.nodeType == 1 && r < Zl(n) && Ql(n.childNodes[r], -1) && (o = !0);
    ;
  )
    if (r > 0) {
      ...
      for (; t && Ql(t, -1); )
        ((i = n.parentNode), (a = Ws(t)), (t = t.previousSibling));
      if (t) ((n = t), (r = Zl(n)));
      else {
...
function tu(e) {
  ...
  for (;;)
    if (r < i) {
      ...
      let t = n.nextSibling;
      for (; t && Ql(t, 1); )
        ((a = t.parentNode), (o = Ws(t) + 1), (t = t.nextSibling));
      if (t) ((n = t), (r = 0), (i = Zl(n)));
      else {
        if (((n = n.parentNode), n == e.dom)) break;
        r = i = 0;
...
function ru(e, t) {
  for (; e && t == e.childNodes.length && !nc(e); )
    ((t = Ws(e) + 1), (e = e.parentNode));
...
function iu(e, t) {
  for (; e && !t && !nc(e); ) ((t = Ws(e)), (e = e.parentNode));
  for (; e && t; ) {
    let n = e.childNodes[t - 1];
    if (n.nodeType == 3) return n;
    if (n.nodeType == 1 && n.contentEditable == `false`) break;
...
function au(e, t, n) {
  if (t.nodeType != 3) {
    ...
    (r = ru(t, n))
      ? ((t = r), (n = 0))
      : (e = iu(t, n)) && ((t = e), (n = e.nodeValue.length));
  }
...
function ou(e, t) {
  ...
  if (!(_c || Sc) && n.parent.inlineContent) {
...
function su(e, t, n) {
  ...
  if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? `up` : `down`)) {
    let n = Jl(e.state, t);
    if (n && n instanceof $) return Yl(e, n);
  }
  if (!i.parent.inlineContent) {
    let n = t < 0 ? i : a,
      o = r instanceof Di ? Z.near(n, t) : Z.findFrom(n, t);
    return o ? Yl(e, o) : !1;
  }
  return !1;
}
...
function uu(e) {
  if (!yc || e.state.selection.$head.parentOffset > 0) return !1;
  ...
  if (
    ...
    let n = t.firstChild;
    (lu(e, n, `true`), setTimeout(() => lu(e, n, `false`), 20));
  }
  return !1;
}
function du(e) {
...
function fu(e, t) {
  let n = t.keyCode,
    r = du(t);
  if (n == 8 || (xc && n == 72 && r == `c`)) return cu(e, -1) || $l(e, -1);
  if ((n == 46 && !t.shiftKey) || (xc && n == 68 && r == `c`))
    return cu(e, 1) || $l(e, 1);
  if (n == 13 || n == 27) return !0;
  if (n == 37 || (xc && n == 66 && r == `c`)) {
    let t = n == 37 ? (ou(e, e.state.selection.from) == `ltr` ? -1 : 1) : -1;
    return Xl(e, t, r) || $l(e, t);
  } else if (n == 39 || (xc && n == 70 && r == `c`)) {
    let t = n == 39 ? (ou(e, e.state.selection.from) == `ltr` ? 1 : -1) : 1;
    return Xl(e, t, r) || $l(e, t);
  } else if (n == 38 || (xc && n == 80 && r == `c`))
    return su(e, -1, r) || $l(e, -1);
  else if (n == 40 || (xc && n == 78 && r == `c`))
    return uu(e) || su(e, 1, r) || $l(e, 1);
  else if (r == (xc ? `m` : `c`) && (n == 66 || n == 73 || n == 89 || n == 90))
    return !0;
  return !1;
}
function pu(e, t) {
  ...
  let o = e.someProp(`clipboardSerializer`) || fr.fromSchema(e.state.schema),
    s = wu(),
...
`,
  ...
  if (
    ...
    s = ku(xu(s, +u[1], +u[2]), u[4]);
  else if (((s = X.maxOpen(gu(s.content, i), !0)), s.openStart || s.openEnd)) {
    let e = 0,
      t = 0;
    for (
    ...
    if (
      (e.forEach((e) => {
        ...
        let t = r.findWrapping(e.type),
          n;
        if (!t) return (a = null);
        if ((n = a.length && i.length && vu(t, i, e, a[a.length - 1], 0)))
          a[a.length - 1] = n;
        else {
          a.length && (a[a.length - 1] = yu(a[a.length - 1], i.length));
          let n = _u(e, t);
...
function vu(e, t, n, r, i) {
  if (i < e.length && i < t.length && e[i] == t[i]) {
    ...
    if (
      ...
      return r.copy(r.content.append(J.from(_u(n, e, i + 1))));
  }
}
function yu(e, t) {
  if (t == 0) return e;
  let n = e.content.replaceChild(e.childCount - 1, yu(e.lastChild, t - 1)),
    r = e.contentMatchAt(e.childCount).fillBefore(J.empty, !0);
      ...
      (s =
        t < 0
          ? o
              ...
              .fillBefore(s, a <= i)
              .append(s)
          : s.append(o.contentMatchAt(o.childCount).fillBefore(J.empty, !0))),
...
function xu(e, t, n) {
  return (
    t < e.openStart &&
      (e = new X(
        bu(e.content, -1, t, e.openStart, 0, e.openEnd),
        t,
        e.openEnd,
      )),
    n < e.openEnd &&
      (e = new X(bu(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)),
    e
  );
}
var Su = {
  ...
  Cu = null;
function wu() {
  return (Cu ||= document.implementation.createHTMLDocument(`title`));
}
var Tu = null;
function Eu(e) {
...
function Du(e) {
  ...
  let n = wu().createElement(`div`),
    r = /<([a-z][^>\s]+)/i.exec(e),
    i;
  if (
    ((i = r && Su[r[1].toLowerCase()]) &&
      (e =
        i.map((e) => `<` + e + `>`).join(``) +
        e +
        i
...
function Ou(e) {
  let t = e.querySelectorAll(
    _c ? `span:not([class]):not([style])` : `span.Apple-converted-space`,
  );
  ...
  for (let t in Au) {
    ...
    e.dom.addEventListener(
      ...
      (e.input.eventHandlers[t] = (t) => {
        zu(e, t) && !Ru(e, t) && (e.editable || !(t.type in ju)) && n(e, t);
      }),
      Mu[t] ? { passive: !0 } : void 0,
    );
  }
  (yc && e.dom.addEventListener(`input`, () => null), Lu(e));
}
function Fu(e, t) {
  ...
  e.someProp(`handleDOMEvents`, (t) => {
    for (let n in t)
      e.input.eventHandlers[n] ||
        e.dom.addEventListener(n, (e.input.eventHandlers[n] = (t) => Ru(e, t)));
  });
}
function Ru(e, t) {
...
((ju.keydown = (e, t) => {
  ...
  if (
    ...
    if (
      ...
      bc && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
    ) {
      let t = Date.now();
      ((e.input.lastIOSEnter = t),
        (e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          e.input.lastIOSEnter == t &&
            (e.someProp(`handleKeyDown`, (t) => t(e, ic(13, `Enter`))),
            (e.input.lastIOSEnter = 0));
        }, 200)));
    } else
      e.someProp(`handleKeyDown`, (t) => t(e, n)) || fu(e, n)
        ? n.preventDefault()
        : Fu(e, `key`);
}),
  (ju.keyup = (e, t) => {
...
function Gu(e, t) {
  ...
  let n = e.state.doc.resolve(t),
    r = n.nodeAfter;
  return r && r.isAtom && $.isSelectable(r)
    ? (Wu(e, new $(n), `pointer`), !0)
    : !1;
}
function Ku(e, t) {
  if (t == -1) return !1;
  ...
  return i == null ? !1 : (Wu(e, $.create(e.state.doc, i), `pointer`), !0);
}
function qu(e, t, n, r, i) {
  return (
    Uu(e, `handleClickOn`, t, n, r) ||
...
function Ju(e, t, n, r) {
  return (
    Uu(e, `handleDoubleClickOn`, t, n, r) ||
    e.someProp(`handleDoubleClick`, (n) => n(e, t, r))
  );
}
function Yu(e, t, n, r) {
  return (
    Uu(e, `handleTripleClickOn`, t, n, r) ||
...
function Xu(e, t, n) {
  ...
  if (t == -1)
    return r.inlineContent
      ? (Wu(e, Q.create(r, 0, r.content.size), `pointer`), !0)
      : !1;
  let i = r.resolve(t);
  for (let t = i.depth + 1; t > 0; t--) {
    let n = t > i.depth ? i.nodeAfter : i.node(t),
      a = i.before(t);
    if (n.inlineContent)
      Wu(e, Q.create(r, a + 1, a + 1 + n.content.size), `pointer`);
    else if ($.isSelectable(n)) Wu(e, $.create(r, a), `pointer`);
    else continue;
    return !0;
  }
}
...
Au.mousedown = (e, t) => {
  ...
  let o = e.posAtCoords(Vu(n));
  o &&
    (a == `singleClick`
      ? (e.input.mouseDown && e.input.mouseDown.done(),
        (e.input.mouseDown = new $u(e, o, n, !!r)))
      : (a == `doubleClick` ? Ju : Yu)(e, o.pos, o.inside, n)
        ? n.preventDefault()
        : Fu(e, `pointer`));
};
var $u = class {
  constructor(e, t, n, r) {
    ...
    (this.view.root.removeEventListener(`mouseup`, this.up),
      ...
      this.mightDrag &&
        ...
        this.view.domObserver.start()),
      this.delayedSelectionSync && setTimeout(() => Fl(this.view)),
      (this.view.input.mouseDown = null));
  }
  up(e) {
    if ((this.done(), !this.view.dom.contains(e.target))) return;
    let t = this.pos;
    (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Vu(e))),
      this.updateAllowDefault(e),
      this.allowDefault || !t
        ? Fu(this.view, `pointer`)
        : qu(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
              (this.flushed ||
                (yc && this.mightDrag && !this.mightDrag.node.isAtom) ||
                (_c &&
            ...
            ? (Wu(
                this.view,
                Z.near(this.view.state.doc.resolve(t.pos)),
                `pointer`,
              ),
              e.preventDefault())
            : Fu(this.view, `pointer`));
...
((Au.touchstart = (e) => {
  ((e.input.lastTouch = Date.now()), Zu(e), Fu(e, `pointer`));
}),
  (Au.touchmove = (e) => {
    ((e.input.lastTouch = Date.now()), Fu(e, `pointer`));
  }),
  (Au.contextmenu = (e) => Zu(e)));
function ed(e, t) {
  return e.composing
    ? !0
    : yc && Math.abs(t.timeStamp - e.input.compositionEndedAt) < 500
      ? ((e.input.compositionEndedAt = -2e8), !0)
      : !1;
}
var td = Cc ? 5e3 : -1;
ju.compositionstart = ju.compositionupdate = (e) => {
  if (!e.composing) {
    e.domObserver.flush();
    let { state: t } = e,
      n = t.selection.$to;
...
function rd(e, t) {
  (clearTimeout(e.input.composingTimeout),
    t > -1 && (e.input.composingTimeout = setTimeout(() => sd(e), t)));
}
function id(e) {
  for (
    e.composing &&
    ((e.input.composing = !1), (e.input.compositionEndedAt = od()));
...
function ad(e) {
  ...
  let n = $s(t.focusNode, t.focusOffset),
    r = ec(t.focusNode, t.focusOffset);
  if (n && r && n != r) {
    let t = r.pmViewDesc,
...
function sd(e, t = !1) {
  if (!(Cc && e.domObserver.flushingSoon >= 0)) {
    if (
      (e.domObserver.forceFlush(), id(e), t || (e.docView && e.docView.dirty))
    ) {
      let n = Nl(e),
        r = e.state.selection;
      return (
...
var ld = (pc && mc < 15) || (bc && Tc < 604);
Au.copy = ju.cut = (e, t) => {
  let n = t,
    r = e.state.selection,
    i = n.type == `cut`;
  if (r.empty) return;
  let a = ld ? null : n.clipboardData,
    { dom: o, text: s } = pu(e, r.content());
  (a
    ? (n.preventDefault(),
      a.clearData(),
...
function dd(e, t) {
  ...
  setTimeout(() => {
    (e.focus(),
      ...
      n ? fd(e, r.value, null, i, t) : fd(e, r.textContent, r.innerHTML, i, t));
  }, 50);
}
function fd(e, t, n, r, i) {
  let a = mu(e, t, n, r, e.state.selection.$from);
...
ju.paste = (e, t) => {
  let n = t;
  if (e.composing && !Cc) return;
  let r = ld ? null : n.clipboardData,
    i = e.input.shiftKey && e.input.lastKeyCode != 45;
  r && fd(e, pd(r), r.getData(`text/html`), i, n)
    ? n.preventDefault()
    : dd(e, n);
};
var md = class {
...
((Au.dragstart = (e, t) => {
  ...
  let i = e.state.selection,
    a = i.empty ? null : e.posAtCoords(Vu(n)),
    o;
  if (!(a && a.pos >= i.from && a.pos <= (i instanceof $ ? i.to - 1 : i.to))) {
    if (r && r.mightDrag) o = $.create(e.state.doc, r.mightDrag.pos);
    else if (n.target && n.target.nodeType == 1) {
      let t = e.docView.nearestDesc(n.target, !0);
      t &&
        t.node.type.spec.draggable &&
        t != e.docView &&
        (o = $.create(e.state.doc, t.posBefore));
    }
  }
  let { dom: s, text: c, slice: l } = pu(e, (o || e.state.selection).content());
  ((!n.dataTransfer.files.length || !_c || vc > 120) &&
    n.dataTransfer.clearData(),
    n.dataTransfer.setData(ld ? `Text` : `text/html`, s.innerHTML),
    (n.dataTransfer.effectAllowed = `copyMove`),
    ld || n.dataTransfer.setData(`text/plain`, c),
    (e.dragging = new md(l, gd(e, n), o)));
}),
  (Au.dragend = (e) => {
    let t = e.dragging;
    window.setTimeout(() => {
  ...
  (ju.dragover = ju.dragenter = (e, t) => t.preventDefault()),
  (ju.drop = (e, t) => {
    try {
      _d(e, t, e.dragging);
    } finally {
...
function _d(e, t, n) {
  ...
  a
    ...
    : (a = mu(
        e,
        pd(t.dataTransfer),
        ld ? null : t.dataTransfer.getData(`text/html`),
        !1,
        i,
      ));
  let o = !!(n && gd(e, t));
...
((Au.focus = (e) => {
  ...
  (Au.beforeinput = (e, t) => {
    if (_c && Cc && t.inputType == `deleteContentBackward`) {
      ...
      setTimeout(() => {
        if (
          ...
          (e.dom.blur(),
          e.focus(),
          e.someProp(`handleKeyDown`, (t) => t(e, ic(8, `Backspace`))))
        )
          return;
...
var yd = class e {
    ...
    map(e, t, n, r) {
      ...
      return a ? null : new Sd(i - n, i - n, this);
    }
    valid() {
      return !0;
    }
      ...
      return (
        ...
        (t instanceof e &&
          ((this.spec.key && this.spec.key == t.spec.key) ||
            (this.toDOM == t.toDOM && vd(this.spec, t.spec))))
      );
    }
    destroy(e) {
  ...
  bd = class e {
    ...
    eq(t) {
      return (
        this == t ||
        (t instanceof e && vd(this.attrs, t.attrs) && vd(this.spec, t.spec))
      );
    }
    static is(t) {
  ...
  Sd = class e {
    ...
    static widget(t, n, r) {
      return new e(t, t, new yd(n, r));
    }
    static inline(t, n, r, i) {
      return new e(t, n, new bd(r, i));
    }
    static node(t, n, r, i) {
      return new e(t, n, new xd(r, i));
    }
    get spec() {
    ...
    get widget() {
      return this.type instanceof yd;
    }
  },
  Cd = [],
  wd = {},
  Td = class e {
    constructor(e, t) {
      ((this.local = e.length ? e : Cd), (this.children = t.length ? t : Cd));
    }
    static create(e, t) {
      return t.length ? Nd(t, e, 0, wd) : Ed;
    }
    find(e, t, n) {
      let r = [];
    ...
    map(e, t, n) {
      return this == Ed || e.maps.length == 0
        ? this
        : this.mapInner(e, t, 0, 0, n || wd);
    }
    mapInner(t, n, r, i, a) {
      let o;
    ...
    addInner(t, n, r) {
      ...
      t.forEach((e, t) => {
        ...
        if ((s = jd(n, e, o))) {
          ...
          (i[a] == t
            ...
            : i.splice(a, 0, t, t + e.nodeSize, Nd(s, e, o + 1, wd)),
            (a += 3));
        }
      });
      let o = kd(a ? Md(n) : n, -r);
      ...
      return new e(
        o.length ? this.local.concat(o).sort(Pd) : this.local,
        i || this.children,
      );
    }
    remove(e) {
      return e.length == 0 || this == Ed ? this : this.removeInner(e, 0);
    }
    removeInner(t, n) {
      let r = this.children,
        i = this.local;
    ...
    forChild(t, n) {
      ...
      for (let e = 0; e < this.local.length; e++) {
        let t = this.local[e];
        if (t.from < o && t.to > a && t.type instanceof bd) {
      ...
      if (i) {
        let t = new e(i.sort(Pd), Cd);
        return r ? new Dd([t, r]) : t;
      }
      return r || Ed;
    }
    eq(t) {
    ...
    locals(e) {
      return Fd(this.localsInner(e));
    }
    localsInner(e) {
      if (this == Ed) return Cd;
...
((Td.empty = new Td([], [])), (Td.removeOverlap = Fd));
var Ed = Td.empty,
  Dd = class e {
    constructor(e) {
      this.members = e;
    ...
    map(t, n) {
      let r = this.members.map((e) => e.map(t, n, wd));
      return e.from(r);
    }
    forChild(t, n) {
      if (n.isLeaf) return Td.empty;
      let r = [];
      for (let i = 0; i < this.members.length; i++) {
        let a = this.members[i].forChild(t, n);
        a != Ed && (a instanceof e ? (r = r.concat(a.members)) : r.push(a));
      }
      return e.from(r);
    }
    eq(t) {
    ...
    static from(t) {
      switch (t.length) {
        ...
        default:
          return new e(
            t.every((e) => e instanceof Td)
              ? t
              : t.reduce(
                  (e, t) => e.concat(t instanceof Td ? t : t.members),
                  [],
                ),
          );
      }
...
function Od(e, t, n, r, i, a, o) {
  ...
  if (c) {
    let c = Nd(Ad(s, e, t, n, i, a, o), r, 0, o);
    t = c.local;
...
function kd(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    let i = e[r];
    n.push(new Sd(i.from + t, i.to + t, i.type));
  }
  return n;
}
...
function Nd(e, t, n, r) {
  ...
  t.forEach((t, o) => {
    ...
    if (s) {
      a = !0;
      let e = Nd(s, t, n + o + 1, r);
      e != Ed && i.push(o, o + t.nodeSize, e);
    }
  });
  let o = kd(a ? Md(e) : e, -n).sort(Pd);
  for (let e = 0; e < o.length; e++)
    o[e].type.valid(t, o[e]) ||
      (r.onRemove && r.onRemove(o[e].spec), o.splice(e--, 1));
  return o.length || i.length ? new Td(o, i) : Ed;
}
function Pd(e, t) {
      ...
      for (let i = n + 1; i < t.length; i++) {
        ...
        if (a.from == r.from) {
          a.to != r.to &&
            ...
            Id(t, i + 1, a.copy(r.to, a.to)));
          continue;
        } else {
          a.from < r.to &&
            (t == e && (t = e.slice()),
            (t[n] = r.copy(r.from, a.from)),
            Id(t, i, r.copy(a.from, r.to)));
          break;
        }
      }
  }
...
var Rd = {
  ...
  Vd = class {
    ...
    start() {
      (this.observer &&
        (this.observer.takeRecords(), this.observer.observe(this.view.dom, Rd)),
        this.onCharData &&
    ...
    onSelectionChange() {
      if (Gl(this.view)) {
        if (this.suppressingSelectionUpdates) return Fl(this.view);
        if (pc && mc <= 11 && !this.view.state.selection.empty) {
          let e = this.view.domSelectionRange();
          if (
            e.focusNode &&
            Ys(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
          )
    ...
    ignoreSelectionChange(e) {
      ...
      let t = new Set(),
        n;
      for (let n = e.focusNode; n; n = Gs(n)) t.add(n);
      for (let r = e.anchorNode; r; r = Gs(r))
        if (t.has(r)) {
          n = r;
          break;
        }
    ...
    flush() {
      ...
      if (
        ...
        if (t.length == 2) {
          ...
          for (let r of t) {
            let t = r.parentNode;
            t && t.nodeName == `LI` && (!n || qd(e, n) != t) && r.remove();
          }
        }
      }
      let c = null;
      ...
      c.eq(Z.near(e.state.doc.resolve(0), 1))
        ? ((e.input.lastFocus = 0),
          ...
          e.scrollToSelection())
        : (i > -1 || r) &&
          (i > -1 && (e.docView.markDirty(i, a), Wd(e)),
          e.input.badSafariComposition &&
            ((e.input.badSafariComposition = !1), Jd(e, s)),
          this.handleDOMChange(i, a, o, s),
          e.docView && e.docView.dirty
            ? e.updateState(e.state)
            : this.currentSelection.eq(n) || Fl(e),
          this.currentSelection.set(n));
    }
    registerMutation(e, t) {
      ...
      if (e.type == `childList`) {
        ...
        let r = e.previousSibling,
          i = e.nextSibling;
        if (pc && mc <= 11 && e.addedNodes.length)
        ...
        let a = r && r.parentNode == e.target ? Ws(r) + 1 : 0,
          o = n.localPosFromDOM(e.target, a, -1),
          s =
            i && i.parentNode == e.target ? Ws(i) : e.target.childNodes.length;
...
function Wd(e) {
  if (
    ...
    if (((e.requiresGeckoHackNode = hc), Ud)) return;
    (console.warn(
...
function Gd(e, t) {
  ...
  return (
    Ys(o.node, o.offset, i, a) && ([n, r, i, a] = [i, a, n, r]),
...
function Yd(e, t, n) {
  ...
  if (
    (u &&
      ...
      rc(c) || l.push({ node: c.focusNode, offset: c.focusOffset })),
    _c && e.input.lastKeyCode === 8)
  )
    for (let e = a; e > i; e--) {
  ...
  let d = e.state.doc,
    f = e.someProp(`domParser`) || Qn.fromSchema(e.state.schema),
    p = d.resolve(o),
    m = null,
    h = f.parse(r, {
      topNode: p.parent,
...
function Qd(e, t, n, r, i) {
  ...
  let m = rf(d.content, l.doc.content, l.from, f, p);
  if (
    (m && e.input.domChangeCount++,
    ((bc && e.input.lastIOSEnter > Date.now() - 225) || Cc) &&
      i.some((e) => e.nodeType == 1 && !Zd.test(e.nodeName)) &&
      (!m || m.endA >= m.endB) &&
      e.someProp(`handleKeyDown`, (t) => t(e, ic(13, `Enter`))))
  ) {
    e.input.lastIOSEnter = 0;
  ...
  if (
    ...
    tf(u, m.start, m.endA, h, g) &&
    e.someProp(`handleKeyDown`, (t) => t(e, ic(8, `Backspace`)))
  ) {
    Cc && _c && e.domObserver.suppressSelectionUpdates();
    return;
  }
  (_c && m.endB == m.start && (e.input.lastChromeDelete = Date.now()),
    Cc &&
      !v &&
      h.start() != g.start() &&
      g.parentOffset == 0 &&
  ...
  if (v)
    if (h.pos == g.pos) {
      pc &&
        mc <= 11 &&
        h.parentOffset == 0 &&
        (e.domObserver.suppressSelectionUpdates(), setTimeout(() => Fl(e), 20));
...
function $d(e, t, n) {
  return Math.max(n.anchor, n.head) > t.content.size
    ? null
    : Wl(e, t.resolve(n.anchor), t.resolve(n.head));
}
function ef(e, t) {
  ...
  if (J.from(l).eq(e)) return { mark: s, type: o };
}
function tf(e, t, n, r, i) {
  if (n - t <= i.pos - r.pos || nf(r, !0, !1) < i.pos) return !1;
  let a = e.resolve(t);
  if (!r.parent.isTextblock) {
    let e = a.nodeAfter;
  ...
  if (a.parentOffset < a.parent.content.size || !a.parent.isTextblock)
    return !1;
  let o = e.resolve(nf(a, !0, !0));
  return !o.parent.isTextblock || o.pos > n || nf(o, !0, !1) < n
    ? !1
...
function rf(e, t, n, r, i) {
  ...
  if (o < a && e.size < t.size) {
    let e = r <= a && r >= o ? a - r : 0;
    ((a -= e),
      a && a < t.size && af(t.textBetween(a - 1, a + 1)) && (a += e ? 1 : -1),
      (s = a + (s - o)),
      (o = a));
  } else if (s < a) {
    let t = r <= a && r >= s ? a - r : 0;
    ((a -= t),
      a && a < e.size && af(e.textBetween(a - 1, a + 1)) && (a += t ? 1 : -1),
      (o = a + (o - s)),
      (s = a));
  }
...
var of = class {
  constructor(e, t) {
    ((this._root = null),
      ...
      (this.editable = lf(this)),
      cf(this),
      (this.nodeViews = df(this)),
      (this.docView = pl(this.state.doc, sf(this), Ld(this), this.dom, this)),
      (this.domObserver = new Vd(this, (e, t, n, r) => Qd(this, e, t, n, r))),
  ...
  update(e) {
    e.handleDOMEvents != this._props.handleDOMEvents && Lu(this);
    let t = this._props;
    ((this._props = e),
      e.plugins && (e.plugins.forEach(pf), (this.directPlugins = e.plugins)),
  ...
  updateStateInner(e, t) {
    let n = this.state,
      r = !1,
      i = !1;
    (e.storedMarks && this.composing && (id(this), (i = !0)), (this.state = e));
    ...
    ((a || t.handleDOMEvents != this._props.handleDOMEvents) && Lu(this),
      (this.editable = lf(this)),
      cf(this));
    let o = Ld(this),
      s = sf(this),
    ...
    let u =
      c == `preserve` && i && this.dom.style.overflowAnchor == null && Ac(this);
    if (i) {
      ...
      !(
        ...
        ? Fl(this, t)
        : (Hl(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start());
    }
  ...
  scrollToSelection() {
    ...
    if (
      ...
      } else kc(this, this.coordsAtPos(this.state.selection.head, 1), e);
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new md(
      e.slice,
      e.move,
      r < 0 ? void 0 : $.create(this.state.doc, r),
    );
  }
  someProp(e, t) {
  ...
  endOfTextblock(e, t) {
    return rl(this, t || this.state, e);
  }
  pasteHTML(e, t) {
    return fd(this, ``, e, !1, t || new ClipboardEvent(`paste`));
  }
  pasteText(e, t) {
    return fd(this, e, null, !0, t || new ClipboardEvent(`paste`));
  }
  ...
  destroy() {
    this.docView &&
      ...
      this.destroyPluginViews(),
      this.mounted
        ? (this.docView.update(this.state.doc, [], Ld(this), this),
  ...
  domSelectionRange() {
    ...
    return e
      ? (yc &&
          ...
          ac(this.dom.ownerDocument) == this.dom &&
          Kd(this, e)) ||
          e
...
of.prototype.dispatch = function (e) {
...
function sf(e) {
  ...
  return (
    ...
    (t.translate ||= `no`),
    [Sd.node(0, e.state.doc.content.size, t)]
  );
}
function cf(e) {
  if (e.markCursor) {
    ...
    ((t.className = `ProseMirror-separator`),
      ...
      (e.cursorWrapper = {
        dom: t,
        deco: Sd.widget(e.state.selection.from, t, {
          raw: !0,
          marks: e.markCursor,
        }),
      }));
...
var mf = class e extends Z {
  ...
  static valid(e) {
    let t = e.parent;
    if (t.inlineContent || !_f(e) || !vf(e)) return !1;
  ...
  static findGapCursorFrom(t, n, r = !1) {
    search: for (;;) {
      ...
      for (;;) {
        ...
        if (!o) {
          if (a.isAtom && !a.isText && !$.isSelectable(a)) {
...
((mf.prototype.visible = !1),
  (mf.findFrom = mf.findGapCursorFrom),
  Z.jsonID(`gapcursor`, mf));
var hf = class e {
  constructor(e) {
    this.pos = e;
  }
  ...
  resolve(e) {
    ...
    return mf.valid(t) ? new mf(t) : Z.near(t);
  }
};
function gf(e) {
...
function _f(e) {
  for (let t = e.depth; t >= 0; t--) {
    ...
    for (let e = r.child(n - 1); ; e = e.lastChild) {
      if ((e.childCount == 0 && !e.inlineContent) || gf(e.type)) return !0;
  ...
  return new Vi({
    props: {
      ...
      createSelectionBetween(e, t, n) {
        return t.pos == n.pos && mf.valid(n) ? new mf(n) : null;
      },
      handleClick: Sf,
      handleKeyDown: bf,
      handleDOMEvents: { beforeinput: Cf },
    },
  });
}
var bf = ho({
  ArrowLeft: xf(`horiz`, -1),
  ArrowRight: xf(`horiz`, 1),
  ArrowUp: xf(`vert`, -1),
  ArrowDown: xf(`vert`, 1),
});
function xf(e, t) {
  ...
  return function (e, r, i) {
    ...
    let c = mf.findGapCursorFrom(o, t, s);
    return c ? (r && r(e.tr.setSelection(new mf(c))), !0) : !1;
  };
}
function Sf(e, t, n) {
  if (!e || !e.editable) return !1;
  let r = e.state.doc.resolve(t);
  if (!mf.valid(r)) return !1;
  let i = e.posAtCoords({ left: n.clientX, top: n.clientY });
  return i && i.inside > -1 && $.isSelectable(e.state.doc.nodeAt(i.inside))
    ? !1
    : (e.dispatch(e.state.tr.setSelection(new mf(r))), !0);
}
function Cf(e, t) {
  if (
    t.inputType != `insertCompositionText` ||
    !(e.state.selection instanceof mf)
  )
    return !1;
  ...
  for (let e = r.length - 1; e >= 0; e--)
    i = J.from(r[e].createAndFill(null, i));
  let a = e.state.tr.replace(n.pos, n.pos, new X(i, 0, 0));
  return (a.setSelection(Q.near(a.doc.resolve(n.pos + 1))), e.dispatch(a), !1);
}
function wf(e) {
  if (!(e.selection instanceof mf)) return null;
  let t = document.createElement(`div`);
  return (
    (t.className = `ProseMirror-gapcursor`),
    Td.create(e.doc, [Sd.widget(e.selection.head, t, { key: `gapcursor` })])
  );
}
var Tf = 200,
  Ef = function () {};
((Ef.prototype.append = function (e) {
  return e.length
    ? ((e = Ef.from(e)),
      (!this.length && e) ||
        (e.length < Tf && this.leafAppend(e)) ||
        (this.length < Tf && e.leafPrepend(this)) ||
        this.appendInner(e))
    : this;
}),
  (Ef.prototype.prepend = function (e) {
    return e.length ? Ef.from(e).append(this) : this;
  }),
  (Ef.prototype.appendInner = function (e) {
    return new Of(this, e);
  }),
  (Ef.prototype.slice = function (e, t) {
    return (
      e === void 0 && (e = 0),
  ...
  (Ef.prototype.forEach = function (e, t, n) {
    (t === void 0 && (t = 0),
  ...
  (Ef.prototype.map = function (e, t, n) {
  ...
  (Ef.from = function (e) {
    return e instanceof Ef ? e : e && e.length ? new Df(e) : Ef.empty;
  }));
var Df = (function (e) {
  function t(t) {
...
var Of = (function (e) {
  ...
  Af = class e {
          ...
          (t, n) => {
            ...
            if (i) {
              ...
              (e &&
                ...
                l.push(new Mf(n, void 0, void 0, l.length + u.length))),
                a--,
                n && i.appendMap(n, a));
    ...
    addTransform(t, n, r, i) {
      ...
      let l = o - r.depth;
      return (l > Pf && ((s = jf(s, l)), (o -= l)), new e(s.append(a), o));
    }
    remapping(e, t) {
      let n = new Ar();
      return (
    ...
    addMaps(t) {
      return this.eventCount == 0
        ? this
        : new e(this.items.append(t.map((e) => new Mf(e))), this.eventCount);
    }
    rebased(t, n) {
      ...
      this.items.forEach((e) => {
        ...
        if (e.step) {
          ...
          (l && s++, r.push(new Mf(i, o, l)));
        } else r.push(new Mf(i));
      }, i);
      let l = [];
      for (let e = n; e < o; e++) l.push(new Mf(a.maps[e]));
    ...
    compress(t = this.items.length) {
      ...
      return (
        ...
        new e(Ef.from(i.reverse()), a)
      );
    }
  };
Af.empty = new Af(Ef.empty, 0);
function jf(e, t) {
  let n;
  return (
    e.forEach((e, r) => {
...
function Ff(e, t, n, r) {
  ...
  n.getMeta(Wf) && (e = new Nf(e.done, e.undone, null, 0, -1));
  let o = n.getMeta(`appendedTransaction`);
  if (n.steps.length == 0) return e;
  if (o && o.getMeta(Uf))
    return o.getMeta(Uf).redo
      ? new Nf(
          e.done.addTransform(n, void 0, r, Hf(t)),
          e.undone,
          Lf(n.mapping.maps),
          e.prevTime,
          e.prevComposition,
      ...
      : new Nf(
          e.done,
          e.undone.addTransform(n, void 0, r, Hf(t)),
          null,
          e.prevTime,
          e.prevComposition,
        );
      ...
      a =
        ...
        (!o &&
          ...
          (e.prevTime < (n.time || 0) - r.newGroupDelay ||
            !If(n, e.prevRanges))),
      s = o ? Rf(e.prevRanges, n.mapping) : Lf(n.mapping.maps);
    return new Nf(
      e.done.addTransform(n, a ? t.selection.getBookmark() : void 0, r, Hf(t)),
      Af.empty,
      s,
      n.time,
      i ?? e.prevComposition,
...
function zf(e, t, n) {
  ...
  let o = a.selection.resolve(a.transform.doc),
    ...
    c = new Nf(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
  return a.transform.setSelection(o).setMeta(Uf, { redo: n, historyState: c });
}
var Bf = !1,
  Vf = null;
function Hf(e) {
...
var Uf = new Wi(`history`),
  Wf = new Wi(`closeHistory`);
function Gf(e = {}) {
  return (
    ...
    new Vi({
      ...
      state: {
        init() {
          return new Nf(Af.empty, Af.empty, null, 0, -1);
        },
        apply(t, n, r) {
          return Ff(n, r, t, e);
        },
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, t) {
            let n = t.inputType,
              r = n == `historyUndo` ? qf : n == `historyRedo` ? Jf : null;
            return !r || !e.editable
              ? !1
...
function Qf(e, t) {
  let n = `custom-keymap-subscription-${Xf}`;
  ((Xf += 1),
    e.dispatch(
      e.state.tr.setMeta(Yf, {
        handlers: t,
        subscriptionId: n,
        type: `addHandlers`,
      }),
  ...
  return () => {
    r &&
      ((r = !1),
      Yf.getState(e.state)?.handlerSubscriptions[n] &&
        e.dispatch(
          e.state.tr.setMeta(Yf, { subscriptionId: n, type: `removeHandlers` }),
        ));
  };
}
function $f(e = {}) {
  return new Vi({
    ...
    state: {
      ...
      apply(e, t) {
        ...
        if (n?.type === `addHandlers`) {
          ...
          return { handlerSubscriptions: e, handlers: Zf(e) };
        }
        if (n?.type === `removeHandlers`) {
          ...
          return { handlerSubscriptions: r, handlers: Zf(r) };
        }
        return t;
      },
    },
    props: {
      handleKeyDown(e, t) {
        let n = Yf.getState(e.state).handlers[t.key];
        return n ? n(t) : !1;
      },
    },
  });
...
`),
    ...
    if (e.isText && e.text !== void 0) t += e.text;
      ...
      t += `[${e.attrs.label}](${u(e.attrs.path)})`;
      ...
      t += `[${n}${i}](${u(e.attrs.path)})`;
    } else
      e.type.name === `richLink` &&
        (t += `[${e.attrs.displayText}](${u(e.attrs.href)})`);
  }
  return (
    e.descendants((e) => r(e)),
    n &&
...
`);
  if (
    ...
    (e.dispatch(e.state.tr.replaceSelection(i)), _s(e.state, e.dispatch, e));
  }
}
var ip = new Wi(`placeholderPlugin`);
function ap(e) {
  return new Vi({
    key: ip,
    state: {
      ...
      apply(e, t) {
        return e.getMeta(ip) ? { placeholder: e.getMeta(ip).placeholder } : t;
      },
    },
    props: {
      decorations(e) {
        ...
        if (
          ...
          let n = [],
            { placeholder: r } = ip.getState(e);
          return (
            t.descendants((e, t) => {
              n.push(
                Sd.node(t, t + e.nodeSize, {
                  class: `placeholder`,
                  "data-placeholder": r,
                }),
              );
...
var op = t((e) => {
    ...
    var re = t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
      ...
      z = ie.d;
    ie.d = { f: z.f, r: z.r, D: ct, C: lt, L: ut, m: dt, X: pt, S: ft, M: mt };
    var ae = [],
      oe = null,
      se = /(<\/|<)(s)(cript)/gi;
    function ce(e, t, n, r) {
          ...
          if (a != null && typeof a != `boolean` && a !== ``) {
            if (i.indexOf(`--`) === 0) {
              ...
              ((o = pe.get(i)),
                o === void 0 &&
                  ((o = F(
                    i.replace(te, `-$1`).toLowerCase().replace(ne, `-ms-`),
                  )),
                  pe.set(i, o)),
                (a =
                  typeof a == `number`
    ...
    function Ie(e, t, n, i, a, o, s, c, l) {
      switch (t) {
        ...
        case `textarea`:
          ...
          if ((j === null && M !== null && (j = M), e.push(`>`), N != null)) {
...
`),
        ...
        case `button`:
          ...
          var ze = xe(e, i, a, pe, ye, Ne, Pe, fe);
          if (
            (e.push(`>`),
            ze?.forEach(ve, e),
            Se(e, de, V),
        ...
        case `form`:
          ...
          if (
            (Ue != null && H(e, `action`, Ue),
            We != null && H(e, `encType`, We),
            Ge != null && H(e, `method`, Ge),
            Ke != null && H(e, `target`, Ke),
            e.push(`>`),
            Xe !== null &&
          ...
          return Ze;
        case `menuitem`:
          for (var Qe in (e.push(Fe(`menuitem`)), n))
            if (O.call(n, Qe)) {
              var $e = n[Qe];
              if ($e != null)
                switch (Qe) {
        ...
        case `object`:
          ...
          if ((e.push(`>`), Se(e, tt, et), typeof et == `string`)) {
            e.push(F(et));
            var at = null;
          } else at = et;
          return at;
        case `title`:
          var ot = c.tagScope & 1,
            st = c.tagScope & 4;
          if (c.insertionMode === 4 || ot || n.itemProp != null)
            var ct = ke(e, n);
          else st ? (ct = null) : (ke(a.hoistableChunks, n), (ct = void 0));
          return ct;
        case `link`:
          var lt = c.tagScope & 1,
            ut = c.tagScope & 4,
          ...
          if (
            ...
            if (
              ...
              var _t = a.styles.get(pt),
                vt = i.styleResources.hasOwnProperty(ft)
                  ? i.styleResources[ft]
                  : void 0;
              if (vt !== null) {
                ((i.styleResources[ft] = null),
                  _t ||
                    ((_t = {
                      precedence: F(pt),
                      rules: [],
                ...
                if (vt) {
                  ...
                  var bt = a.preloads.stylesheets.get(ft);
                  bt && 0 < bt.length ? (bt.length = 0) : (yt.state = 1);
                }
                (_t.sheets.set(ft, yt), s && s.stylesheets.add(yt));
              } else if (_t) {
                var xt = _t.sheets.get(ft);
                xt && s && s.stylesheets.add(xt);
              }
              (l && e.push(`<!-- -->`), (mt = null));
            }
          else
            n.onLoad || n.onError
              ? (mt = Te(e, n))
              : (l && e.push(`<!-- -->`),
                (mt = ut ? null : Te(a.hoistableChunks, n)));
          return mt;
        case `script`:
          var St = c.tagScope & 1,
            Ct = n.async;
          if (
            ...
            var Tt = n.src;
            if (n.type === `module`)
              var Et = i.moduleScriptResources,
                Dt = a.preloads.moduleScripts;
            else ((Et = i.scriptResources), (Dt = a.preloads.scripts));
            var W = Et.hasOwnProperty(Tt) ? Et[Tt] : void 0;
            if (W !== null) {
              Et[Tt] = null;
              var G = n;
              if (W) {
                W.length === 2 && ((G = D({}, n)), ht(G, W));
                var Ot = Dt.get(Tt);
                Ot && (Ot.length = 0);
              }
              var kt = [];
              (a.scripts.add(kt), Ae(kt, G));
            }
            (l && e.push(`<!-- -->`), (wt = null));
          }
          return wt;
        case `style`:
          ...
          if (
            ...
            e.push(`>`);
            var Lt = Array.isArray(Nt) ? (2 > Nt.length ? Nt[0] : null) : Nt;
            (typeof Lt != `function` &&
              typeof Lt != `symbol` &&
              Lt != null &&
              e.push((`` + Lt).replace(Ee, De)),
              Se(e, Pt, Nt),
              e.push(Re(`style`)));
            var Rt = null;
          } else {
            var zt = a.styles.get(jt);
            if (
              (i.styleResources.hasOwnProperty(Mt)
                ? i.styleResources[Mt]
                : void 0) !== null
            ) {
              ((i.styleResources[Mt] = null),
                zt ||
                  ((zt = {
                    precedence: F(jt),
                    rules: [],
              ...
              if (!Bt || Bt === K) {
                ...
                (typeof Kt != `function` &&
                  typeof Kt != `symbol` &&
                  Kt != null &&
                  Vt.push((`` + Kt).replace(Ee, De)),
                  Se(Vt, Ut, Ht));
              }
            }
            (zt && s && s.styles.add(zt),
              l && e.push(`<!-- -->`),
              (Rt = void 0));
          }
          return Rt;
        case `meta`:
          var qt = c.tagScope & 1,
            Jt = c.tagScope & 4;
          if (c.insertionMode === 4 || qt || n.itemProp != null)
            var Yt = Oe(e, n, `meta`);
          else
            (l && e.push(`<!-- -->`),
              (Yt = Jt
        ...
        case `pre`:
          ...
          if ((e.push(`>`), Zt != null)) {
            if (Xt != null) throw Error(r(60));
            if (typeof Zt != `object` || !(`__html` in Zt)) throw Error(r(61));
            var q = Zt.__html;
            q != null &&
              (typeof q == `string` &&
              0 < q.length &&
...
`),
        ...
        case `img`:
          ...
          if (
            ...
            var nn = typeof n.sizes == `string` ? n.sizes : void 0,
              Y = tn
                ? tn +
                  `
` +
                  (nn || ``)
                : en,
              rn = a.preloads.images,
              X = rn.get(Y);
            if (X)
              (n.fetchPriority === `high` || 10 > a.highImagePreloads.size) &&
                (rn.delete(Y), a.highImagePreloads.add(X));
            else if (!i.imageResources.hasOwnProperty(Y)) {
              i.imageResources[Y] = ae;
              ...
              0 <= (sn.remainingCapacity -= cn.length + 2))
                ...
                : ((X = []),
                  ...
                  n.fetchPriority === `high` || 10 > a.highImagePreloads.size
                    ? a.highImagePreloads.add(X)
                    : (a.bulkPreloads.add(X), rn.set(Y, X)));
            }
          }
          return Oe(e, n, `img`);
        case `base`:
        ...
        case `head`:
          if (2 > c.insertionMode) {
            ...
            var un = je(ln.headChunks, n, `head`);
          } else un = Me(e, n, `head`);
          return un;
        case `body`:
          if (2 > c.insertionMode) {
            ...
            var fn = je(dn.bodyChunks, n, `body`);
          } else fn = Me(e, n, `body`);
          return fn;
        case `html`:
          if (c.insertionMode === 0) {
            ...
            var mn = je(pn.htmlChunks, n, `html`);
          } else mn = Me(e, n, `html`);
          return mn;
        default:
          if (t.indexOf(`-`) !== -1) {
                  ...
                  switch (_n) {
                    ...
                    default:
                      if (
                        ...
                        if (!0 === vn) vn = ``;
                        else if (typeof vn == `object`) continue;
                        e.push(` `, yn, `="`, F(vn), `"`);
                      }
                  }
                }
              }
            return (e.push(`>`), Se(e, gn, hn), hn);
          }
      }
      return Me(e, n, t);
    }
    ...
    function Re(e) {
      var t = Le.get(e);
      return (t === void 0 && ((t = `</` + e + `>`), Le.set(e, t)), t);
    }
    function ze(e, t) {
      ((e = e.preamble),
    ...
    function Ze(e, t, n) {
      return (
        ...
        (Ye = !0),
        (oe = n),
        t.styles.forEach(Xe, e),
        (oe = null),
        t.stylesheets.forEach(U),
        Je && (n.stylesToHoist = !0),
        Ye
      );
    }
    function Qe(e) {
        ...
        if (typeof e == `string` && e) {
          if (!n.dnsResources.hasOwnProperty(e)) {
            ...
            ((a = n && 0 < n.remainingCapacity) &&
              (a =
                ((i = `<` + (`` + e).replace(_t, vt) + `>; rel=dns-prefetch`),
        ...
        if (typeof e == `string` && e) {
          ...
          if (!r.connectResources[a].hasOwnProperty(e)) {
            ...
            if ((s = r && 0 < r.remainingCapacity)) {
              if (
                ((s = `<` + (`` + e).replace(_t, vt) + `>; rel=preconnect`),
                typeof t == `string`)
              ) {
                var c = (`` + t).replace(yt, bt);
                s += `; crossorigin="` + c + `"`;
              }
...
` +
              ...
              typeof o != `string` &&
              c === `high` &&
              ((u = gt(e, t, n)), 0 <= (i.remainingCapacity -= u.length + 2))
                ? ((a.resets.image[l] = ae),
                  i.highImagePreloads && (i.highImagePreloads += `, `),
                  (i.highImagePreloads += u))
                : ((i = []),
                  Te(i, D({ rel: `preload`, href: o ? void 0 : e, as: t }, n)),
                  c === `high`
            ...
            case `style`:
              ...
              ((o = []),
                Te(o, D({ rel: `preload`, href: e, as: t }, n)),
                (i.styleResources[e] =
                  !n ||
    ...
    function dt(e, t) {
      ...
      if (n) {
        ...
        if (e) {
          ...
          (Te(a, D({ rel: `modulepreload`, href: e }, t)),
      ...
      if (r) {
        ...
        if (e) {
          ...
          s !== null &&
            ...
            (t = {
              state: 0,
              props: D({ rel: `stylesheet`, href: e, "data-precedence": t }, n),
            }),
            s &&
              (s.length === 2 && ht(t.props, s),
      ...
      if (n) {
        ...
        if (e) {
          ...
          a !== null &&
            ...
            (t = D({ src: e, async: !0 }, t)),
            a &&
              (a.length === 2 && ht(t, a), (e = i.preloads.scripts.get(e))) &&
              (e.length = 0),
            (e = []),
            i.scripts.add(e),
            Ae(e, t),
      ...
      if (n) {
        ...
        if (e) {
          ...
          a !== null &&
            ...
            (t = D({ src: e, type: `module`, async: !0 }, t)),
            a &&
              (a.length === 2 && ht(t, a),
    ...
    function gt(e, t, n) {
      for (var r in ((e = (`` + e).replace(_t, vt)),
      (t = (`` + t).replace(yt, bt)),
...
`:
    ...
    function Ct(e, t) {
      (t.styles.forEach(xt, e),
        t.stylesheets.forEach(St, e),
    ...
    function Mt(e) {
      var t = e.parent;
      (t !== null && Mt(t), (e.context._currentValue2 = e.value));
    }
    function K(e, t) {
      if (
        ...
        throw Error(r(402));
      e.depth === t.depth ? At(e, t) : K(e, t);
    }
    function Nt(e, t) {
      var n = t.parent;
      if (n === null) throw Error(r(402));
      (e.depth === n.depth ? At(e, n) : Nt(e, n),
        (t.context._currentValue2 = t.value));
    }
    function Pt(e) {
      var t = kt;
    ...
    function Lt(e, t, n) {
      ...
      if (30 < a) {
        ...
        return (
          ...
          (r >>= o),
          (i -= o),
          { id: (1 << (32 - Rt(t) + i)) | (n << i) | r, overflow: a + e }
        );
      }
      return { id: (1 << a) | (n << i) | r, overflow: e };
    }
    var Rt = Math.clz32 ? Math.clz32 : Vt,
      zt = Math.log,
      Bt = Math.LN2;
    function Vt(e) {
    ...
    function Wt(e, t, n) {
      switch (
        ((n = e[n]),
        n === void 0 ? e.push(t) : n !== t && (t.then(Ht, Ht), (t = n)),
        t.status)
      ) {
        case `fulfilled`:
          return t.value;
    ...
    var Jt = typeof Object.is == `function` ? Object.is : qt,
      Yt = null,
      Xt = null,
      Zt = null,
      Qt = null,
    ...
    function pn(e, t, n) {
      ...
      return (
        ...
        (e = e.dispatch = hn.bind(null, Yt, e)),
        [q.memoizedState, e]
      );
    }
    function mn(e, t) {
      if (
        ((Yt = sn()), (q = ln()), (t = t === void 0 ? null : t), q !== null)
      ) {
    ...
    var Sn = {
        ...
        useId: function () {
          var e = Xt.treeContext,
            t = e.overflow;
          ((e = e.id), (e = (e & ~(1 << (32 - Rt(e) - 1))).toString(32) + t));
          var n = Cn;
...
` + e;
      ...
      if (typeof e == `object` && e && typeof e.environmentName == `string`) {
        ...
        ((e = [e].slice(0)),
          typeof e[0] == `string`
            ...
            : e.splice(0, 0, `[%s]`, ` ` + t + ` `),
          e.unshift(console),
          (t = Dt.apply(console.error, e)),
          t());
      } else console.error(e);
      return null;
    }
    function Nn(e, t, n, r, i, a, o, s, c, l, u) {
      var d = new Set();
      ((this.destination = null),
        ...
        (this.onError = i === void 0 ? Mn : i),
        (this.onPostpone = l === void 0 ? Ht : l),
        (this.onAllReady = a === void 0 ? Ht : a),
        (this.onShellReady = o === void 0 ? Ht : o),
        (this.onShellError = s === void 0 ? Ht : s),
        (this.onFatalError = c === void 0 ? Ht : c),
        (this.formState = u === void 0 ? null : u));
    }
    function Pn(e, t, n, r, i, a, o, s, c, l, u, d) {
      return (
        (t = new Nn(t, n, r, i, a, o, s, c, l, u, d)),
        (n = Bn(t, 0, null, r, !1, !1)),
        (n.parentFlushed = !0),
        (e = Rn(
          t,
    ...
    function In(e, t) {
      (e.pingedTasks.push(t),
        e.pingedTasks.length === 1 &&
          ((e.flushScheduled = e.destination !== null), vr(e)));
    }
    function Ln(e, t, n, r, i) {
      return (
        ...
        t !== null &&
          ...
          e !== null && Ct(n.contentState, e)),
        n
      );
    }
    function Rn(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m) {
      (e.allPendingTasks++,
    ...
    function zn(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
      (e.allPendingTasks++,
...
` +
    ...
    function Kn(e, t) {
      qn(e, t.next, t.hoistables);
    }
    function qn(e, t, n) {
      for (; t !== null; ) {
        n !== null && (Ct(t.hoistables, n), (t.inheritedHoistables = n));
        var r = t.boundaries;
        if (r !== null) {
          t.boundaries = null;
          for (var i = 0; i < r.length; i++) {
            var a = r[i];
            (n !== null && Ct(a.contentState, n), _r(e, a, null, null));
          }
        }
    ...
    function Jn(e, t) {
      ...
      if (n !== null && t.pendingTasks === n.length) {
        for (var r = !0, i = 0; i < n.length; i++) {
          var a = n[i];
          if (a.pendingTasks !== 1 || a.parentFlushed || jn(e, a)) {
            r = !1;
            break;
          }
        }
        r && qn(e, t, t.hoistables);
      }
    }
    function Yn(e) {
      var t = {
    ...
    function Xn(e, t, n, r, i) {
      ...
      if (t.replay !== null) {
          ...
          for (var u = 0; u < n; u++) {
            var d =
                i !== `backwards` && i !== `unstable_legacy-backwards`
                  ...
                  : n - 1 - u,
              f = r[d];
            ((t.row = c = Yn(c)), (t.treeContext = Lt(o, n, d)));
            var p = l[d];
            (typeof p == `number`
              ? (er(e, t, p, f, d), delete l[d])
              : lr(e, t, f, d),
              --c.pendingTasks === 0 && Kn(e, c));
          }
        else
          for (l = 0; l < n; l++)
            ((u =
        ...
        for (
          ...
          try {
            (lr(e, t, f, d),
              Et(p.chunks, e.renderState, p.lastPushedText, p.textEmbedded),
              (p.status = 1),
              --c.pendingTasks === 0 && Kn(e, c));
          } catch (t) {
      ...
      if (typeof i == `function`)
        if (i.prototype && i.prototype.isReactComponent) {
          ...
          ((a = m),
            ...
            (m = new i(a, m)));
          var O = m.state === void 0 ? null : m.state;
          if (
            ((m.updater = Ft),
            (m.props = a),
            (m.state = O),
            ...
            (m._reactInternals = C),
            (d = i.contextType),
            (m.context = typeof d == `object` && d ? d._currentValue2 : Ot),
            (d = i.getDerivedStateFromProps),
            typeof d == `function` &&
              ((d = d(a, O)), (O = d == null ? O : D({}, O, d)), (m.state = O)),
            ...
            if (
              ...
              i !== m.state && Ft.enqueueReplaceState(m, m.state, null),
              ...
              if (
                ...
                for (
                  C = d ? i[0] : m.state, O = !0, d = d ? 1 : 0;
                  d < i.length;
                  d++
                )
                  ((E = i[d]),
                    (E = typeof E == `function` ? E.call(m, C, a, void 0) : E),
                    E != null && (O ? ((O = !1), (C = D({}, C, E))) : D(C, E)));
                m.state = C;
              }
            else C.queue = null;
          if (((i = m.render()), e.status === 12)) throw null;
          ((a = t.keyPath), (t.keyPath = n), tr(e, t, i, -1), (t.keyPath = a));
        } else {
          if (((i = Zn(e, t, n, i, a, void 0)), e.status === 12)) throw null;
          Qn(e, t, n, i, tn !== 0, nn, Y);
        }
        ...
        if (((m = t.blockedSegment), m === null))
          ...
          if (
            ...
            ((n = Bn(e, 0, null, t.formatContext, !1, !1)),
              m.preambleChildren.push(n),
              (t.blockedSegment = n));
            try {
              ((n.status = 6),
                lr(e, t, O, -1),
                Et(n.chunks, e.renderState, n.lastPushedText, n.textEmbedded),
                (n.status = 1));
            } finally {
              t.blockedSegment = m;
            }
              ...
              if (((F.parentFlushed = !0), e.trackedPostpones !== null)) {
                ...
                try {
                  if (
                    ...
                    if (((N.status = 1), !jn(e, N))) {
                      (k !== null && --k.pendingTasks === 0 && Kn(e, k),
                        e.pendingRootTasks === 0 && t.blockedPreamble && xr(e));
                      break a;
                    }
                  } else k !== null && k.together && Jn(e, k);
                } catch (n) {
                  ((N.status = 4),
                    e.status === 12
                      ? ((F.status = 3), (m = e.fatalError))
                      : ((F.status = 4), (m = n)),
                    (C = Un(t.componentStack)),
                    (O = Wn(e, m, C)),
                    (N.errorDigest = O),
                    or(e, N));
                } finally {
        ...
        if (typeof i == `object` && i)
          switch (i.$$typeof) {
            case f:
              if (`ref` in a)
                for (ee in ((m = {}), a)) ee !== `ref` && (m[ee] = a[ee]);
              else m = a;
              ((i = Zn(e, t, n, i.render, m, d)),
                Qn(e, t, n, i, tn !== 0, nn, Y));
              return;
            case g:
              $n(e, t, n, i.type, a, d);
    ...
    function er(e, t, n, r, i) {
      var a = t.replay,
        o = t.blockedBoundary,
        s = Bn(e, 0, null, t.formatContext, !1, !1);
      ...
      try {
        ((t.replay = null),
          ...
          o === null
            ...
            : (gr(o, s), o.parentFlushed && e.partialBoundaries.push(o)));
      } finally {
      ...
      if (n !== null) {
        if (typeof n == `object`) {
                  ...
                  for (o = h.nodes, n = 0; n < o.length; n++) {
                    ...
                    if (m === g[1]) {
                      if (g.length === 4) {
                        ...
                        if (s !== p)
                          throw Error(r(490, `Suspense`, G(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = g[5]),
                            (d = g[2]),
          ...
          if (typeof n.then == `function`)
            return ((t.thenableState = null), tr(e, t, bn(n), o));
          if (n.$$typeof === u) return tr(e, t, n._currentValue2, o);
          throw (
    ...
    function rr(e, t, n, i) {
          ...
          if (l[1] === i) {
            ...
            try {
              ...
              if (
                ...
                throw r;
              (t.replay.pendingTasks--, (n = Un(t.componentStack)));
              var u = t.blockedBoundary,
                d = r;
              ((n = Wn(e, d, n)), dr(e, u, i, l, d, n));
            }
      ...
      if (
        ...
        for (i = 0; i < s; i++)
          ((l = n[i]),
            (t.treeContext = Lt(o, s, i)),
            (u = c[i]),
            typeof u == `number`
              ? (er(e, t, u, l, i), delete c[i])
              : lr(e, t, l, i));
        ((t.treeContext = o), (t.keyPath = a));
        return;
      }
      for (c = 0; c < s; c++)
        ((i = n[c]), (t.treeContext = Lt(o, s, c)), lr(e, t, i, c));
      ((t.treeContext = o), (t.keyPath = a));
    }
    function ir(e, t, n) {
      if (
      ...
      if (o === null)
        ...
        if (
          ...
          if (a === null) {
            ...
            ((e = {}), (s = [a[1], a[2], [], e]), o.set(a, s), Nr(s, a[0], t));
    ...
    function cr(e, t, n) {
      var r = t.blockedSegment,
        i = Bn(e, r.chunks.length, null, t.formatContext, r.lastPushedText, !0);
      return (
        r.children.push(i),
        (r.lastPushedText = !1),
        Rn(
    ...
    function ur(e) {
      var t = e.blockedBoundary,
        n = e.blockedSegment;
      n !== null && ((n.status = 3), _r(this, t, e.row, n));
    }
    function dr(e, t, n, i, a, o) {
      for (var s = 0; s < n.length; s++) {
        var c = n[s];
        if (c.length === 4) dr(e, t, c[2], c[3], a, o);
        else {
          c = c[5];
          var l = e,
            u = o,
            d = Ln(l, null, new Set(), null, null);
          ((d.parentFlushed = !0),
            (d.rootSegmentID = c),
            (d.status = 4),
            (d.errorDigest = u),
    ...
    function fr(e, t, n) {
      ...
      if (r === null) {
        if (t.status !== 13 && t.status !== 14) {
          ...
          (r.pendingTasks--,
            r.pendingTasks === 0 &&
              0 < r.nodes.length &&
              ((i = Wn(t, n, a)), dr(t, null, r.nodes, r.slots, n, i)),
            t.pendingRootTasks--,
            t.pendingRootTasks === 0 && mr(t));
        }
      } else {
        ...
        (r.pendingTasks--,
          (i = r.row),
          i !== null && --i.pendingTasks === 0 && Kn(t, i),
          r.fallbackAbortableTasks.forEach(function (e) {
            return fr(e, t, n);
          }),
          r.fallbackAbortableTasks.clear());
      ...
      ((e = e.row),
        e !== null && --e.pendingTasks === 0 && Kn(t, e),
        t.allPendingTasks--,
        t.allPendingTasks === 0 && hr(t));
    }
    function pr(e, t) {
      try {
        var n = e.renderState,
    ...
    function mr(e) {
      (e.trackedPostpones === null && pr(e, !0),
        e.trackedPostpones === null && xr(e),
        (e.onShellError = Ht),
        (e = e.onShellReady),
        e());
    }
    ...
    function gr(e, t) {
      if (
        ...
        ((n.id = t.id),
          (n.parentFlushed = !0),
          (n.status !== 1 && n.status !== 3 && n.status !== 4) || gr(e, n));
      } else e.completedSegments.push(t);
    }
    function _r(e, t, n, i) {
      if (
        (n !== null &&
          (--n.pendingTasks === 0 ? Kn(e, n) : n.together && Jn(e, n)),
        e.allPendingTasks--,
        t === null)
      ) {
        ...
        (e.pendingRootTasks--, e.pendingRootTasks === 0 && mr(e));
        ...
        if (t.pendingTasks === 0) {
          if (
            ...
            ((n = t.row),
              n !== null && Ct(n.hoistables, t.contentState),
              jn(e, t) ||
                (t.fallbackAbortableTasks.forEach(ur, e),
                t.fallbackAbortableTasks.clear(),
                n !== null && --n.pendingTasks === 0 && Kn(e, n)),
            ...
            if (e.trackedPostpones !== null) {
              ...
              if (a !== null && ((i = a.boundaries), i !== null))
                for (a.boundaries = null, a = 0; a < i.length; a++) {
                  var o = i[a];
                  (ir(e, n, o), _r(e, o, null, null));
                }
            }
            --t.pendingTasks === 0 && Kn(e, t);
          }
        } else
          (i === null ||
            !i.parentFlushed ||
            ...
            (t = t.row),
            t !== null && t.together && Jn(e, t));
      e.allPendingTasks === 0 && hr(e);
    }
    function vr(e) {
                ...
                try {
                  if (
                    (typeof l.replay.slots == `number`
                      ? er(f, l, l.replay.slots, l.node, l.childIndex)
                      : nr(f, l),
                  ...
                  (l.replay.pendingTasks--,
                    l.abortSet.delete(l),
                    _r(f, l.blockedBoundary, l.row, null));
                } catch (e) {
                  dn();
                  var p = e === Ut ? Kt() : e;
                  if (
                    ...
                    var m = l.ping;
                    (p.then(m, m), (l.thenableState = e === Ut ? un() : null));
                  } else {
                    (l.replay.pendingTasks--, l.abortSet.delete(l));
                    var h = Un(l.componentStack);
                    u = void 0;
                    var g = f,
                      _ = l.blockedBoundary,
                    ...
                    ((u = Wn(g, v, h)),
                      dr(g, _, y, b, v, u),
                      f.pendingRootTasks--,
                      f.pendingRootTasks === 0 && mr(f),
                      f.allPendingTasks--,
                      f.allPendingTasks === 0 && hr(f));
                  }
                }
              }
            } else if (((f = void 0), (g = d), g.status === 0)) {
              ((g.status = 6), Pt(l.context));
              var x = g.children.length,
                S = g.chunks.length;
              try {
                (nr(u, l),
                  Et(g.chunks, u.renderState, g.lastPushedText, g.textEmbedded),
                  l.abortSet.delete(l),
                  (g.status = 1),
                  _r(u, l.blockedBoundary, l.row, g));
              } catch (e) {
                (dn(), (g.children.length = x), (g.chunks.length = S));
                var C = e === Ut ? Kt() : u.status === 12 ? u.fatalError : e;
                if (u.status === 12 && u.trackedPostpones !== null) {
                  var w = u.trackedPostpones,
                    T = Un(l.componentStack);
                  (l.abortSet.delete(l),
                    Wn(u, C, T),
                    ar(u, w, l, g),
                    _r(u, l.blockedBoundary, l.row, g));
                  ...
                  ((g.status = 0), (l.thenableState = e === Ut ? un() : null));
                  var E = l.ping;
                  C.then(E, E);
                } else {
                  var D = Un(l.componentStack);
                  (l.abortSet.delete(l), (g.status = 4));
                  var O = l.blockedBoundary,
                    k = l.row;
                  if (
                    (k !== null && --k.pendingTasks === 0 && Kn(u, k),
                    u.allPendingTasks--,
                    (f = Wn(u, C, D)),
                    O === null)
                  )
                    ...
                    ((O.status = 4), (O.errorDigest = f), or(u, O));
                    var A = O.row;
                    (A !== null && --A.pendingTasks === 0 && Kn(u, A),
                  ...
                  u.allPendingTasks === 0 && hr(u);
                }
              }
            }
          }
          (s.splice(0, c), e.destination !== null && kr(e, e.destination));
        } catch (t) {
          (Wn(e, t, {}), Gn(e, t));
        } finally {
          ((Cn = o), (re.H = n), (re.A = i), n === Sn && Pt(t), (Fn = a));
        }
      }
    }
    function yr(e, t, n) {
      ...
      for (var r = !1, i = 0; i < t.children.length; i++)
        r = br(e, t.children[i], n) || r;
      return r;
    }
    function br(e, t, n) {
      var i = t.boundary;
      if (i === null) return yr(e, t, n);
      ...
      switch (i.status) {
        ...
        case 4:
          if (t.status === 1) return (ze(e.renderState, o), yr(e, t, n));
        default:
          return !0;
      }
    }
    function xr(e) {
      if (e.completedRootSegment && e.completedPreambleSegments === null) {
        var t = [],
          n = e.byteSize,
          r = br(e, e.completedRootSegment, t),
    ...
    function wr(e, t, n, i) {
      var a = n.boundary;
      if (a === null) return Sr(e, t, n, i);
      if (((a.parentFlushed = !0), a.status === 4)) {
        var o = a.row;
        return (
          o !== null && --o.pendingTasks === 0 && Kn(e, o),
          e.renderState.generateStaticMarkup ||
            ((a = a.errorDigest),
            t.push(`<!--$!-->`),
            t.push(`<template`),
      ...
      if (a.status !== 1)
        return (
          ...
          Ve(t, e.renderState, a.rootSegmentID),
          i && Ct(i, a.fallbackState),
          Sr(e, t, n, i),
          t.push(`<!--/$-->`)
        );
      if (!Or && jn(e, a) && Cr + a.byteSize > e.progressiveChunkSize)
        return (
      ...
      if (
        ((Cr += a.byteSize),
        i && Ct(i, a.contentState),
        (n = a.row),
        n !== null && jn(e, a) && --n.pendingTasks === 0 && Kn(e, n),
    ...
    function Tr(e, t, n, r) {
      return (
        He(t, e.renderState, n.parentFormatContext, n.id),
        wr(e, t, n, r),
        Ue(t, n.parentFormatContext)
      );
    }
    function Er(e, t, n) {
      Cr = n.byteSize;
      ...
      ((r.length = 0),
        (r = n.row),
        r !== null && jn(e, n) && --r.pendingTasks === 0 && Kn(e, r),
        Ze(t, n.contentState, e.renderState),
        (r = e.resumableState),
        (e = e.renderState),
        (i = n.rootSegmentID),
        (n = n.contentState));
...
$RC=function(a,b){if(b=document.getElementById(b))(a=document.getElementById(a))?(a.previousSibling.data="$~",$RB.push(a,b),2===$RB.length&&("number"!==typeof $RT?requestAnimationFrame($RV.bind(null,$RB)):(a=performance.now(),setTimeout($RV.bind(null,$RB),2300>a&&2E3<a?2300-a:$RT+300-a)))):b.parentNode.removeChild(b)};`)),
      ...
      try {
        if (!(0 < e.pendingRootTasks)) {
          ...
          if (r !== null) {
            ...
            for (a = h.length = 0; a < i.length; a++) {
              var g = i[a];
              for (o = 0; o < g.length; o++) wr(e, t, g[o], null);
            }
            ...
            (wr(e, t, r, null), (e.completedRootSegment = null));
            var x = e.renderState;
            if (
              e.allPendingTasks !== 0 ||
          ...
          ((E.length = 0),
            T.preconnects.forEach(Qe, t),
            T.preconnects.clear(),
            T.fontPreloads.forEach(Qe, t),
            T.fontPreloads.clear(),
            T.highImagePreloads.forEach(Qe, t),
            T.highImagePreloads.clear(),
            T.styles.forEach(rt, t),
            T.scripts.forEach(Qe, t),
            T.scripts.clear(),
            T.bulkPreloads.forEach(Qe, t),
          ...
          for (n = 0; n < O.length; n++) {
            ...
            var N = ee.toString(16);
            if ((T.push(N), T.push(`"`), M)) {
              T.push(`,`);
              var P = Ge(M || ``);
              T.push(P);
            }
            var te = T.push(`)<\/script>`);
            if (!te) {
            ...
            a: {
              ...
              (R !== null &&
                ...
                (R.pendingTasks === 1
                  ? qn(O, R, R.hoistables)
                  : R.pendingTasks--),
                (ie = Ze(k, L.contentState, O.renderState)));
            }
            if (!ie) {
        ...
        ((Or = !1),
          e.allPendingTasks === 0 &&
            ...
            ((e.flushScheduled = !1),
            (n = e.resumableState),
            n.hasBody && ((I = Re(`body`)), t.push(I)),
            n.hasHtml && ((n = Re(`html`)), t.push(n)),
            (e.status = 14),
            t.push(null),
            (e.destination = null)));
      }
    ...
    function Mr(e, t) {
      ...
      try {
        ...
        e.destination !== null && kr(e, e.destination);
      } catch (t) {
        (Wn(e, t, {}), Gn(e, t));
      }
    }
    function Nr(e, t, n) {
      if (t === null) n.rootNodes.push(e);
        ...
        var r = n.workingMap,
          i = r.get(t);
        (i === void 0 &&
          ((i = [t[1], t[2], [], null]), r.set(t, i), Nr(i, t[0], n)),
          i[2].push(e));
      }
    }
    function Pr() {}
    function Fr(e, t, n, i) {
      ...
      if (
        ...
        e.trackedPostpones === null && pr(e, e.pendingRootTasks === 0),
        Mr(e, i),
        jr(e, {
          push: function (e) {
            return (e !== null && (s += e), !0);
  ...
  sp = t((e) => {
    ...
    function k(e) {
      (O.push(e), D.port2.postMessage(null));
    }
    function A(e) {
      setTimeout(function () {
        throw e;
    ...
    var je = L(`<script type="importmap">`),
      Me = L(`<\/script>`);
    function Ne(e, t, n, r, i, a) {
      ...
      if (
        (d !== void 0 &&
          (u.push(o), ir(u, e), u.push(st, I((`` + d).replace(ke, Ae)), H)),
        (d = []),
        r !== void 0 &&
          (d.push(je),
          d.push(I((`` + JSON.stringify(r)).replace(ke, Ae))),
          d.push(Me)),
        (r = i
          ? {
              preconnects: ``,
        ...
        for (r = 0; r < f.length; r++)
          ((l = f[r]),
            ...
            u.push(Se, I(V(a)), U),
            n && u.push(we, I(V(n)), U),
            typeof s == `string` && u.push(Te, I(V(s)), U),
            typeof o == `string` && u.push(Ee, I(V(o)), U),
            ir(u, e),
            u.push(De));
      if (p !== void 0)
        for (t = 0; t < p.length; t++)
          ((s = p[t]),
            ...
            u.push(Ce, I(V(f)), U),
            n && u.push(we, I(V(n)), U),
            typeof a == `string` && u.push(Te, I(V(a)), U),
            typeof r == `string` && u.push(Ee, I(V(r)), U),
            ir(u, e),
            u.push(De));
      return i;
    }
    ...
    function Re(e, t, n) {
      ...
      switch (t) {
        case `noscript`:
          return Ie(2, null, r | 1, null);
        case `select`:
          return Ie(2, n.value == null ? n.defaultValue : n.value, r, null);
        case `svg`:
          return Ie(4, null, r, null);
        case `picture`:
          return Ie(2, null, r | 2, null);
        case `math`:
          return Ie(5, null, r, null);
        case `foreignObject`:
          return Ie(2, null, r, null);
        case `table`:
          return Ie(6, null, r, null);
        case `thead`:
        case `tbody`:
        case `tfoot`:
          return Ie(7, null, r, null);
        case `colgroup`:
          return Ie(9, null, r, null);
        case `tr`:
          return Ie(8, null, r, null);
        case `head`:
          if (2 > e.insertionMode) return Ie(3, null, r, null);
          break;
        case `html`:
          if (e.insertionMode === 0) return Ie(1, null, r, null);
      }
      return 6 <= e.insertionMode || 2 > e.insertionMode
        ? Ie(2, null, r, null)
        : e.tagScope === r
          ? e
          : Ie(e.insertionMode, e.selectedValue, r, null);
    }
    function ze(e) {
      return e === null
        ? null
    ...
    function Ve(e, t) {
      ...
      return (
        e !== null && e.share !== `none` && (n |= 64),
        Ie(t.insertionMode, t.selectedValue, n, e)
      );
    }
    var He = L(`<!-- -->`);
    function Ue(e, t, n, r) {
      return t === `` ? r : (r && e.push(He), e.push(I(V(t))), !0);
    }
    var We = new Map(),
      Ge = L(` style="`),
      Ke = L(`:`),
          ...
          if (a != null && typeof a != `boolean` && a !== ``) {
            if (i.indexOf(`--`) === 0) {
              ...
              ((o = We.get(i)),
                o === void 0 &&
                  ((o = L(
                    V(i.replace(de, `-$1`).toLowerCase().replace(fe, `-ms-`)),
                  )),
                  We.set(i, o)),
                (a =
                  typeof a == `number`
                    ? a === 0 || le.has(i)
                      ...
                      : I(a + `px`)
                    : I(V((`` + a).trim()))));
            n ? ((n = !1), e.push(Ge, o, Ke, a)) : e.push(qe, o, Ke, a);
          }
        }
      n || e.push(U);
    }
    ...
    function $e(e, t, n) {
      typeof n != `function` &&
        typeof n != `symbol` &&
        typeof n != `boolean` &&
        e.push(Ye, I(t), Xe, I(V(n)), U);
    }
    var et = L(
        V(`javascript:throw new Error('React form unexpectedly submitted.')`),
      ),
      tt = L(`<input type="hidden"`);
    function nt(e, t) {
      (this.push(tt),
        rt(e),
        $e(this, `name`, t),
    ...
    function at(e, t, n, r, i, a, o, s) {
      ...
      if (typeof r == `function`) {
        var l = it(t, r);
        l === null
          ? (e.push(Ye, I(`formAction`), Xe, et, U),
            (o = a = i = r = s = null),
            pt(t, n))
          : ((s = l.name),
            (r = l.action || ``),
      ...
      return (
        s != null && ot(e, `name`, s),
        r != null && ot(e, `formAction`, r),
        i != null && ot(e, `formEncType`, i),
        a != null && ot(e, `formMethod`, a),
        o != null && ot(e, `formTarget`, o),
        c
      );
    }
    function ot(e, t, n) {
      switch (t) {
        ...
        case `formAction`:
          if (
            ...
            break;
          ((n = me(`` + n)), e.push(Ye, I(t), Xe, I(V(n)), U));
          break;
        case `defaultValue`:
        case `defaultChecked`:
        case `innerHTML`:
        ...
        case `xlinkHref`:
          if (
            ...
            break;
          ((n = me(`` + n)), e.push(Ye, I(`xlink:href`), Xe, I(V(n)), U));
          break;
        case `contentEditable`:
        case `spellCheck`:
        case `draggable`:
    ...
    function pt(e, t) {
      if (!(e.instructions & 16)) {
        ...
        var n = t.preamble,
          r = t.bootstrapChunks;
        (n.htmlChunks || n.headChunks) && r.length === 0
          ? (r.push(t.startInlineScript), ir(r, e), r.push(st, ft, H))
          : r.unshift(t.startInlineScript, st, ft, H);
      }
    }
    var mt = L(`<!--F!-->`),
      ht = L(`<!--F-->`);
    function gt(e, t) {
      for (var n in (e.push(Ot(`link`)), t))
        if (z.call(t, n)) {
          var i = t[n];
          if (i != null)
            switch (n) {
    ...
    function wt(e, t) {
      ...
      return (
        e.push(st),
        lt(e, r, n),
        typeof n == `string` && e.push(I((`` + n).replace(ke, Ae))),
        e.push(Mt(`script`)),
        null
      );
    }
    ...
    function Et(e, t, n) {
      ...
      return (
        e.push(st),
        lt(e, r, n),
        typeof n == `string` ? (e.push(I(V(n))), null) : n
      );
    }
    var Dt = L(`
`),
    ...
    function Ot(e) {
      var t = G.get(e);
      if (t === void 0) {
        if (!W.test(e)) throw Error(r(65, e));
        ((t = L(`<` + e)), G.set(e, t));
      }
      return t;
    }
    var kt = L(`<!DOCTYPE html>`);
    function At(e, t, n, i, a, o, s, c, l) {
      switch (t) {
        ...
        case `a`:
          ...
          if ((e.push(st), lt(e, d, u), typeof u == `string`)) {
            e.push(I(V(u)));
            var m = null;
          } else m = u;
          return m;
        ...
        case `textarea`:
          ...
          if ((k === null && A !== null && (k = A), e.push(st), j != null)) {
...
` &&
        ...
        case `input`:
          ...
          var le = at(e, i, a, P, F, te, ne, N);
          return (
            ie === null
              ? ae !== null && Qe(e, `checked`, ae)
              : Qe(e, `checked`, ie),
            L === null ? re !== null && ot(e, `value`, re) : ot(e, `value`, L),
            e.push(ct),
            le?.forEach(nt, e),
            null
          );
        case `button`:
          ...
          var be = at(e, i, a, fe, pe, he, ge, de);
          if (
            (e.push(st), be?.forEach(nt, e), lt(e, ue, B), typeof B == `string`)
          ) {
            e.push(I(V(B)));
            var xe = null;
          } else xe = B;
        ...
        case `form`:
          ...
          if (
            (Ce != null && ot(e, `action`, Ce),
            we != null && ot(e, `encType`, we),
            Te != null && ot(e, `method`, Te),
            Ee != null && ot(e, `target`, Ee),
            e.push(st),
            Ae !== null &&
              (e.push(tt), $e(e, `name`, Ae), e.push(ct), ke?.forEach(nt, e)),
            lt(e, Se, H),
            typeof H == `string`)
          ) {
            e.push(I(V(H)));
          ...
          return Me;
        case `menuitem`:
          for (var Ne in (e.push(Ot(`menuitem`)), n))
            if (z.call(n, Ne)) {
              var Pe = n[Ne];
              if (Pe != null)
                switch (Ne) {
              ...
              if (Re != null)
                switch (Le) {
                  ...
                  case `data`:
                    var ze = me(`` + Re);
                    if (ze === ``) break;
                    e.push(Ye, I(`data`), Xe, I(V(ze)), U);
                    break;
                  default:
                    ot(e, Le, Re);
                }
            }
          if ((e.push(st), lt(e, Ie, Fe), typeof Fe == `string`)) {
            e.push(I(V(Fe)));
            var Be = null;
          } else Be = Fe;
          return Be;
        case `title`:
          var Ve = c.tagScope & 1,
            Ue = c.tagScope & 4;
          if (c.insertionMode === 4 || Ve || n.itemProp != null)
            var We = bt(e, n);
          else Ue ? (We = null) : (bt(a.hoistableChunks, n), (We = void 0));
          return We;
        case `link`:
          var Ge = c.tagScope & 1,
            Ke = c.tagScope & 4,
          ...
          if (
            ...
            if (
              ...
              var mt = a.styles.get(rt),
                ht = i.styleResources.hasOwnProperty(Ze)
                  ? i.styleResources[Ze]
                  : void 0;
              if (ht !== null) {
                ((i.styleResources[Ze] = null),
                  mt ||
                    ((mt = {
                      precedence: I(V(rt)),
                      rules: [],
                ...
                if (ht) {
                  ht.length === 2 && yr(W.props, ht);
                  var G = a.preloads.stylesheets.get(Ze);
                  G && 0 < G.length ? (G.length = 0) : (W.state = 1);
                }
                (mt.sheets.set(Ze, W), s && s.stylesheets.add(W));
              } else if (mt) {
                var At = mt.sheets.get(Ze);
                At && s && s.stylesheets.add(At);
              }
              (l && e.push(He), (ft = null));
            }
          else
            n.onLoad || n.onError
              ? (ft = gt(e, n))
              : (l && e.push(He), (ft = Ke ? null : gt(a.hoistableChunks, n)));
          return ft;
        case `script`:
          var jt = c.tagScope & 1,
            K = n.async;
          if (
            ...
            var Pt = n.src;
            if (n.type === `module`)
              var Ft = i.moduleScriptResources,
                It = a.preloads.moduleScripts;
            else ((Ft = i.scriptResources), (It = a.preloads.scripts));
            var Lt = Ft.hasOwnProperty(Pt) ? Ft[Pt] : void 0;
            if (Lt !== null) {
              Ft[Pt] = null;
              var Rt = n;
              if (Lt) {
                Lt.length === 2 && ((Rt = R({}, n)), yr(Rt, Lt));
                var zt = It.get(Pt);
                zt && (zt.length = 0);
              }
              var Bt = [];
              (a.scripts.add(Bt), wt(Bt, Rt));
            }
            (l && e.push(He), (Nt = null));
          }
          return Nt;
        case `style`:
          ...
          if (
            ...
            (typeof Yt != `function` &&
              typeof Yt != `symbol` &&
              Yt != null &&
              e.push(I((`` + Yt).replace(_t, vt))),
              lt(e, Kt, Gt),
              e.push(Mt(`style`)));
            var Xt = null;
          } else {
            var Zt = a.styles.get(Ht);
            if (
              (i.styleResources.hasOwnProperty(Ut)
                ? i.styleResources[Ut]
                : void 0) !== null
            ) {
              ((i.styleResources[Ut] = null),
                Zt ||
                  ((Zt = {
                    precedence: I(V(Ht)),
                    rules: [],
                  ...
                  a.styles.set(Ht, Zt)));
              var Qt = a.nonce.style;
              if (!Qt || Qt === Wt) {
                Zt.hrefs.push(I(V(Ut)));
                var $t = Zt.rules,
                  q = null,
                  J = null,
                  en;
                ...
                var nn = Array.isArray(q) ? (2 > q.length ? q[0] : null) : q;
                (typeof nn != `function` &&
                  typeof nn != `symbol` &&
                  nn != null &&
                  $t.push(I((`` + nn).replace(_t, vt))),
                  lt($t, J, q));
              }
            }
            (Zt && s && s.styles.add(Zt), l && e.push(He), (Xt = void 0));
          }
          return Xt;
        case `meta`:
          var Y = c.tagScope & 1,
          ...
          if (c.insertionMode === 4 || Y || n.itemProp != null)
            ...
            (l && e.push(He),
              (X = rn
                ? null
                : typeof n.charSet == `string`
                  ? yt(a.charsetChunks, n, `meta`)
                  : n.name === `viewport`
                    ? yt(a.viewportChunks, n, `meta`)
                    : yt(a.hoistableChunks, n, `meta`)));
          return X;
        case `listing`:
        case `pre`:
          e.push(Ot(t));
...
` +
                  (pn || ``)
                : dn,
              hn = a.preloads.images,
              gn = hn.get(mn);
            if (gn)
              (n.fetchPriority === `high` || 10 > a.highImagePreloads.size) &&
                (hn.delete(mn), a.highImagePreloads.add(gn));
            else if (!i.imageResources.hasOwnProperty(mn)) {
              i.imageResources[mn] = ye;
              var _n = n.crossOrigin,
                vn =
                  typeof _n == `string`
                    ? _n === `use-credentials`
                      ? _n
                ...
                bn;
              yn &&
              0 < yn.remainingCapacity &&
              typeof n.srcSet != `string` &&
              (n.fetchPriority === `high` ||
                500 > yn.highImagePreloads.length) &&
              ((bn = br(dn, `image`, {
                imageSrcSet: n.srcSet,
                imageSizes: n.sizes,
                crossOrigin: vn,
              ...
              0 <= (yn.remainingCapacity -= bn.length + 2))
                ? ((a.resets.image[mn] = ye),
                  yn.highImagePreloads && (yn.highImagePreloads += `, `),
                  (yn.highImagePreloads += bn))
                : ((gn = []),
                  gt(gn, {
                    rel: `preload`,
                    as: `image`,
                  ...
                  n.fetchPriority === `high` || 10 > a.highImagePreloads.size
                    ? a.highImagePreloads.add(gn)
                    : (a.bulkPreloads.add(gn), hn.set(mn, gn)));
            }
          }
          return yt(e, n, `img`);
        case `base`:
        ...
        case `head`:
          if (2 > c.insertionMode) {
            var xn = o || a.preamble;
            if (xn.headChunks) throw Error(r(545, "`<head>`"));
            (o !== null && e.push(xt), (xn.headChunks = []));
            var Sn = Tt(xn.headChunks, n, `head`);
          } else Sn = Et(e, n, `head`);
          return Sn;
        case `body`:
          if (2 > c.insertionMode) {
            var Cn = o || a.preamble;
            if (Cn.bodyChunks) throw Error(r(545, "`<body>`"));
            (o !== null && e.push(St), (Cn.bodyChunks = []));
            var wn = Tt(Cn.bodyChunks, n, `body`);
          } else wn = Et(e, n, `body`);
          return wn;
        case `html`:
          if (c.insertionMode === 0) {
            var Tn = o || a.preamble;
            if (Tn.htmlChunks) throw Error(r(545, "`<html>`"));
            (o !== null && e.push(Ct), (Tn.htmlChunks = [kt]));
            var En = Tt(Tn.htmlChunks, n, `html`);
          } else En = Et(e, n, `html`);
          return En;
        default:
          if (t.indexOf(`-`) !== -1) {
                  ...
                  switch (kn) {
                    ...
                    default:
                      if (
                        ...
                        if (!0 === An) An = ``;
                        else if (typeof An == `object`) continue;
                        e.push(Ye, I(jn), Xe, I(V(An)), U);
                      }
                  }
                }
              }
            return (e.push(st), lt(e, On, Dn), Dn);
          }
      }
      return Et(e, n, t);
    }
    ...
    function Mt(e) {
      var t = jt.get(e);
      return (t === void 0 && ((t = L(`</` + e + `>`)), jt.set(e, t)), t);
    }
    function K(e, t) {
      ((e = e.preamble),
        e.htmlChunks === null && t.htmlChunks && (e.htmlChunks = t.htmlChunks),
    ...
    var Pt = L(`requestAnimationFrame(function(){$RT=performance.now()});`),
      Ft = L(`<template id="`),
      It = L(`"></template>`),
      Lt = L(`<!--&-->`),
      Rt = L(`<!--/&-->`),
    ...
    var qt = L(`></template>`);
    function Jt(e, t, n) {
      if ((P(e, Bt), n === null)) throw Error(r(395));
      return (P(e, t.boundaryPrefix), P(e, I(n.toString(16))), F(e, Vt));
    }
    var Yt = L(`<div hidden id="`),
      Xt = L(`">`),
      Zt = L(`</div>`),
      Qt = L(`<svg aria-hidden="true" style="display:none" id="`),
      $t = L(`">`),
      q = L(`</svg>`),
      J = L(`<math aria-hidden="true" style="display:none" id="`),
      en = L(`">`),
      tn = L(`</math>`),
      nn = L(`<table hidden id="`),
      Y = L(`">`),
      rn = L(`</table>`),
      X = L(`<table hidden><tbody id="`),
      an = L(`">`),
      on = L(`</tbody></table>`),
      sn = L(`<table hidden><tr id="`),
      cn = L(`">`),
      ln = L(`</tr></table>`),
      un = L(`<table hidden><colgroup id="`),
      dn = L(`">`),
      fn = L(`</colgroup></table>`);
    function pn(e, t, n, i) {
      switch (n.insertionMode) {
...
"$~";Promise.all(b).then($RC.bind(null,n,w),$RX.bind(null,n,"CSS failed to load"))};$RR("`),
    ...
    var Ln = L(` media="not all" data-precedence="`),
      Rn = L(`" data-href="`),
      zn = L(`">`),
      Bn = L(`</style>`),
      Vn = !1,
    ...
    function Un(e) {
      ...
      if (n.length) {
        for (
          ...
          (P(this, n[r]), P(this, Zn));
        for (P(this, n[r]), P(this, zn), r = 0; r < t.length; r++)
          P(this, t[r]);
        ((Hn = F(this, Bn)), (Vn = !0), (t.length = 0), (n.length = 0));
      }
    }
    function Wn(e) {
      return e.state === 2 ? !1 : (Vn = !0);
    }
    function Gn(e, t, n) {
      return (
        (Vn = !1),
        (Hn = !0),
        (be = n),
        t.styles.forEach(Un, e),
        (be = null),
        t.stylesheets.forEach(Wn),
        Vn && (n.stylesToHoist = !0),
        Hn
      );
    }
    function Kn(e) {
    ...
    function Jn(e) {
      gt(qn, e.props);
      for (var t = 0; t < qn.length; t++) P(this, qn[t]);
      ((qn.length = 0), (e.state = 2));
    }
    var Yn = L(` data-precedence="`),
      Xn = L(`" data-href="`),
      Zn = L(` `),
      Qn = L(`">`),
      $n = L(`</style>`);
    function er(e) {
      var t = 0 < e.sheets.size;
      (e.sheets.forEach(Jn, this), e.sheets.clear());
      var n = e.rules,
        r = e.hrefs;
      if (!t || r.length) {
        if (
          ...
          for (P(this, Xn); e < r.length - 1; e++) (P(this, r[e]), P(this, Zn));
          P(this, r[e]);
        }
        for (P(this, Qn), e = 0; e < n.length; e++) P(this, n[e]);
        (P(this, $n), (n.length = 0), (r.length = 0));
      }
    }
    function tr(e) {
      if (e.state === 0) {
    ...
    function nr(e) {
      (e.sheets.forEach(tr, this), e.sheets.clear());
    }
    (L(`<link rel="expect" href="#`), L(`" blocking="render"/>`));
    var rr = L(` id="`);
    function ir(e, t) {
      !(t.instructions & 32) &&
        ((t.instructions |= 32), e.push(rr, I(V(`_` + t.idPrefix + `R_`)), U));
    }
    var ar = L(`[`),
      or = L(`,[`),
      sr = L(`,`),
    ...
    function lr(e, t) {
      ...
      (t.stylesheets.forEach(function (t) {
        if (t.state !== 2)
          if (t.state === 3)
            (P(e, n), P(e, I(In(`` + t.props.href))), P(e, cr), (n = or));
          else {
            P(e, n);
            var i = t.props[`data-precedence`],
              a = t.props;
            for (var o in (P(e, I(In(me(`` + t.props.href)))),
            (i = `` + i),
            P(e, sr),
            P(e, I(In(i))),
            a))
    ...
    function ur(e, t, n) {
      ...
      (P(e, sr), P(e, I(In(r))), P(e, sr), P(e, I(In(t))));
    }
    function dr() {
      return { styles: new Set(), stylesheets: new Set(), suspenseyImages: !1 };
    }
      ...
      if (t) {
        ...
        if (typeof e == `string` && e) {
          if (!n.dnsResources.hasOwnProperty(e)) {
            ...
            ((a = n && 0 < n.remainingCapacity) &&
              (a =
                ((i = `<` + (`` + e).replace(xr, Sr) + `>; rel=dns-prefetch`),
                0 <= (n.remainingCapacity -= i.length + 2))),
              a
                ? ((r.resets.dns[e] = null),
                  n.preconnects && (n.preconnects += `, `),
      ...
      if (n) {
        ...
        if (typeof e == `string` && e) {
          ...
          if (!r.connectResources[a].hasOwnProperty(e)) {
            ...
            if ((s = r && 0 < r.remainingCapacity)) {
              if (
                ((s = `<` + (`` + e).replace(xr, Sr) + `>; rel=preconnect`),
                typeof t == `string`)
              ) {
                var c = (`` + t).replace(Cr, wr);
                s += `; crossorigin="` + c + `"`;
              }
              s = ((o = s), 0 <= (r.remainingCapacity -= o.length + 2));
            }
            s
              ? ((i.resets.connect[a][e] = null),
                ...
                (r.preconnects += o))
              : ((a = []),
                gt(a, { rel: `preconnect`, href: e, crossOrigin: t }),
                i.preconnects.add(a));
          }
          Ba(n);
        }
...
` +
              ...
              typeof o != `string` &&
              c === `high` &&
              ((u = br(e, t, n)), 0 <= (i.remainingCapacity -= u.length + 2))
                ? ((a.resets.image[l] = ye),
                  i.highImagePreloads && (i.highImagePreloads += `, `),
                  (i.highImagePreloads += u))
                : ((i = []),
                  gt(i, R({ rel: `preload`, href: o ? void 0 : e, as: t }, n)),
                  c === `high`
                    ? a.highImagePreloads.add(i)
                    : (a.bulkPreloads.add(i), a.preloads.images.set(l, i)));
              break;
            case `style`:
              if (i.styleResources.hasOwnProperty(e)) return;
              ((o = []),
                gt(o, R({ rel: `preload`, href: e, as: t }, n)),
                (i.styleResources[e] =
                  !n ||
                  (typeof n.crossOrigin != `string` &&
                    typeof n.integrity != `string`)
    ...
    function hr(e, t) {
      ...
      if (n) {
        ...
        if (e) {
          ...
          (gt(a, R({ rel: `modulepreload`, href: e }, t)),
            i.bulkPreloads.add(a),
            Ba(n));
        }
      } else ve.m(e, t);
      ...
      if (r) {
        ...
        if (e) {
          ...
          s !== null &&
            ...
            (t = {
              state: 0,
              props: R({ rel: `stylesheet`, href: e, "data-precedence": t }, n),
            }),
            s &&
              (s.length === 2 && yr(t.props, s),
              (a = a.preloads.stylesheets.get(e)) && 0 < a.length
                ? (a.length = 0)
                : (t.state = 1)),
            o.sheets.set(e, t),
      ...
      if (n) {
        ...
        if (e) {
          ...
          a !== null &&
            ...
            (t = R({ src: e, async: !0 }, t)),
            a &&
              (a.length === 2 && yr(t, a), (e = i.preloads.scripts.get(e))) &&
              (e.length = 0),
            (e = []),
            i.scripts.add(e),
            wt(e, t),
    ...
    function br(e, t, n) {
      for (var r in ((e = (`` + e).replace(xr, Sr)),
      (t = (`` + t).replace(Cr, wr)),
      (t = `<` + e + `>; rel=preload; as="` + t + `"`),
      n))
        z.call(n, r) &&
...
`:
    ...
    function Dr(e, t) {
      (t.styles.forEach(Tr, e),
        t.stylesheets.forEach(Er, e),
        t.suspenseyImages && (e.suspenseyImages = !0));
    }
    function Or(e) {
    ...
    var kr = Function.prototype.bind,
      Ar = Symbol.for(`react.client.reference`);
    function jr(e) {
      if (e == null) return null;
      if (typeof e == `function`)
    ...
    function Ir(e) {
      var t = e.parent;
      (t !== null && Ir(t), (e.context._currentValue = e.value));
    }
    function Lr(e, t) {
      if (
        ...
        throw Error(r(402));
      e.depth === t.depth ? Pr(e, t) : Lr(e, t);
    }
    function Rr(e, t) {
      var n = t.parent;
      if (n === null) throw Error(r(402));
      (e.depth === n.depth ? Pr(e, n) : Rr(e, n),
        (t.context._currentValue = t.value));
    }
    function zr(e) {
      var t = Nr;
    ...
    function Hr(e, t, n) {
      ...
      if (30 < a) {
        ...
        return (
          ...
          (r >>= o),
          (i -= o),
          { id: (1 << (32 - Ur(t) + i)) | (n << i) | r, overflow: a + e }
        );
      }
      return { id: (1 << a) | (n << i) | r, overflow: e };
    }
    var Ur = Math.clz32 ? Math.clz32 : Kr,
      Wr = Math.log,
      Gr = Math.LN2;
    function Kr(e) {
      return ((e >>>= 0), e === 0 ? 32 : (31 - ((Wr(e) / Gr) | 0)) | 0);
    }
    function qr() {}
    var Jr = Error(r(460));
    function Yr(e, t, n) {
      switch (
        ((n = e[n]),
        n === void 0 ? e.push(t) : n !== t && (t.then(qr, qr), (t = n)),
        t.status)
      ) {
        case `fulfilled`:
          return t.value;
    ...
    var $r = typeof Object.is == `function` ? Object.is : Qr,
      ...
      mi = 0;
    function hi() {
      if (ei === null) throw Error(r(321));
      return ei;
    }
    function gi() {
      if (0 < mi) throw Error(r(312));
      return { memoizedState: null, queue: null, next: null };
    }
    function _i() {
      return (
    ...
    function xi(e, t, n) {
      if (((ei = hi()), (ai = _i()), oi)) {
        var r = ai.queue;
        if (
          ((t = r.dispatch), pi !== null && ((n = pi.get(r)), n !== void 0))
        ) {
          (pi.delete(r), (r = ai.memoizedState));
          do ((r = e(r, n.action)), (n = n.next));
          while (n !== null);
          return ((ai.memoizedState = r), [r, t]);
        }
        ...
        (e =
          e === bi
            ...
            : n === void 0
              ...
              : n(t)),
        (ai.memoizedState = e),
        (e = ai.queue = { last: null, dispatch: null }),
        (e = e.dispatch = Si.bind(null, ei, e)),
        [ai.memoizedState, e]
      );
    }
    function Z(e, t) {
      if (
        ((ei = hi()), (ai = _i()), (t = t === void 0 ? null : t), ai !== null)
      ) {
        var n = ai.memoizedState;
        if (n !== null && t !== null) {
          var r = n[1];
          a: if (r === null) r = !1;
          else {
      ...
      return ((e = e()), (ai.memoizedState = [e, t]), e);
    }
    function Si(e, t, n) {
      if (25 <= mi) throw Error(r(301));
      if (e === ei)
        if (
          ((si = !0),
          (e = { action: n, next: null }),
    ...
    function $(e) {
      var t = di;
      return ((di += 1), fi === null && (fi = []), Yr(fi, e, t));
    }
    function Ei() {
      throw Error(r(393));
    }
    var Di = {
        ...
        use: function (e) {
          if (typeof e == `object` && e) {
            if (typeof e.then == `function`) return $(e);
            if (e.$$typeof === u) return e._currentValue;
          }
          throw Error(r(438, String(e)));
        },
        useContext: function (e) {
          return (hi(), e._currentValue);
        },
        useMemo: Z,
        useReducer: xi,
        useRef: function (e) {
          ((ei = hi()), (ai = _i()));
          var t = ai.memoizedState;
          return t === null
        ...
        useDebugValue: qr,
        useDeferredValue: function (e, t) {
          return (hi(), t === void 0 ? e : t);
        },
        useTransition: function () {
          return (hi(), [!1, wi]);
        },
        useId: function () {
          var e = ti.treeContext,
            t = e.overflow;
          ((e = e.id), (e = (e & ~(1 << (32 - Ur(e) - 1))).toString(32) + t));
          var n = Oi;
          if (n === null) throw Error(r(404));
          return (
            (t = ci++),
...
` + e;
    ...
    function Ii(e, t) {
      return (
        (500 < t.byteSize || Or(t.contentState)) && t.contentPreamble === null
      );
    }
    function Li(e) {
      if (typeof e == `object` && e && typeof e.environmentName == `string`) {
    ...
    function Ri(e, t, n, r, i, a, o, s, c, l, u) {
      ...
      ((this.destination = null),
        ...
        (this.onPostpone = l === void 0 ? qr : l),
        (this.onAllReady = a === void 0 ? qr : a),
        (this.onShellReady = o === void 0 ? qr : o),
        (this.onShellError = s === void 0 ? qr : s),
        (this.onFatalError = c === void 0 ? qr : c),
        (this.formState = u === void 0 ? null : u));
    }
...
` +
    ...
    function ta(e, t, n) {
      for (; t !== null; ) {
        n !== null && (Dr(t.hoistables, n), (t.inheritedHoistables = n));
        var r = t.boundaries;
        if (r !== null) {
          t.boundaries = null;
          for (var i = 0; i < r.length; i++) {
            var a = r[i];
            (n !== null && Dr(a.contentState, n), Ea(e, a, null, null));
          }
        }
        if ((t.pendingTasks--, 0 < t.pendingTasks)) break;
        ((n = t.hoistables), (t = t.next));
    ...
    function ia(e, t, n, r, i) {
      ...
      if (t.replay !== null) {
          ...
          for (var u = 0; u < n; u++) {
            var d =
                i !== `backwards` && i !== `unstable_legacy-backwards`
                  ...
                  : n - 1 - u,
              f = r[d];
            ((t.row = c = ra(c)), (t.treeContext = Hr(o, n, d)));
            var p = l[d];
            (typeof p == `number`
        ...
        for (
          ...
          try {
            (_a(e, t, f, d),
              p.lastPushedText && p.textEmbedded && p.chunks.push(He),
              (p.status = 1),
      ...
      if (typeof i == `function`)
        if (i.prototype && i.prototype.isReactComponent) {
          ...
          if (
            ...
            (m._reactInternals = C),
            (d = i.contextType),
            (m.context = typeof d == `object` && d ? d._currentValue : Mr),
            (d = i.getDerivedStateFromProps),
            typeof d == `function` &&
              ((d = d(a, D)), (D = d == null ? D : R({}, D, d)), (m.state = D)),
            typeof i.getDerivedStateFromProps != `function` &&
              typeof m.getSnapshotBeforeUpdate != `function` &&
              (typeof m.UNSAFE_componentWillMount == `function` ||
                typeof m.componentWillMount == `function`))
            ...
            if (
              ...
              typeof m.UNSAFE_componentWillMount == `function` &&
                m.UNSAFE_componentWillMount(),
              i !== m.state && Br.enqueueReplaceState(m, m.state, null),
              C.queue !== null && 0 < C.queue.length)
            )
              if (
                ((i = C.queue),
        ...
        if (((m = t.blockedSegment), m === null))
          ...
          if (
            ...
            (d = t.keyPath),
            (t.keyPath = n),
            (t.formatContext = Re(C, i, a)).insertionMode === 3)
          ) {
            ...
            try {
              ((n.status = 6),
                _a(e, t, D, -1),
                n.lastPushedText && n.textEmbedded && n.chunks.push(He),
                (n.status = 1),
          ...
          case p:
            a: if (t.replay !== null) {
              ((i = t.keyPath),
                ...
                (C = t.row),
                (t.keyPath = n),
                (t.formatContext = Ve(e.resumableState, m)),
                (t.row = null),
                (n = a.children));
              try {
                _a(e, t, n, -1);
              ...
              ((i = t.keyPath), (d = t.formatContext));
              var O = t.row;
              ((E = t.blockedBoundary), (x = t.blockedPreamble));
              ...
              var ee = new Set(),
                M =
                  2 > t.formatContext.insertionMode
                    ? Gi(e, t.row, ee, Fe(), Fe())
                    : Gi(e, t.row, ee, null, null);
              e.trackedPostpones !== null && (M.trackedContentKeyPath = n);
              var N = Ji(e, A.chunks.length, M, t.formatContext, !1, !1);
              (A.children.push(N), (A.lastPushedText = !1));
              ...
              if (((P.parentFlushed = !0), e.trackedPostpones !== null)) {
                ((m = t.componentStack),
                  ...
                  (t.keyPath = C),
                  (t.formatContext = Be(e.resumableState, d)),
                ...
                ((t = Ki(
                  ...
                  t.abortSet,
                  n,
                  Ve(e.resumableState, t.formatContext),
                  t.context,
                  t.treeContext,
                  null,
                  m,
                ...
                ((t.blockedBoundary = M),
                  ...
                  (t.blockedSegment = P),
                  (t.keyPath = n),
                  (t.formatContext = Ve(e.resumableState, d)),
                  (t.row = null),
                  (P.status = 6));
                try {
                  if (
                ...
                ((t = Ki(
                  ...
                  ee,
                  [n[0], `Suspense Fallback`, n[2]],
                  Be(e.resumableState, t.formatContext),
                  t.context,
                  t.treeContext,
                  t.row,
                  Xi(t.componentStack),
    ...
    function ua(e, t) {
      ...
      if (n !== null) {
        if (typeof n == `object`) {
                  ...
                  for (o = h.nodes, n = 0; n < o.length; n++) {
                    ...
                    if (m === g[1]) {
                      if (g.length === 4) {
                        ...
                        if (s !== p)
                          throw Error(r(490, `Suspense`, jr(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = g[5]),
                            (d = g[2]),
                          ...
                          ((l =
                            ...
                            (t.hoistableState = l.contentState),
                            (t.keyPath = c),
                            (t.formatContext = Ve(e.resumableState, b)),
                            (t.row = null),
                            (t.replay = {
                              nodes: d,
                              slots: f,
          ...
          if (typeof n.then == `function`)
            return ((t.thenableState = null), la(e, t, $(n), o));
    ...
    function da(e, t, n, i) {
      ...
      for (c = 0; c < s; c++)
        ((i = n[c]), (t.treeContext = Hr(o, s, c)), _a(e, t, i, c));
      ((t.treeContext = o), (t.keyPath = a));
    }
    function fa(e, t, n) {
      if (
      ...
      if (
        ...
        if (t.pendingTasks === 0) {
          if (
            ...
            ((n = t.row),
              n !== null && Dr(n.hoistables, t.contentState),
              Ii(e, t) ||
        ...
        try {
          ...
          for (c = 0; c < s.length; c++) {
            ...
            if (d === null) {
              ...
              if (l.replay.pendingTasks !== 0) {
                ...
                try {
                  ...
                  if (
                    ...
                    var m = l.ping;
                    (p.then(m, m), (l.thenableState = e === Jr ? vi() : null));
                  } else {
                    (l.replay.pendingTasks--, l.abortSet.delete(l));
              ...
              ((g.status = 6), zr(l.context));
              var x = g.children.length,
                S = g.chunks.length;
              try {
                (ua(u, l),
                  g.lastPushedText && g.textEmbedded && g.chunks.push(He),
                  l.abortSet.delete(l),
                  (g.status = 1),
                  Ta(u, l.blockedBoundary, g),
                  Ea(u, l.blockedBoundary, l.row, g));
              } catch (e) {
                (yi(), (g.children.length = x), (g.chunks.length = S));
                var C = e === Jr ? Zr() : u.status === 12 ? u.fatalError : e;
                if (u.status === 12 && u.trackedPostpones !== null) {
                  var w = u.trackedPostpones,
                  ...
                  ((g.status = 0), (l.thenableState = e === Jr ? vi() : null));
                  var E = l.ping;
                  C.then(E, E);
                } else {
          ...
          ((Oi = o), (he.H = n), (he.A = i), n === Di && zr(t), (Ui = a));
        }
      }
    }
    function Oa(e, t, n) {
    ...
    function ka(e, t, n) {
      ...
      switch (i.status) {
        ...
        case 5:
          if (e.trackedPostpones !== null) return !0;
        case 4:
          if (t.status === 1) return (K(e.renderState, o), Oa(e, t, n));
        default:
          return !0;
      }
    }
    ...
    function Na(e, t, n, i) {
      ...
      if (((a.parentFlushed = !0), a.status === 4)) {
        ...
        (o !== null && --o.pendingTasks === 0 && ea(e, o),
          ...
          F(t, Ht),
          P(t, Wt),
          a && (P(t, Kt), P(t, I(V(a))), P(t, Gt)),
          F(t, qt),
          ja(e, t, n, i));
      } else if (a.status !== 1)
        (a.status === 0 && (a.rootSegmentID = e.nextSegmentId++),
          0 < a.completedSegments.length && e.partialBoundaries.push(a),
          Jt(t, e.renderState, a.rootSegmentID),
          i && Dr(i, a.fallbackState),
          ja(e, t, n, i));
      else if (
        !La &&
        Ii(e, a) &&
        (Ma + a.byteSize > e.progressiveChunkSize || Or(a.contentState))
      )
        ((a.rootSegmentID = e.nextSegmentId++),
          e.completedBoundaries.push(a),
          Jt(t, e.renderState, a.rootSegmentID),
    ...
    function Fa(e, t, n) {
      ...
      ((r.length = 0),
        ...
        Gn(t, n.contentState, e.renderState),
        (r = e.resumableState),
        (e = e.renderState),
        (i = n.rootSegmentID),
        (n = n.contentState));
      ...
      return (
        ...
        P(t, st),
        a
          ? (!(r.instructions & 4) && ((r.instructions |= 4), P(t, Dn)),
            !(r.instructions & 2) && ((r.instructions |= 2), P(t, yn)),
            r.instructions & 8 ? P(t, Sn) : ((r.instructions |= 8), P(t, xn)))
          : (!(r.instructions & 2) && ((r.instructions |= 2), P(t, yn)),
            P(t, bn)),
        (r = I(i.toString(16))),
    ...
    function Ia(e, t, n, i) {
      ...
      return o === n.rootSegmentID
        ...
        : (Pa(e, t, i, a),
          ...
          P(t, e.startInlineScript),
          P(t, st),
          n.instructions & 1 ? P(t, gn) : ((n.instructions |= 1), P(t, hn)),
          P(t, e.segmentPrefix),
          (o = I(o.toString(16))),
          P(t, o),
          P(t, _n),
      ...
      try {
        if (!(0 < e.pendingRootTasks)) {
          ...
          if (r !== null) {
            ...
            if (c) {
              ...
              else (P(t, Ot(`head`)), P(t, st));
            } else if (l) for (u = 0; u < l.length; u++) P(t, l[u]);
            var d = o.charsetChunks;
            for (u = 0; u < d.length; u++) P(t, d[u]);
            ((d.length = 0),
              o.preconnects.forEach(Kn, t),
              o.preconnects.clear());
            var f = o.viewportChunks;
            for (u = 0; u < f.length; u++) P(t, f[u]);
            ((f.length = 0),
              o.fontPreloads.forEach(Kn, t),
              o.fontPreloads.clear(),
              o.highImagePreloads.forEach(Kn, t),
              o.highImagePreloads.clear(),
              (be = o),
              o.styles.forEach(er, t),
              (be = null));
            var p = o.importMapChunks;
            for (u = 0; u < p.length; u++) P(t, p[u]);
            ((p.length = 0),
              o.bootstrapScripts.forEach(Kn, t),
              o.scripts.forEach(Kn, t),
              o.scripts.clear(),
              o.bulkPreloads.forEach(Kn, t),
              o.bulkPreloads.clear(),
          ...
          ((C.length = 0),
            S.preconnects.forEach(Kn, t),
            S.preconnects.clear(),
            S.fontPreloads.forEach(Kn, t),
            S.fontPreloads.clear(),
            S.highImagePreloads.forEach(Kn, t),
            S.highImagePreloads.clear(),
            S.styles.forEach(nr, t),
            S.scripts.forEach(Kn, t),
            S.scripts.clear(),
            S.bulkPreloads.forEach(Kn, t),
          ...
          for (n = 0; n < T.length; n++) {
            ...
            (P(S, O.startInlineScript),
              P(S, st),
              D.instructions & 4 ? P(S, kn) : ((D.instructions |= 4), P(S, On)),
            ...
            a: {
              ...
              (R !== null &&
                ...
                (R.pendingTasks === 1
                  ? ta(T, R, R.hoistables)
                  : R.pendingTasks--),
                (ie = Gn(E, L.contentState, T.renderState)));
            }
            if (!ie) {
              ((e.destination = null), n++, ne.splice(0, n));
              return;
        ...
        ((La = !1),
          ...
          e.completedBoundaries.length === 0
            ? ((e.flushScheduled = !1),
              (n = e.resumableState),
              n.hasBody && P(t, Mt(`body`)),
              n.hasHtml && P(t, Mt(`html`)),
              te(t),
              (e.status = 14),
              t.close(),
              (e.destination = null))
...
function lp({
  ...
  let c =
      r == null
        ? null
        : (0, G.isValidElement)(r)
          ? (0, G.cloneElement)(r, { className: p(Ne, r.props.className) })
          : (0, G.createElement)(r, { className: Ne }),
    l = (0, cp.renderToStaticMarkup)(
      (0, G.createElement)(
        `span`,
        {
          className: p(Le, ke, Oe, i ? `cursor-interaction` : void 0, t),
          style: Fe({ brandColor: e, style: a }),
          title: typeof s == `string` && s.length > 0 ? s : void 0,
          ...n,
        },
        c == null ? null : (0, G.createElement)(`span`, { className: ze }, c),
        (0, G.createElement)(`span`, { className: `min-w-0 break-words` }, o),
      ),
    ),
    u = document.createElement(`span`);
  u.innerHTML = l;
  let d = u.firstElementChild;
  for (; d?.tagName === `LINK`; ) d = d.nextElementSibling;
  return d ?? u;
}
var up = {
    attrs: {
  ...
  fp = {
    ...
    toDOM: (e) =>
      lp({
        ...
        icon: Pe(e.attrs.sourceAppId) ?? ae,
...
var hp = mp(`skill-mention`),
  gp = mp(`app-mention`),
  _p = mp(`plugin-mention`);
function vp(e = {}) {
  return So({ key: pp, trigger: `$`, wordPattern: /(^|\s)(\$[^$]*)$/, ...e });
}
var yp = new Jn({
    nodes: {
  ...
  bp = new Wi(`slash-command-ui`);
function xp(e = {}) {
  return So({ key: bp, trigger: `/`, wordPattern: /(^|\s)(\/[^/]*)$/, ...e });
}
var Sp = class {
  listeners = new Map();
  emit(e, t) {
...
function Cp(
  ...
  let o = new EventTarget(),
    ...
    l = new of(null, {
      state: zi.create({
        ...
        plugins: [
          ...
          mo({
            ...
            "Shift-Enter": (e, t) => np(e, t),
            "Alt-Enter": (e, t) => np(e, t),
            Enter: (e, t) => {
              let n = wo.getState(e),
                r = pp.getState(e),
                i = bp.getState(e);
              if (n?.active || r?.active || i?.active) return !0;
              if (c === `newline`) return np(e, t);
      ...
      handleDOMEvents: {
        mousedown(e, t) {
          return (setPointerInputMode(!0), !1);
        },
        touchstart(e, t) {
          return (setPointerInputMode(!0), !1);
        },
        blur(e, t) {
          return (setPointerInputMode(!1), !1);
        },
      },
      handlePaste(e, t) {
        if (t.defaultPrevented) return !0;
        let n = t.clipboardData,
          { imageFiles: r, otherFiles: i } = ea(n);
        if (
      ...
      clipboardTextSerializer(e) {
        return ep(e.content).content;
      },
    });
  return (
    e != null && l.dispatch(l.state.tr.setSelection(Q.atEnd(l.state.doc))),
    {
      view: l,
      eventEmitter: s,
      setEnterBehavior: (e) => {
  ...
  getMentionedAgentConversationIds() {
    ...
    return (
      this.view.state.doc.descendants((t) => {
        ...
        return (typeof n == `string` && n.length > 0 && e.add(a(n)), !0);
      }),
      Array.from(e)
    );
  }
  ...
  isCursorAtEnd() {
    ...
    return n == null || !e.contains(n)
      ...
      : this.view.posAtDOM(n, t.anchorOffset, -1) ===
          Q.atEnd(this.view.state.doc).from;
  }
  setText(e) {
    let t = _t({ schema: this.view.state.schema, text: e }),
...
`,
  ...
  setPromptText(e) {
    let t = bt({ schema: this.view.state.schema, text: e }),
      n = this.view.state.tr;
    (n.replaceWith(0, this.view.state.doc.content.size, t.content),
      n.setSelection(Q.atEnd(n.doc)),
      this.view.dispatch(n));
  ...
  setPlaceholder(e) {
    this.view.dispatch(this.view.state.tr.setMeta(ip, { placeholder: e }));
  }
  syncMentionMetadata({
    skills: e,
    apps: t = [],
    ...
    let a = new Map(),
      ...
      u = new Map();
    (e.forEach((e) => {
      (a.set(T(e.path), e), o.set(e.name.toLowerCase(), e));
    }),
      t.forEach((e) => {
        let t = _e(e.id);
        (s.set(t, e),
    ...
    (f.doc.descendants((e, t) => {
      ...
      let n = typeof e.attrs.path == `string` ? e.attrs.path : ``,
        f = typeof e.attrs.name == `string` ? e.attrs.name : ``,
        p = Ep({ nodeTypeName: e.type.name, path: n }),
        g = null;
      if (p === `app`) {
        let e = s.get(n),
          t = f.length > 0 ? c.get(f.toLowerCase()) : void 0,
          r = e ?? t;
        r && (g = he(r));
      } else if (p === `plugin`) {
        let t = l.get(n),
          a = f.length > 0 ? u.get(f.toLowerCase()) : void 0,
          o = t ?? a,
          s =
          ...
          p = o == null ? null : ve(o, i),
          m = o?.displayName ?? o?.plugin.name ?? ``,
          h = o == null ? `` : ve(o).displayName,
          _ =
            c.isComputerUse &&
            s.length > 0 &&
            s !== m &&
        ...
        let t = n.length > 0 ? a.get(T(n)) : void 0;
        (!t && f.length > 0 && (t = o.get(f.toLowerCase())),
          t
            ? (g = B(t))
            : n.length > 0 &&
              (g = {
      ...
      return (!g && !v) ||
        (!(
          g != null &&
          (e.attrs.name !== g.name ||
            e.attrs.displayName !== g.displayName ||
            e.attrs.path !== g.path ||
            e.attrs.description !== g.description ||
            e.attrs.iconSmall !== g.iconSmall ||
            (typeof e.attrs.brandColor == `string`
              ? e.attrs.brandColor
              : ``) !== (g.brandColor ?? ``))
        ) &&
          !v)
        ? !0
        : ((h = !0), (m = m.setNodeMarkup(t, _, { ...e.attrs, ...g })), !0);
    }),
      h && p(m));
  }
  insertAtMention(e, t) {
    let n = t ?? wo.getState(this.view.state);
    ...
    let { state: r, dispatch: i } = this.view,
      ...
      s =
        e.matchType === `directory` && !/[\\/]$/.test(e.path)
          ? `${e.path}/`
          : e.path,
      c = yp.nodes.atMention.create({ ...e, path: s }),
    ...
    f && (l = l.insertText(` `, u));
    let p = u + (f ? 1 : 0);
    ((l = l.setSelection(Q.create(l.doc, p))),
      (l = l.setMeta(wo, { active: !1, anchorPos: null, query: `` })),
      i(l),
      this.view.focus());
  }
  insertAgentMention(e, t) {
    ...
    let { state: r, dispatch: i } = this.view,
      a = n.anchorPos - 1,
      o = n.anchorPos + n.query.length,
      s = yp.nodes.agentMention.create({
        name: e.name,
    ...
    d && (c = c.insertText(` `, l));
    let f = l + (d ? 1 : 0);
    ((c = c.setSelection(Q.create(c.doc, f))),
      (c = c.setMeta(wo, { active: !1, anchorPos: null, query: `` })),
      i(c),
      this.view.focus());
  }
  insertConfiguredAgentMention(e, t) {
    this.insertAgentMention(pe(e), t);
  }
  insertSkillMention(e, t) {
    this.insertMention(ue(e), t);
  }
  insertSkillMentionFromSlashCommand(e, t) {
    this.insertMentionFromSlashCommand(ue(e), t);
  }
  insertMention(e, t) {
    let n = t ?? pp.getState(this.view.state);
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, pp);
  }
  insertMentionFromSlashCommand(e, t) {
    let n = t ?? bp.getState(this.view.state);
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, bp);
  }
  ...
  insertMentionFromAtMention(e, t) {
    let n = t ?? wo.getState(this.view.state);
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, wo);
  }
  insertSkillMentionAtSelection(e) {
    this.insertMentionAtSelection(ue(e));
  }
  ...
  clearSlashCommand(e) {
    let t = e ?? bp.getState(this.view.state);
    ...
    ((o = o.setSelection(Q.create(o.doc, i))),
      (o = o.setMeta(bp, { active: !1, anchorPos: null, query: `` })),
      r(o),
      this.view.focus());
  }
  insertMentionInRange(e, t, n, r) {
    ...
    u && (s = s.insertText(` `, c));
    let d = c + (u ? 1 : 0);
    ((s = s.setSelection(Q.create(s.doc, d))),
...
function Tp(e) {
  switch (e) {
    case `agent`:
      return yp.nodes.agentMention;
    case `app`:
      return yp.nodes.appMention;
    case `plugin`:
      return yp.nodes.pluginMention;
    case `skill`:
      return yp.nodes.skillMention;
  }
}
function Ep({ nodeTypeName: e, path: t }) {
...
function Dp(e, t) {
  let { view: n, eventEmitter: r, setEnterBehavior: i } = Cp(e ?? null, t);
  return new wp(n, r, i);
}
function Op({
  composerController: e,
  ...
  return (
    ...
    (0, K.jsx)(`div`, {
      ...
      onClick: (e) => {
        ...
        n &&
          (e.preventDefault(), e.stopPropagation(), N({ path: n, cwd: null }));
      },
      className: p(
        `text-size-chat`,
...
function jp() {
  let e = g(Xe);
  return Mp(e.value.kind === `local` ? e.value.conversationId : null);
}
function Mp(e) {
  return Pp(e, Tt);
}
...
function Pp(e, t) {
  let n = (0, W.c)(6),
    r;
  n[0] !== e || n[1] !== t
    ? ((r = (n) => Fp(e, t, n)), (n[0] = e), (n[1] = t), (n[2] = r))
    : (r = n[2]);
  let i = r,
    a;
  return (
...
function Ip(e) {
  ...
  t[0] === c.pathname
    ? (u = t[1])
    : ((u = jt(c.pathname)), (t[0] = c.pathname), (t[1] = u));
  let d = u,
  ...
  t[2] !== a || t[3] !== f || t[4] !== o
    ? ((g = f
        ? p(Mt.expandedTopTrayShell, `absolute bottom-0 z-40`)
        : p(
  ...
  return (
    t[6] !== m || t[7] !== g
      ? ((_ = { overlayPortalContainer: m, shellClassName: g }),
        (t[6] = m),
        (t[7] = g),
        (t[8] = _))
      : (_ = t[8]),
...
function Vp(e) {
  ...
  t[0] !== _ || t[1] !== m || t[2] !== g
    ? ((y = { placement: m, zIndexClassName: g, variant: _ }),
      ...
      (t[3] = y))
    : (y = t[3]);
  let { overlayPortalContainer: b, shellClassName: x } = Ip(y),
    S;
  ...
  t[9] !== s || t[10] !== n.ui || t[11] !== o || t[12] !== m || t[13] !== h
    ? ((w = () => {
      ...
      (t[14] = w))
    : (w = t[14]);
  let T = (0, G.useSyncExternalStore)(C, w),
    E;
  bb0: {
    if (T == null) {
      E = null;
  ...
  if (D != null) {
    ...
    t[37] !== e || t[38] !== n || t[39] !== g
      ? ((r = p(e, n, g)), (t[37] = e), (t[38] = n), (t[39] = g), (t[40] = r))
      : (r = t[40]);
    let i;
    t[41] !== D.left || t[42] !== D.top || t[43] !== D.width
    ...
    let o;
    return (
      t[49] !== D.portalContainer || t[50] !== a
        ? ((o = (0, Lp.createPortal)(a, D.portalContainer)),
          (t[49] = D.portalContainer),
          (t[50] = a),
          (t[51] = o))
        : (o = t[51]),
      o
...
function Up({
  ...
  let s = Gp({ anchorElement: o, portalRoot: i }),
...
function Wp({
  ...
  let a = e.view.dom,
    o = Gp({ anchorElement: a, portalRoot: r }),
    s =
      o === document.body
        ? {
            left: 0,
    ...
    l = Math.max(s.width - zp * 2, 0),
    u = Math.min(Rp, l),
    d = Kp(c.left - s.left, zp, s.width - u - zp),
    f = c.bottom - s.top + Bp;
  return {
    portalContainer: o,
    left: d,
    top: n === `top` ? c.top - s.top - Bp : f,
    width: u,
    fixedPosition: o === document.body,
    renderAbove: n === `top`,
  };
}
function Gp({ anchorElement: e, portalRoot: t }) {
  return t === `body`
    ? document.body
...
function Jp(e) {
  return pp.getState(e.view.state);
}
export {
  Ut as A,
  xt as B,
...
//# sourceMappingURL=prosemirror-DbRBBq50.js.map
